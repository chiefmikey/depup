...
> [react-cookie](https://www.npmjs.com/package/react-cookie) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/react-cookie
```
...
**Original version**: 8.1.2 | **DepUp version**: 8.1.2-depup.51 | **Updated**: 7/11/2026 | **Import test**: failed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| universal-cookie | `^8.0.0` | `^8.1.2` |
...
This package inherits the license from [react-cookie](https://www.npmjs.com/package/react-cookie).