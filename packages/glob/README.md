...
> [glob](https://www.npmjs.com/package/glob) with all dependencies updated to latest versions.
...
**Original version**: 13.0.6 | **DepUp version**: 13.0.6-depup.23 | **Updated**: 7/21/2026 | **Import test**: passed
...
Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/glob&labels=bug).
...
This package inherits the license from [glob](https://www.npmjs.com/package/glob).