# @depup/focus-trap-react

> [focus-trap-react](https://www.npmjs.com/package/focus-trap-react) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/focus-trap-react
```
...
**Original version**: 12.0.1 | **DepUp version**: 12.0.1-depup.1 | **Updated**: 5/4/2026 | **Import test**: failed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| focus-trap | `^8.1.0` | `^8.2.0` |
...
This package inherits the license from [focus-trap-react](https://www.npmjs.com/package/focus-trap-react).