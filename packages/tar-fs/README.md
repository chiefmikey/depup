...
> Dependency-bumped version of tar-fs

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for tar-fs.
...
- **Original Package**: [tar-fs](https://www.npmjs.com/package/tar-fs)
