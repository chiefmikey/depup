...
> [pkg-dir](https://www.npmjs.com/package/pkg-dir) with all dependencies updated to latest versions.
...
**Original version**: 9.0.0 | **DepUp version**: 9.0.0-depup.0 | **Updated**: 3/17/2026 | **Import test**: unknown
...
Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/pkg-dir&labels=bug).
...
This package inherits the license from [pkg-dir](https://www.npmjs.com/package/pkg-dir).