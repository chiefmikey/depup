...
> Dependency-bumped version of redis-errors

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for redis-errors.
...
- **Original Package**: [redis-errors](https://www.npmjs.com/package/redis-errors)
