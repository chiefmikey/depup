...
> [stream-json](https://www.npmjs.com/package/stream-json) with all dependencies updated to latest versions.
...
**Original version**: 3.2.0 | **DepUp version**: 3.2.0-depup.1 | **Updated**: 5/28/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| stream-chain | `^4.1.1` | `^4.2.0` |
...
This package inherits the license from [stream-json](https://www.npmjs.com/package/stream-json).