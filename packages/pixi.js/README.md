...
> [pixi.js](https://www.npmjs.com/package/pixi.js) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/pixi.js
```
...
**Original version**: 8.19.0 | **DepUp version**: 8.19.0-depup.52 | **Updated**: 7/13/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @webgpu/types | `^0.1.69` | `^0.1.71` |
...
This package inherits the license from [pixi.js](https://www.npmjs.com/package/pixi.js).