...
**Original version**: 6.1.35 | **DepUp version**: 6.1.35-depup.3 | **Updated**: 9/9/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @graphql-tools/delegate | `^8.8.1` | `^12.2.0` |
| @graphql-tools/schema | `^8.5.1` | `^10.1.1` |
