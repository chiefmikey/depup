# @depup/graphql-middleware

> [graphql-middleware](https://www.npmjs.com/package/graphql-middleware) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/graphql-middleware
```
...
**Original version**: 6.1.35 | **DepUp version**: 6.1.35-depup.0 | **Updated**: 3/19/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @graphql-tools/delegate | `^8.8.1` | `^12.0.12` |
| @graphql-tools/schema | `^8.5.1` | `^10.0.31` |
...
This package inherits the license from [graphql-middleware](https://www.npmjs.com/package/graphql-middleware).