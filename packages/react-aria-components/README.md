# @depup/react-aria-components

> [react-aria-components](https://www.npmjs.com/package/react-aria-components) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/react-aria-components
```
...
**Original version**: 1.19.0 | **DepUp version**: 1.19.0-depup.25 | **Updated**: 7/14/2026 | **Import test**: passed
...
This package inherits the license from [react-aria-components](https://www.npmjs.com/package/react-aria-components).