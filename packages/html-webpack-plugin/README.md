...
> Dependency-bumped version of html-webpack-plugin

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for html-webpack-plugin.
...
- **Original Package**: [html-webpack-plugin](https://www.npmjs.com/package/html-webpack-plugin)
- **DepUp Version**: 5.6.6-depup.0
- **Original Version**: 5.6.6
...
- **Revision 0** (5.6.6-depup.0) - 🔴 Poor 0% integrity
