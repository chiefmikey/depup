...
> Dependency-bumped version of @react-dnd/asap

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @react-dnd/asap.
...
- **Original Package**: [@react-dnd/asap](https://www.npmjs.com/package/@react-dnd/asap)
- **DepUp Version**: 5.0.2-depup.0
...
- **Revision 0** (5.0.2-depup.0) - 🔴 Poor 0% integrity
