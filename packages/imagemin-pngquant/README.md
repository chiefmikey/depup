...
> [imagemin-pngquant](https://www.npmjs.com/package/imagemin-pngquant) with all dependencies updated to latest versions.
...
**Original version**: 10.0.0 | **DepUp version**: 10.0.0-depup.0 | **Updated**: 3/18/2026 | **Import test**: passed
...
Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/imagemin-pngquant&labels=bug).
...
This package inherits the license from [imagemin-pngquant](https://www.npmjs.com/package/imagemin-pngquant).