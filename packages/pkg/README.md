...
> Dependency-bumped version of pkg

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for pkg.
...
- **Original Package**: [pkg](https://www.npmjs.com/package/pkg)
- **DepUp Version**: 5.8.1-depup.0
- **Original Version**: 5.8.1
...
- **Revision 0** (5.8.1-depup.0) - 🔴 Poor 0% integrity
