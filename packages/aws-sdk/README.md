...
> [aws-sdk](https://www.npmjs.com/package/aws-sdk) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/aws-sdk
```
...
This package inherits the license from [aws-sdk](https://www.npmjs.com/package/aws-sdk).