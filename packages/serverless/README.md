...
> Dependency-bumped version of serverless

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for serverless.
...
- **Original Package**: [serverless](https://www.npmjs.com/package/serverless)
- **DepUp Version**: 4.33.0-depup.0
...
- **Revision 0** (4.33.0-depup.0) - 🔴 Poor 0% integrity
