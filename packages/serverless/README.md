...
> [serverless](https://www.npmjs.com/package/serverless) with all dependencies updated to latest versions.
...
**Original version**: 4.37.0 | **DepUp version**: 4.37.0-depup.19 | **Updated**: 6/15/2026 | **Import test**: failed
...
This package inherits the license from [serverless](https://www.npmjs.com/package/serverless).