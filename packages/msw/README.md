...
**Original version**: 2.15.0 | **DepUp version**: 2.15.0-depup.10 | **Updated**: 8/27/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @inquirer/confirm | `^6.0.11` | `^6.3.0` |
| @mswjs/interceptors | `^0.41.3` | `^0.42.3` |
| cookie | `^1.1.1` | `^2.0.1` |
