# @depup/react-three__postprocessing

> [@react-three/postprocessing](https://www.npmjs.com/package/@react-three/postprocessing) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/react-three__postprocessing
```
...
**Original version**: 3.0.4 | **DepUp version**: 3.0.4-depup.2 | **Updated**: 7/21/2026 | **Import test**: failed
...
This package inherits the license from [@react-three/postprocessing](https://www.npmjs.com/package/@react-three/postprocessing).