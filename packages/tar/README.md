...
> [tar](https://www.npmjs.com/package/tar) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/tar
```
...
**Original version**: 7.5.16 | **DepUp version**: 7.5.16-depup.25 | **Updated**: 6/19/2026 | **Import test**: passed
...
Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/tar&labels=bug).
...
This package inherits the license from [tar](https://www.npmjs.com/package/tar).