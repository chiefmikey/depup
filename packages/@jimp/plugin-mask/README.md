...
> [@jimp/plugin-mask](https://www.npmjs.com/package/@jimp/plugin-mask) with all dependencies updated to latest versions.
...
**Original version**: 1.6.1 | **DepUp version**: 1.6.1-depup.13 | **Updated**: 6/11/2026 | **Import test**: failed
...
This package inherits the license from [@jimp/plugin-mask](https://www.npmjs.com/package/@jimp/plugin-mask).