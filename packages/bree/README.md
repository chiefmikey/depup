...
> Dependency-bumped version of bree

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for bree.
...
- **Original Package**: [bree](https://www.npmjs.com/package/bree)
- **DepUp Version**: 9.2.9-depup.0
- **Original Version**: 9.2.9
...
- **Revision 0** (9.2.9-depup.0) - 🔴 Poor 0% integrity
