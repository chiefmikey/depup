...
> [multer](https://www.npmjs.com/package/multer) with all dependencies updated to latest versions.
...
**Original version**: 2.2.0 | **DepUp version**: 2.2.0-depup.0 | **Updated**: 6/15/2026 | **Import test**: passed
...
This package inherits the license from [multer](https://www.npmjs.com/package/multer).