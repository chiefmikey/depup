...
> Dependency-bumped version of bootstrap

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for bootstrap.
...
- **Original Package**: [bootstrap](https://www.npmjs.com/package/bootstrap)
- **DepUp Version**: 5.3.8-depup.0
- **Original Version**: 5.3.8
...
- **Revision 0** (5.3.8-depup.0) - 🔴 Poor 0% integrity
