...
> Dependency-bumped version of decompress-response

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for decompress-response.
...
- **Original Package**: [decompress-response](https://www.npmjs.com/package/decompress-response)
