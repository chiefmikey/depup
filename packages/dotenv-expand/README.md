...
> Dependency-bumped version of dotenv-expand

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for dotenv-expand.
...
- **Original Package**: [dotenv-expand](https://www.npmjs.com/package/dotenv-expand)
- **DepUp Version**: 12.0.3-depup.0
- **Original Version**: 12.0.3
...
- **Revision 0** (12.0.3-depup.0) - 🔴 Poor 0% integrity
