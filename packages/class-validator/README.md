...
> Dependency-bumped version of class-validator

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for class-validator.
...
- **Original Package**: [class-validator](https://www.npmjs.com/package/class-validator)
- **DepUp Version**: 0.15.1-depup.0
- **Original Version**: 0.15.1
...
- **Revision 0** (0.15.1-depup.0) - 🔴 Poor 0% integrity
