...
> Dependency-bumped version of koa-router

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for koa-router.
...
- **Original Package**: [koa-router](https://www.npmjs.com/package/koa-router)
