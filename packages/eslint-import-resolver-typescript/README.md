# @depup/eslint-import-resolver-typescript

> [eslint-import-resolver-typescript](https://www.npmjs.com/package/eslint-import-resolver-typescript) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/eslint-import-resolver-typescript
```
...
**Original version**: 4.4.5 | **DepUp version**: 4.4.5-depup.14 | **Updated**: 6/12/2026 | **Import test**: passed
...
This package inherits the license from [eslint-import-resolver-typescript](https://www.npmjs.com/package/eslint-import-resolver-typescript).