...
> Dependency-bumped version of primus

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for primus.
...
- **Original Package**: [primus](https://www.npmjs.com/package/primus)
- **DepUp Version**: 8.0.9-depup.0
- **Original Version**: 8.0.9
...
- **Revision 0** (8.0.9-depup.0) - 🔴 Poor 0% integrity
