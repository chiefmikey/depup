...
> Dependency-bumped version of recharts

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for recharts.
...
- **Original Package**: [recharts](https://www.npmjs.com/package/recharts)
- **DepUp Version**: 3.8.0-depup.0
...
- **Revision 0** (3.8.0-depup.0) - 🔴 Poor 0% integrity
