...
**Original version**: 0.14.0 | **DepUp version**: 0.14.0-depup.58 | **Updated**: 9/21/2026 | **Import test**: failed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @mantine/code-highlight | `7.17.4` | `^9.6.1` |
| @mantine/core | `7.17.4` | `^9.6.1` |
| @mantine/hooks | `7.17.4` | `^9.6.1` |
| @redux-devtools/extension | `^3.3.0` | `^4.0.0` |
| jsondiffpatch | `^0.5.0` | `^0.7.6` |
| react-base16-styling | `^0.9.1` | `^0.10.0` |
| react-error-boundary | `^5.0.0` | `^6.1.6` |
| react-json-tree | `^0.18.0` | `^0.20.0` |
| react-resizable-panels | `2.1.7` | `^4.13.1` |
