...
**Original version**: 0.14.0 | **DepUp version**: 0.14.0-depup.0 | **Updated**: 5/9/2026 | **Import test**: failed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @mantine/code-highlight | `7.17.4` | `^9.1.1` |
| @mantine/core | `7.17.4` | `^9.1.1` |
| @mantine/hooks | `7.17.4` | `^9.1.1` |
