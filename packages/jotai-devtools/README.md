...
**Original version**: 0.14.0 | **DepUp version**: 0.14.0-depup.1 | **Updated**: 5/12/2026 | **Import test**: failed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @mantine/code-highlight | `7.17.4` | `^9.2.0` |
| @mantine/core | `7.17.4` | `^9.2.0` |
| @mantine/hooks | `7.17.4` | `^9.2.0` |
...
| react-resizable-panels | `2.1.7` | `^4.11.0` |
