...
**Original version**: 0.14.0 | **DepUp version**: 0.14.0-depup.56 | **Updated**: 7/27/2026 | **Import test**: failed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @mantine/code-highlight | `7.17.4` | `^9.5.0` |
| @mantine/core | `7.17.4` | `^9.5.0` |
| @mantine/hooks | `7.17.4` | `^9.5.0` |
...
| react-resizable-panels | `2.1.7` | `^4.12.2` |
