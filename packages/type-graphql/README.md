...
> [type-graphql](https://www.npmjs.com/package/type-graphql) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/type-graphql
```
...
**Original version**: 2.0.0-rc.3 | **DepUp version**: 2.0.0-rc.3-depup.0 | **Updated**: 3/17/2026
...
This package inherits the license from [type-graphql](https://www.npmjs.com/package/type-graphql).