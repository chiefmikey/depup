...
> Dependency-bumped version of vite-plugin-svgr

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for vite-plugin-svgr.
...
- **Original Package**: [vite-plugin-svgr](https://www.npmjs.com/package/vite-plugin-svgr)
- **DepUp Version**: 4.5.0-depup.0
- **Original Version**: 4.5.0
...
- **Revision 0** (4.5.0-depup.0) - 🔴 Poor 0% integrity
