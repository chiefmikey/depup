...
> Dependency-bumped version of split

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for split.
...
- **Original Package**: [split](https://www.npmjs.com/package/split)
