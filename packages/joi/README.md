...
> Dependency-bumped version of joi

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for joi.
...
- **DepUp Version**: 18.0.2-depup.0
- **Original Version**: 18.0.2
...
- **Revision 0** (18.0.2-depup.0) - 🔴 Poor 0% integrity
