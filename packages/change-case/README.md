...
> Dependency-bumped version of change-case

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for change-case.
...
- **Original Package**: [change-case](https://www.npmjs.com/package/change-case)
- **DepUp Version**: 5.4.4-depup.0
- **Original Version**: 5.4.4
...
- **Revision 0** (5.4.4-depup.0) - 🔴 Poor 0% integrity
