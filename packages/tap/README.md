...
> Dependency-bumped version of tap

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for tap.
...
- **Original Package**: [tap](https://www.npmjs.com/package/tap)
- **DepUp Version**: 21.6.2-depup.0
- **Original Version**: 21.6.2
...
- **Revision 0** (21.6.2-depup.0) - 🔴 Poor 0% integrity
