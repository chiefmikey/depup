...
> [redux-saga](https://www.npmjs.com/package/redux-saga) with all dependencies updated to latest versions.
...
This package inherits the license from [redux-saga](https://www.npmjs.com/package/redux-saga).