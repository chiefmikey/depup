...
> Dependency-bumped version of @redis/json

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @redis/json.
...
- **Original Package**: [@redis/json](https://www.npmjs.com/package/@redis/json)
