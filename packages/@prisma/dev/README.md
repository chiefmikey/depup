...
**Original version**: 0.24.14 | **DepUp version**: 0.24.14-depup.41 | **Updated**: 7/21/2026 | **Import test**: failed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @electric-sql/pglite | `0.4.3` | `^0.5.4` |
| @electric-sql/pglite-socket | `0.1.3` | `^0.2.7` |
| @electric-sql/pglite-tools | `0.3.3` | `^0.4.4` |
| @prisma/get-platform | `7.2.0` | `^7.9.0` |
| @prisma/query-plan-executor | `7.2.0` | `^7.9.0` |
| find-my-way | `9.6.0` | `^9.7.0` |
| foreground-child | `3.3.1` | `^4.0.3` |
| remeda | `2.33.4` | `^2.39.0` |
