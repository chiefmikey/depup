...
**Original version**: 0.25.2 | **DepUp version**: 0.25.2-depup.5 | **Updated**: 9/10/2026 | **Import test**: failed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @electric-sql/pglite | `0.4.3` | `^0.5.8` |
| @electric-sql/pglite-socket | `0.1.3` | `^0.2.11` |
