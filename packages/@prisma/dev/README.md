...
**Original version**: 0.24.12 | **DepUp version**: 0.24.12-depup.10 | **Updated**: 6/12/2026 | **Import test**: failed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @electric-sql/pglite | `0.4.3` | `^0.5.2` |
| @electric-sql/pglite-socket | `0.1.3` | `^0.2.2` |
| @electric-sql/pglite-tools | `0.3.3` | `^0.4.2` |
