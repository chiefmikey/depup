# @depup/light-my-request

> [light-my-request](https://www.npmjs.com/package/light-my-request) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/light-my-request
```
...
**Original version**: 6.6.0 | **DepUp version**: 6.6.0-depup.0 | **Updated**: 3/17/2026 | **Import test**: unknown
...
This package inherits the license from [light-my-request](https://www.npmjs.com/package/light-my-request).