...
> [sqlite3](https://www.npmjs.com/package/sqlite3) with all dependencies updated to latest versions.
...
**Original version**: 6.0.1 | **DepUp version**: 6.0.1-depup.33 | **Updated**: 5/22/2026 | **Import test**: failed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| node-addon-api | `^8.0.0` | `^8.8.0` |
| tar | `^7.5.10` | `^7.5.15` |
...
This package inherits the license from [sqlite3](https://www.npmjs.com/package/sqlite3).