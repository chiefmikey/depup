...
> Dependency-bumped version of electron-builder

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for electron-builder.
...
- **Original Package**: [electron-builder](https://www.npmjs.com/package/electron-builder)
- **DepUp Version**: 26.8.1-depup.0
- **Original Version**: 26.8.1
...
- **Revision 0** (26.8.1-depup.0) - 🔴 Poor 0% integrity
