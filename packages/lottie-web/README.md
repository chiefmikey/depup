...
> Dependency-bumped version of lottie-web

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for lottie-web.
...
- **Original Package**: [lottie-web](https://www.npmjs.com/package/lottie-web)
- **DepUp Version**: 5.13.0-depup.0
- **Original Version**: 5.13.0
- **Last Updated**: 3/9/2026

## 🚀 Installation

```bash
npm install @depup/lottie-web
```
...
- **Revision 0** (5.13.0-depup.0) - 🔴 Poor 0% integrity
