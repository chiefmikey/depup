...
> Dependency-bumped version of @rushstack/eslint-patch

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @rushstack/eslint-patch.
...
- **Original Package**: [@rushstack/eslint-patch](https://www.npmjs.com/package/@rushstack/eslint-patch)
- **DepUp Version**: 1.16.1-depup.0
- **Original Version**: 1.16.1
...
- **Revision 0** (1.16.1-depup.0) - 🔴 Poor 0% integrity
