...
> [redbird](https://www.npmjs.com/package/redbird) with all dependencies updated to latest versions.
...
**Original version**: 1.0.2 | **DepUp version**: 1.0.2-depup.3 | **Updated**: 5/18/2026 | **Import test**: passed
...
This package inherits the license from [redbird](https://www.npmjs.com/package/redbird).