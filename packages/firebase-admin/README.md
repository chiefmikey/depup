...
> Dependency-bumped version of firebase-admin

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for firebase-admin.
...
- **Original Package**: [firebase-admin](https://www.npmjs.com/package/firebase-admin)
- **DepUp Version**: 13.7.0-depup.0
- **Original Version**: 13.7.0
...
- **Revision 0** (13.7.0-depup.0) - 🔴 Poor 0% integrity
