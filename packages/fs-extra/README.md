...
> Dependency-bumped version of fs-extra

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for fs-extra.
...
- **Original Package**: [fs-extra](https://www.npmjs.com/package/fs-extra)
- **DepUp Version**: 11.3.4-depup.0
- **Original Version**: 11.3.4
...
- **Revision 0** (11.3.4-depup.0) - 🔴 Poor 0% integrity
