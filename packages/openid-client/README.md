...
> Dependency-bumped version of openid-client

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for openid-client.
...
- **Original Package**: [openid-client](https://www.npmjs.com/package/openid-client)
- **DepUp Version**: 6.8.2-depup.0
- **Original Version**: 6.8.2
...
- **Revision 0** (6.8.2-depup.0) - 🔴 Poor 0% integrity
