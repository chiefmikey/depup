...
> [detective-typescript](https://www.npmjs.com/package/detective-typescript) with all dependencies updated to latest versions.
...
**Original version**: 14.1.2 | **DepUp version**: 14.1.2-depup.1 | **Updated**: 5/19/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @typescript-eslint/typescript-estree | `^8.58.2` | `^8.59.4` |
| ast-module-types | `^6.0.1` | `^6.0.2` |
| node-source-walk | `^7.0.1` | `^8.0.0` |
...
This package inherits the license from [detective-typescript](https://www.npmjs.com/package/detective-typescript).