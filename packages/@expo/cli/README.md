...
> [@expo/cli](https://www.npmjs.com/package/@expo/cli) with all dependencies updated to latest versions.
...
**Original version**: 57.0.14 | **DepUp version**: 57.0.14-depup.1 | **Updated**: 8/11/2026 | **Import test**: failed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @react-native/dev-middleware | `0.86.2` | `^0.87.0` |
| agent-cli-detector | `^0.1.2` | `^0.1.5` |
...
| debug | `^4.3.4` | `^4.4.3` |
| dnssd-advertise | `^1.1.4` | `^1.1.6` |
| glob | `^13.0.0` | `^13.0.6` |
| multitars | `^1.0.0` | `^1.0.1` |
...
| structured-headers | `^0.4.1` | `^2.0.3` |
...
This package inherits the license from [@expo/cli](https://www.npmjs.com/package/@expo/cli).