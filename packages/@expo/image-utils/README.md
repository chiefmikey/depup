...
> Dependency-bumped version of @expo/image-utils

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @expo/image-utils.
...
- **Original Package**: [@expo/image-utils](https://www.npmjs.com/package/@expo/image-utils)
- **DepUp Version**: 0.8.12-depup.0
- **Original Version**: 0.8.12
...
- **Revision 0** (0.8.12-depup.0) - 🔴 Poor 0% integrity
