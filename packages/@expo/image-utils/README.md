...
> [@expo/image-utils](https://www.npmjs.com/package/@expo/image-utils) with all dependencies updated to latest versions.
...
**Original version**: 0.8.13-canary-20260328-2049187 | **DepUp version**: 0.8.13-canary-20260328-2049187-depup.0 | **Updated**: 3/28/2026 | **Import test**: passed
...
This package inherits the license from [@expo/image-utils](https://www.npmjs.com/package/@expo/image-utils).