...
> [markdown-it](https://www.npmjs.com/package/markdown-it) with all dependencies updated to latest versions.
...
**Original version**: 15.0.1 | **DepUp version**: 15.0.1-depup.42 | **Updated**: 9/11/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| argparse | `^3.0.0` | `^3.0.2` |
...
This package inherits the license from [markdown-it](https://www.npmjs.com/package/markdown-it).