...
> Dependency-bumped version of @0no-co/graphql.web

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @0no-co/graphql.web.
...
- **Original Package**: [@0no-co/graphql.web](https://www.npmjs.com/package/@0no-co/graphql.web)
