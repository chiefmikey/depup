...
> [express-slow-down](https://www.npmjs.com/package/express-slow-down) with all dependencies updated to latest versions.
...
**Original version**: 3.1.1 | **DepUp version**: 3.1.1-depup.0 | **Updated**: 8/27/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| express-rate-limit | `8` | `^8.6.2` |
...
This package inherits the license from [express-slow-down](https://www.npmjs.com/package/express-slow-down).