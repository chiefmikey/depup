...
> [yup](https://www.npmjs.com/package/yup) with all dependencies updated to latest versions.
...
**Original version**: 1.7.1 | **DepUp version**: 1.7.1-depup.3 | **Updated**: 5/31/2026 | **Import test**: passed
...
This package inherits the license from [yup](https://www.npmjs.com/package/yup).