...
> Dependency-bumped version of @google-cloud

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @google-cloud.
...
- **Original Package**: [@google-cloud](https://www.npmjs.com/package/@google-cloud)
...
```bash
npm install @depup/@google-cloud
```
