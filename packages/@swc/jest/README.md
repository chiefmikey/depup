...
> Dependency-bumped version of @swc/jest

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @swc/jest.
...
- **Original Package**: [@swc/jest](https://www.npmjs.com/package/@swc/jest)
- **DepUp Version**: 0.2.39-depup.0
- **Original Version**: 0.2.39
...
- **Revision 0** (0.2.39-depup.0) - 🔴 Poor 0% integrity
