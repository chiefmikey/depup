...
> Dependency-bumped version of busboy

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for busboy.
...
- **Original Package**: [busboy](https://www.npmjs.com/package/busboy)
- **DepUp Version**: 1.6.0-depup.0
...
- **Revision 0** (1.6.0-depup.0) - 🔴 Poor 0% integrity
