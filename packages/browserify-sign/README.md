# @depup/browserify-sign

> [browserify-sign](https://www.npmjs.com/package/browserify-sign) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/browserify-sign
```
...
**Original version**: 4.2.6 | **DepUp version**: 4.2.6-depup.12 | **Updated**: 6/12/2026 | **Import test**: passed
...
This package inherits the license from [browserify-sign](https://www.npmjs.com/package/browserify-sign).