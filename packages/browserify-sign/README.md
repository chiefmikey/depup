...
> Dependency-bumped version of browserify-sign

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for browserify-sign.
...
- **Original Package**: [browserify-sign](https://www.npmjs.com/package/browserify-sign)
- **DepUp Version**: 4.2.5-depup.0
- **Original Version**: 4.2.5
...
- **Revision 0** (4.2.5-depup.0) - 🔴 Poor 0% integrity
