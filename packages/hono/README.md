...
> Dependency-bumped version of hono

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for hono.
...
- **Original Package**: [hono](https://www.npmjs.com/package/hono)
- **DepUp Version**: 4.12.8-depup.0
- **Original Version**: 4.12.8
...
- **Revision 0** (4.12.8-depup.0) - 🔴 Poor 0% integrity
