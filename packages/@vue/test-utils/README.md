# @depup/vue__test-utils

> [@vue/test-utils](https://www.npmjs.com/package/@vue/test-utils) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/vue__test-utils
```
...
**Original version**: 2.5.0 | **DepUp version**: 2.5.0-depup.0 | **Updated**: 8/27/2026 | **Import test**: failed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| js-beautify | `^2.0.0` | `^2.0.3` |
| vue-component-type-helpers | `^3.0.0` | `^3.3.11` |
...
This package inherits the license from [@vue/test-utils](https://www.npmjs.com/package/@vue/test-utils).