# @depup/mobx-react-lite

> [mobx-react-lite](https://www.npmjs.com/package/mobx-react-lite) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/mobx-react-lite
```
...
**Original version**: 5.0.3 | **DepUp version**: 5.0.3-depup.0 | **Updated**: 8/19/2026 | **Import test**: failed
...
This package inherits the license from [mobx-react-lite](https://www.npmjs.com/package/mobx-react-lite).