...
> [posthog-js](https://www.npmjs.com/package/posthog-js) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/posthog-js
```
...
**Original version**: 1.364.1 | **DepUp version**: 1.364.1-depup.0 | **Updated**: 3/27/2026 | **Import test**: passed
...
| @opentelemetry/api-logs | `^0.208.0` | `^0.214.0` |
| @opentelemetry/exporter-logs-otlp-http | `^0.208.0` | `^0.214.0` |
| @opentelemetry/resources | `^2.2.0` | `^2.6.1` |
| @opentelemetry/sdk-logs | `^0.208.0` | `^0.214.0` |
...
This package inherits the license from [posthog-js](https://www.npmjs.com/package/posthog-js).