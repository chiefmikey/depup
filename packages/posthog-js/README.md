...
**Original version**: 1.372.10 | **DepUp version**: 1.372.10-depup.0 | **Updated**: 5/8/2026 | **Import test**: passed
...
| @opentelemetry/api-logs | `^0.208.0` | `^0.217.0` |
| @opentelemetry/exporter-logs-otlp-http | `^0.208.0` | `^0.217.0` |
| @opentelemetry/resources | `^2.2.0` | `^2.7.1` |
| @opentelemetry/sdk-logs | `^0.208.0` | `^0.217.0` |
| core-js | `^3.38.1` | `^3.49.0` |
| dompurify | `^3.3.2` | `^3.4.2` |
| fflate | `^0.4.8` | `^0.8.2` |
