...
**Original version**: 1.383.2 | **DepUp version**: 1.383.2-depup.1 | **Updated**: 6/9/2026 | **Import test**: passed
...
| fflate | `^0.4.8` | `^0.8.3` |
| preact | `^10.28.2` | `^10.29.2` |
| web-vitals | `^5.1.0` | `^5.3.0` |
| @posthog/types | `1.383.2` | `^1.383.3` |
| @posthog/core | `1.30.13` | `^1.30.14` |
