...
**Original version**: 1.371.4 | **DepUp version**: 1.371.4-depup.0 | **Updated**: 4/24/2026 | **Import test**: passed
...
| @opentelemetry/api-logs | `^0.208.0` | `^0.215.0` |
| @opentelemetry/exporter-logs-otlp-http | `^0.208.0` | `^0.215.0` |
| @opentelemetry/resources | `^2.2.0` | `^2.7.0` |
| @opentelemetry/sdk-logs | `^0.208.0` | `^0.215.0` |
