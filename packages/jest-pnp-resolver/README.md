...
> Dependency-bumped version of jest-pnp-resolver

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for jest-pnp-resolver.
...
- **Original Package**: [jest-pnp-resolver](https://www.npmjs.com/package/jest-pnp-resolver)
- **DepUp Version**: 1.2.3-depup.0
...
- **Revision 0** (1.2.3-depup.0) - 🔴 Poor 0% integrity
