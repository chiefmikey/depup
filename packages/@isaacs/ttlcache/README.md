...
> Dependency-bumped version of @isaacs/ttlcache

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @isaacs/ttlcache.
...
- **Original Package**: [@isaacs/ttlcache](https://www.npmjs.com/package/@isaacs/ttlcache)
- **DepUp Version**: 2.1.4-depup.0
- **Original Version**: 2.1.4
...
- **Revision 0** (2.1.4-depup.0) - 🔴 Poor 0% integrity
