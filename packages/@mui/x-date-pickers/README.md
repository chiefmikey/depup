# @depup/mui__x-date-pickers

> [@mui/x-date-pickers](https://www.npmjs.com/package/@mui/x-date-pickers) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/mui__x-date-pickers
```
...
**Original version**: 8.27.2 | **DepUp version**: 8.27.2-depup.0 | **Updated**: 3/22/2026 | **Import test**: failed
...
This package inherits the license from [@mui/x-date-pickers](https://www.npmjs.com/package/@mui/x-date-pickers).