...
> [open-cli](https://www.npmjs.com/package/open-cli) with all dependencies updated to latest versions.
...
This package inherits the license from [open-cli](https://www.npmjs.com/package/open-cli).