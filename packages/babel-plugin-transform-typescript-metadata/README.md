...
> Dependency-bumped version of babel-plugin-transform-typescript-metadata

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for babel-plugin-transform-typescript-metadata.
...
- **Original Package**: [babel-plugin-transform-typescript-metadata](https://www.npmjs.com/package/babel-plugin-transform-typescript-metadata)
- **DepUp Version**: 0.4.0-depup.0
...
- **Revision 0** (0.4.0-depup.0) - 🔴 Poor 0% integrity
