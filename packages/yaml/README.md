...
> Dependency-bumped version of yaml

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for yaml.
...
- **Original Package**: [yaml](https://www.npmjs.com/package/yaml)
