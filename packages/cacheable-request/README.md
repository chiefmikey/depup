...
> Dependency-bumped version of cacheable-request

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for cacheable-request.
...
- **Original Package**: [cacheable-request](https://www.npmjs.com/package/cacheable-request)
- **DepUp Version**: 13.0.18-depup.0
- **Original Version**: 13.0.18
...
- **Revision 0** (13.0.18-depup.0) - 🔴 Poor 0% integrity
