...
> [ioredis](https://www.npmjs.com/package/ioredis) with all dependencies updated to latest versions.
...
**Original version**: 5.11.1 | **DepUp version**: 5.11.1-depup.45 | **Updated**: 7/21/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @ioredis/commands | `1.10.0` | `^1.11.0` |
| cluster-key-slot | `1.1.1` | `^1.1.2` |
...
This package inherits the license from [ioredis](https://www.npmjs.com/package/ioredis).