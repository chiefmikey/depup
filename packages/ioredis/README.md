...
> Dependency-bumped version of ioredis

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for ioredis.
...
- **Original Package**: [ioredis](https://www.npmjs.com/package/ioredis)
- **DepUp Version**: 5.10.0-depup.0
- **Original Version**: 5.10.0
...
- **Revision 0** (5.10.0-depup.0) - 🔴 Poor 0% integrity
