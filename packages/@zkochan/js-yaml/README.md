...
> Dependency-bumped version of @zkochan/js-yaml

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @zkochan/js-yaml.
...
- **Original Package**: [@zkochan/js-yaml](https://www.npmjs.com/package/@zkochan/js-yaml)
- **DepUp Version**: 0.0.11-depup.0
- **Original Version**: 0.0.11
...
- **Revision 0** (0.0.11-depup.0) - 🔴 Poor 0% integrity
