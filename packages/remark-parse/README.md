...
> Dependency-bumped version of remark-parse

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for remark-parse.
...
- **Original Package**: [remark-parse](https://www.npmjs.com/package/remark-parse)
