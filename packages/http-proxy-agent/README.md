...
> Dependency-bumped version of http-proxy-agent

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for http-proxy-agent.
...
- **Original Package**: [http-proxy-agent](https://www.npmjs.com/package/http-proxy-agent)
