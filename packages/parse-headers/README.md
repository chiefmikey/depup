...
> Dependency-bumped version of parse-headers

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for parse-headers.
...
- **Original Package**: [parse-headers](https://www.npmjs.com/package/parse-headers)
- **DepUp Version**: 2.0.6-depup.0
...
- **Revision 0** (2.0.6-depup.0) - 🔴 Poor 0% integrity
