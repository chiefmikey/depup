...
> [postgres](https://www.npmjs.com/package/postgres) with all dependencies updated to latest versions.
...
**Original version**: 3.4.8 | **DepUp version**: 3.4.8-depup.0 | **Updated**: 3/17/2026 | **Import test**: unknown

## What changed

No dependencies were updated (all already at latest).

Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/postgres&labels=bug).
...
This package inherits the license from [postgres](https://www.npmjs.com/package/postgres).