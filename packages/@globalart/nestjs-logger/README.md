# @depup/globalart__nestjs-logger

> [@globalart/nestjs-logger](https://www.npmjs.com/package/@globalart/nestjs-logger) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/globalart__nestjs-logger
```
...
**Original version**: 4.0.4 | **DepUp version**: 4.0.4-depup.42 | **Updated**: 6/30/2026 | **Import test**: passed
...
This package inherits the license from [@globalart/nestjs-logger](https://www.npmjs.com/package/@globalart/nestjs-logger).