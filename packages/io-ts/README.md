...
> Dependency-bumped version of io-ts

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for io-ts.
...
- **Original Package**: [io-ts](https://www.npmjs.com/package/io-ts)
- **DepUp Version**: 2.2.22-depup.0
- **Original Version**: 2.2.22
...
- **Revision 0** (2.2.22-depup.0) - 🔴 Poor 0% integrity
