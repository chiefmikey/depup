...
> Dependency-bumped version of fast-xml-parser

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for fast-xml-parser.
...
- **Original Package**: [fast-xml-parser](https://www.npmjs.com/package/fast-xml-parser)
- **DepUp Version**: 5.5.6-depup.0
- **Original Version**: 5.5.6
...
- **Revision 0** (5.5.6-depup.0) - 🔴 Poor 0% integrity
