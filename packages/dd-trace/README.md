...
> Dependency-bumped version of dd-trace

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for dd-trace.
...
- **Original Package**: [dd-trace](https://www.npmjs.com/package/dd-trace)
- **DepUp Version**: 5.90.0-depup.0
- **Original Version**: 5.90.0
...
- **Revision 0** (5.90.0-depup.0) - 🔴 Poor 0% integrity
