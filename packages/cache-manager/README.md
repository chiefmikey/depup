...
> [cache-manager](https://www.npmjs.com/package/cache-manager) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/cache-manager
```
...
**Original version**: 7.2.8 | **DepUp version**: 7.2.8-depup.22 | **Updated**: 6/16/2026 | **Import test**: passed
...
This package inherits the license from [cache-manager](https://www.npmjs.com/package/cache-manager).