...
> Dependency-bumped version of docker-modem

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for docker-modem.
...
- **Original Package**: [docker-modem](https://www.npmjs.com/package/docker-modem)
- **DepUp Version**: 5.0.6-depup.0
- **Original Version**: 5.0.6
...
- **Revision 0** (5.0.6-depup.0) - 🔴 Poor 0% integrity
