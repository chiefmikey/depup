# @depup/pac-proxy-agent

> [pac-proxy-agent](https://www.npmjs.com/package/pac-proxy-agent) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/pac-proxy-agent
```
...
This package inherits the license from [pac-proxy-agent](https://www.npmjs.com/package/pac-proxy-agent).