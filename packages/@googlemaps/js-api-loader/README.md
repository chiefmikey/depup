# @depup/googlemaps__js-api-loader

> [@googlemaps/js-api-loader](https://www.npmjs.com/package/@googlemaps/js-api-loader) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/googlemaps__js-api-loader
```
...
**Original version**: 2.1.1 | **DepUp version**: 2.1.1-depup.26 | **Updated**: 6/18/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @types/google.maps | `^3.53.1` | `^3.65.1` |
...
This package inherits the license from [@googlemaps/js-api-loader](https://www.npmjs.com/package/@googlemaps/js-api-loader).