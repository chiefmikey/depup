...
> Dependency-bumped version of class-transformer

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for class-transformer.
...
- **Original Package**: [class-transformer](https://www.npmjs.com/package/class-transformer)
- **DepUp Version**: 0.5.1-depup.0
...
- **Revision 0** (0.5.1-depup.0) - 🔴 Poor 0% integrity
