...
> [pdfkit](https://www.npmjs.com/package/pdfkit) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/pdfkit
```
...
|------------|----------|--------|
| @noble/ciphers | `^1.0.0` | `^2.1.1` |
| @noble/hashes | `^1.6.0` | `^2.0.1` |
...
This package inherits the license from [pdfkit](https://www.npmjs.com/package/pdfkit).