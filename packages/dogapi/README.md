...
> Dependency-bumped version of dogapi

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for dogapi.
...
- **Original Package**: [dogapi](https://www.npmjs.com/package/dogapi)
- **DepUp Version**: 2.8.4-depup.0
- **Original Version**: 2.8.4
...
- **Revision 0** (2.8.4-depup.0) - 🔴 Poor 0% integrity
