...
> Dependency-bumped version of systeminformation

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for systeminformation.
...
- **Original Package**: [systeminformation](https://www.npmjs.com/package/systeminformation)
- **DepUp Version**: 5.31.4-depup.0
- **Original Version**: 5.31.4
...
- **Revision 0** (5.31.4-depup.0) - 🔴 Poor 0% integrity
