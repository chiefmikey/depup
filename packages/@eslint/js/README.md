...
> Dependency-bumped version of @eslint/js

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @eslint/js.
...
- **Original Package**: [@eslint/js](https://www.npmjs.com/package/@eslint/js)
- **DepUp Version**: 10.0.1-depup.0
...
- **Revision 0** (10.0.1-depup.0) - 🔴 Poor 0% integrity
