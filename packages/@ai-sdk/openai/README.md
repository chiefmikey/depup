...
> [@ai-sdk/openai](https://www.npmjs.com/package/@ai-sdk/openai) with all dependencies updated to latest versions.
...
**Original version**: 3.0.71 | **DepUp version**: 3.0.71-depup.10 | **Updated**: 6/16/2026 | **Import test**: failed

## What changed

No dependencies were updated (all already at latest).

Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/ai-sdk__openai&labels=bug).
...
This package inherits the license from [@ai-sdk/openai](https://www.npmjs.com/package/@ai-sdk/openai).