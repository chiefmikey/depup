...
> Dependency-bumped version of sift

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for sift.
...
- **Original Package**: [sift](https://www.npmjs.com/package/sift)
- **DepUp Version**: 17.1.3-depup.0
- **Original Version**: 17.1.3
...
- **Revision 0** (17.1.3-depup.0) - 🔴 Poor 0% integrity
