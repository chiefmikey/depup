...
> [flat-cache](https://www.npmjs.com/package/flat-cache) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/flat-cache
```
...
**Original version**: 6.1.23 | **DepUp version**: 6.1.23-depup.15 | **Updated**: 7/13/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| hookified | `^1.15.0` | `^3.0.1` |
...
This package inherits the license from [flat-cache](https://www.npmjs.com/package/flat-cache).