...
> Dependency-bumped version of flat-cache

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for flat-cache.
...
- **Original Package**: [flat-cache](https://www.npmjs.com/package/flat-cache)
- **DepUp Version**: 6.1.20-depup.0
- **Original Version**: 6.1.20
...
- **Revision 0** (6.1.20-depup.0) - 🔴 Poor 0% integrity
