...
> Dependency-bumped version of @react-aria/ssr

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @react-aria/ssr.
...
- **Original Package**: [@react-aria/ssr](https://www.npmjs.com/package/@react-aria/ssr)
- **DepUp Version**: 3.9.10-depup.0
- **Original Version**: 3.9.10
...
- **Revision 0** (3.9.10-depup.0) - 🔴 Poor 0% integrity
