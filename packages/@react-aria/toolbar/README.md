# @depup/react-aria__toolbar

> [@react-aria/toolbar](https://www.npmjs.com/package/@react-aria/toolbar) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/react-aria__toolbar
```
...
**Original version**: 3.0.0-beta.26 | **DepUp version**: 3.0.0-beta.26-depup.29 | **Updated**: 7/31/2026 | **Import test**: passed
...
This package inherits the license from [@react-aria/toolbar](https://www.npmjs.com/package/@react-aria/toolbar).