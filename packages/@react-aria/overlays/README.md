# @depup/react-aria__overlays

> [@react-aria/overlays](https://www.npmjs.com/package/@react-aria/overlays) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/react-aria__overlays
```
...
**Original version**: 3.32.1 | **DepUp version**: 3.32.1-depup.37 | **Updated**: 7/31/2026 | **Import test**: passed
...
This package inherits the license from [@react-aria/overlays](https://www.npmjs.com/package/@react-aria/overlays).