...
> Dependency-bumped version of crypto-browserify

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for crypto-browserify.
...
- **Original Package**: [crypto-browserify](https://www.npmjs.com/package/crypto-browserify)
- **DepUp Version**: 3.12.1-depup.0
- **Original Version**: 3.12.1
...
- **Revision 0** (3.12.1-depup.0) - 🔴 Poor 0% integrity
