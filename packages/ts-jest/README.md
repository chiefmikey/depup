...
> [ts-jest](https://www.npmjs.com/package/ts-jest) with all dependencies updated to latest versions.
...
**Original version**: 29.4.6 | **DepUp version**: 29.4.6-depup.1 | **Updated**: 3/19/2026 | **Import test**: passed
...
Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/ts-jest&labels=bug).
...
This package inherits the license from [ts-jest](https://www.npmjs.com/package/ts-jest).