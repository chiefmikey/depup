...
> Dependency-bumped version of remeda

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for remeda.
...
- **Original Package**: [remeda](https://www.npmjs.com/package/remeda)
- **DepUp Version**: 2.33.6-depup.0
- **Original Version**: 2.33.6
...
- **Revision 0** (2.33.6-depup.0) - 🔴 Poor 0% integrity
