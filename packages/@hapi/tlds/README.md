...
> Dependency-bumped version of @hapi/tlds

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @hapi/tlds.
...
- **Original Package**: [@hapi/tlds](https://www.npmjs.com/package/@hapi/tlds)
- **DepUp Version**: 1.1.6-depup.0
- **Original Version**: 1.1.6
...
- **Revision 0** (1.1.6-depup.0) - 🔴 Poor 0% integrity
