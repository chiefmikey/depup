...
> Dependency-bumped version of conf

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for conf.
...
- **Original Package**: [conf](https://www.npmjs.com/package/conf)
- **DepUp Version**: 15.1.0-depup.0
- **Original Version**: 15.1.0
...
- **Revision 0** (15.1.0-depup.0) - 🔴 Poor 0% integrity
