...
> Dependency-bumped version of readable-web-to-node-stream

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for readable-web-to-node-stream.
...
- **Original Package**: [readable-web-to-node-stream](https://www.npmjs.com/package/readable-web-to-node-stream)
- **DepUp Version**: 5.0.0-depup.0
...
- **Revision 0** (5.0.0-depup.0) - 🔴 Poor 0% integrity
