...
> Dependency-bumped version of unbuild

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for unbuild.
...
- **DepUp Version**: 3.6.1-depup.0
- **Original Version**: 3.6.1
...
- **Revision 0** (3.6.1-depup.0) - 🔴 Poor 0% integrity
