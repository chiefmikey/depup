...
> [handlebars](https://www.npmjs.com/package/handlebars) with all dependencies updated to latest versions.
...
**Original version**: 4.7.8 | **DepUp version**: 4.7.8-depup.0 | **Updated**: 3/9/2026 | **Import test**: unknown
...
This package inherits the license from [handlebars](https://www.npmjs.com/package/handlebars).