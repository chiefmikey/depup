...
> Dependency-bumped version of swc

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for swc.
...
- **DepUp Version**: 1.0.11-depup.0
- **Original Version**: 1.0.11
...
- **Revision 0** (1.0.11-depup.0) - 🔴 Poor 0% integrity
