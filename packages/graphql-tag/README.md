...
> Dependency-bumped version of graphql-tag

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for graphql-tag.
...
- **Original Package**: [graphql-tag](https://www.npmjs.com/package/graphql-tag)
- **DepUp Version**: 2.12.6-depup.0
- **Original Version**: 2.12.6
...
- **Revision 0** (2.12.6-depup.0) - 🔴 Poor 0% integrity
