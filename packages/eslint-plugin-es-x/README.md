...
> Dependency-bumped version of eslint-plugin-es-x

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for eslint-plugin-es-x.
...
- **Original Package**: [eslint-plugin-es-x](https://www.npmjs.com/package/eslint-plugin-es-x)
- **DepUp Version**: 9.5.0-depup.0
- **Original Version**: 9.5.0
...
- **Revision 0** (9.5.0-depup.0) - 🔴 Poor 0% integrity
