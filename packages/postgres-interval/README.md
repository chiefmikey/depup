...
> Dependency-bumped version of postgres-interval

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for postgres-interval.
...
- **Original Package**: [postgres-interval](https://www.npmjs.com/package/postgres-interval)
- **DepUp Version**: 4.0.2-depup.0
- **Original Version**: 4.0.2
...
- **Revision 0** (4.0.2-depup.0) - 🔴 Poor 0% integrity
