...
**Original version**: 6.43.0 | **DepUp version**: 6.43.0-depup.0 | **Updated**: 5/29/2026 | **Import test**: failed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @aws-sdk/client-s3 | `3.1053.0` | `^3.1056.0` |
