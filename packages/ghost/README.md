...
**Original version**: 6.45.0 | **DepUp version**: 6.45.0-depup.10 | **Updated**: 6/16/2026 | **Import test**: failed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @aws-sdk/client-s3 | `3.1064.0` | `^3.1069.0` |
...
| ghost-storage-base | `1.1.2` | `^2.0.0` |
| got | `13.0.0` | `^15.0.5` |
...
| metascraper-amazon | `5.45.10` | `^5.50.6` |
