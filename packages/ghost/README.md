...
> Dependency-bumped version of ghost

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for ghost.
...
- **Original Package**: [ghost](https://www.npmjs.com/package/ghost)
- **DepUp Version**: 6.22.0-depup.0
- **Original Version**: 6.22.0
...
- **Revision 0** (6.22.0-depup.0) - 🔴 Poor 0% integrity
