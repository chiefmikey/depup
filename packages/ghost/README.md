...
**Original version**: 6.22.0 | **DepUp version**: 6.22.0-depup.0 | **Updated**: 3/17/2026
...
| @tryghost/mw-error-handler | `1.0.7` | `^3.0.3` |
| @tryghost/mw-vhost | `1.0.1` | `^3.0.3` |
...
| intl-messageformat | `5.4.3` | `^11.1.3` |
| js-yaml | `4.1.0` | `^4.1.1` |
