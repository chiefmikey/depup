...
> Dependency-bumped version of prosemirror-schema-basic

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for prosemirror-schema-basic.
...
- **Original Package**: [prosemirror-schema-basic](https://www.npmjs.com/package/prosemirror-schema-basic)
- **DepUp Version**: 1.2.4-depup.0
...
- **Revision 0** (1.2.4-depup.0) - 🔴 Poor 0% integrity
