# @depup/html-react-parser

> [html-react-parser](https://www.npmjs.com/package/html-react-parser) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/html-react-parser
```
...
**Original version**: 5.2.17 | **DepUp version**: 5.2.17-depup.1 | **Updated**: 3/30/2026 | **Import test**: failed
...
This package inherits the license from [html-react-parser](https://www.npmjs.com/package/html-react-parser).