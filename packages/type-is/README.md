...
> [type-is](https://www.npmjs.com/package/type-is) with all dependencies updated to latest versions.
...
**Original version**: 2.1.0 | **DepUp version**: 2.1.0-depup.21 | **Updated**: 6/15/2026 | **Import test**: passed
...
This package inherits the license from [type-is](https://www.npmjs.com/package/type-is).