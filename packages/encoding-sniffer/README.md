# @depup/encoding-sniffer

> [encoding-sniffer](https://www.npmjs.com/package/encoding-sniffer) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/encoding-sniffer
```
...
This package inherits the license from [encoding-sniffer](https://www.npmjs.com/package/encoding-sniffer).