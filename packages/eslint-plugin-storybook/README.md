# @depup/eslint-plugin-storybook

> [eslint-plugin-storybook](https://www.npmjs.com/package/eslint-plugin-storybook) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/eslint-plugin-storybook
```
...
**Original version**: 10.5.10 | **DepUp version**: 10.5.10-depup.1 | **Updated**: 8/25/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @typescript-eslint/types | `^8.60.0` | `^8.68.0` |
| @typescript-eslint/utils | `^8.60.0` | `^8.68.0` |
...
This package inherits the license from [eslint-plugin-storybook](https://www.npmjs.com/package/eslint-plugin-storybook).