...
> [web-push](https://www.npmjs.com/package/web-push) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/web-push
```
...
Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/web-push&labels=bug).
...
This package inherits the license from [web-push](https://www.npmjs.com/package/web-push).