...
**Original version**: 9.0.7 | **DepUp version**: 9.0.7-depup.45 | **Updated**: 7/26/2026 | **Import test**: failed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @npmcli/arborist | `9.1.6` | `^10.0.1` |
| @npmcli/package-json | `7.0.2` | `^8.0.0` |
| @npmcli/run-script | `10.0.3` | `^11.0.0` |
| @nx/devkit | `>=21.5.2 < 23.0.0` | `^23.1.0` |
...
| conventional-changelog-angular | `7.0.0` | `^9.2.1` |
| conventional-changelog-core | `5.0.1` | `^9.0.0` |
| conventional-recommended-bump | `7.0.1` | `^12.1.0` |
