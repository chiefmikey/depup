...
> Dependency-bumped version of lerna

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for lerna.
...
- **DepUp Version**: 9.0.5-depup.0
- **Original Version**: 9.0.5
...
- **Revision 0** (9.0.5-depup.0) - 🔴 Poor 0% integrity
