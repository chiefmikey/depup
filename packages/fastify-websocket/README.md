# @depup/fastify-websocket

> [fastify-websocket](https://www.npmjs.com/package/fastify-websocket) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/fastify-websocket
```
...
**Original version**: 4.3.0 | **DepUp version**: 4.3.0-depup.0 | **Updated**: 3/18/2026 | **Import test**: failed
...
This package inherits the license from [fastify-websocket](https://www.npmjs.com/package/fastify-websocket).