...
> Dependency-bumped version of elastic

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for elastic.
...
- **Original Package**: [elastic](https://www.npmjs.com/package/elastic)
- **DepUp Version**: 0.1.10-depup.0
- **Original Version**: 0.1.10
...
- **Revision 0** (0.1.10-depup.0) - 🔴 Poor 0% integrity
