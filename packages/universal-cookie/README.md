# @depup/universal-cookie

> [universal-cookie](https://www.npmjs.com/package/universal-cookie) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/universal-cookie
```
...
This package inherits the license from [universal-cookie](https://www.npmjs.com/package/universal-cookie).