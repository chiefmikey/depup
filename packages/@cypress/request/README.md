...
> Dependency-bumped version of @cypress/request

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @cypress/request.
...
- **Original Package**: [@cypress/request](https://www.npmjs.com/package/@cypress/request)
- **DepUp Version**: 3.0.10-depup.0
- **Original Version**: 3.0.10
...
- **Revision 0** (3.0.10-depup.0) - 🔴 Poor 0% integrity
