...
> Dependency-bumped version of oauth-sign

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for oauth-sign.
...
- **Original Package**: [oauth-sign](https://www.npmjs.com/package/oauth-sign)
- **DepUp Version**: 0.9.0-depup.0
...
- **Revision 0** (0.9.0-depup.0) - 🔴 Poor 0% integrity
