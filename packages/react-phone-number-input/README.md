# @depup/react-phone-number-input

> [react-phone-number-input](https://www.npmjs.com/package/react-phone-number-input) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/react-phone-number-input
```
...
**Original version**: 3.4.16 | **DepUp version**: 3.4.16-depup.0 | **Updated**: 3/19/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| country-flag-icons | `^1.6.14` | `^1.6.15` |
| libphonenumber-js | `^1.12.37` | `^1.12.40` |
...
This package inherits the license from [react-phone-number-input](https://www.npmjs.com/package/react-phone-number-input).