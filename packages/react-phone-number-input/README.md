...
**Original version**: 3.4.17 | **DepUp version**: 3.4.17-depup.51 | **Updated**: 7/13/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| country-flag-icons | `^1.6.14` | `^1.6.20` |
| libphonenumber-js | `^1.13.4` | `^1.13.8` |
