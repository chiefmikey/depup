...
> Dependency-bumped version of combined-stream

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for combined-stream.
...
- **Original Package**: [combined-stream](https://www.npmjs.com/package/combined-stream)
- **DepUp Version**: 1.0.8-depup.0
- **Original Version**: 1.0.8
...
- **Revision 0** (1.0.8-depup.0) - 🔴 Poor 0% integrity
