...
**Original version**: 3.8.8 | **DepUp version**: 3.8.8-depup.47 | **Updated**: 7/2/2026 | **Import test**: failed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @npmcli/arborist | `^2.6.4` | `^9.9.0` |
...
| postcss | `^8.3.5` | `^8.5.16` |
| postcss-modules | `^4.0.0` | `^9.0.0` |
