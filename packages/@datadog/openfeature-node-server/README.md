...
> Dependency-bumped version of @datadog/openfeature-node-server

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @datadog/openfeature-node-server.
...
- **Original Package**: [@datadog/openfeature-node-server](https://www.npmjs.com/package/@datadog/openfeature-node-server)
- **DepUp Version**: 1.1.0-depup.0
...
- **Revision 0** (1.1.0-depup.0) - 🔴 Poor 0% integrity
