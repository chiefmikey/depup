...
**Original version**: 4.18.0 | **DepUp version**: 4.18.0-depup.11 | **Updated**: 9/9/2026 | **Import test**: failed
...
| @opentelemetry/sdk-metrics | `^2.8.0` | `^2.11.0` |
...
| import-in-the-middle | `1.15.0` | `^3.5.0` |
