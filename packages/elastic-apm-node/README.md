...
**Original version**: 4.15.0 | **DepUp version**: 4.15.0-depup.2 | **Updated**: 4/17/2026 | **Import test**: failed
...
| @opentelemetry/core | `^1.11.0` | `^2.7.0` |
| @opentelemetry/sdk-metrics | `^1.12.0` | `^2.7.0` |
