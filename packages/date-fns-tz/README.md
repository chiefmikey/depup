...
> Dependency-bumped version of date-fns-tz

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for date-fns-tz.
...
- **Original Package**: [date-fns-tz](https://www.npmjs.com/package/date-fns-tz)
