# @depup/normalize-package-data

> [normalize-package-data](https://www.npmjs.com/package/normalize-package-data) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/normalize-package-data
```
...
**Original version**: 8.0.0 | **DepUp version**: 8.0.0-depup.2 | **Updated**: 5/12/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| hosted-git-info | `^9.0.0` | `^10.1.0` |
| semver | `^7.3.5` | `^7.8.0` |
...
This package inherits the license from [normalize-package-data](https://www.npmjs.com/package/normalize-package-data).