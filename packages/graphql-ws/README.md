...
> Dependency-bumped version of graphql-ws

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for graphql-ws.
...
- **Original Package**: [graphql-ws](https://www.npmjs.com/package/graphql-ws)
- **DepUp Version**: 6.0.7-depup.0
- **Original Version**: 6.0.7
...
- **Revision 0** (6.0.7-depup.0) - 🔴 Poor 0% integrity
