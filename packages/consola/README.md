...
> Dependency-bumped version of consola

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for consola.
...
- **Original Package**: [consola](https://www.npmjs.com/package/consola)
- **DepUp Version**: 3.4.2-depup.0
- **Original Version**: 3.4.2
...
- **Revision 0** (3.4.2-depup.0) - 🔴 Poor 0% integrity
