...
> Dependency-bumped version of vuetify

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for vuetify.
...
- **Original Package**: [vuetify](https://www.npmjs.com/package/vuetify)
- **DepUp Version**: 4.0.2-depup.1
...
- **Revision 0** (4.0.1-depup.0) - 🔴 Poor 0% integrity

### Version 4.0.2

- **Revision 1** (4.0.2-depup.1) - 🔴 Poor 0% integrity
