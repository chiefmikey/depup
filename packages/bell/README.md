...
> [bell](https://www.npmjs.com/package/bell) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/bell
```
...
**Original version**: 10.0.0 | **DepUp version**: 10.0.0-depup.2 | **Updated**: 5/5/2026 | **Import test**: failed
...
Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/bell&labels=bug).
...
This package inherits the license from [bell](https://www.npmjs.com/package/bell).