...
> Dependency-bumped version of @opentelemetry/redis-common

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @opentelemetry/redis-common.
...
- **Original Package**: [@opentelemetry/redis-common](https://www.npmjs.com/package/@opentelemetry/redis-common)
- **DepUp Version**: 0.38.2-depup.0
- **Original Version**: 0.38.2
...
- **Revision 0** (0.38.2-depup.0) - 🔴 Poor 0% integrity
