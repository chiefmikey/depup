# @depup/opentelemetry__sdk-node

> [@opentelemetry/sdk-node](https://www.npmjs.com/package/@opentelemetry/sdk-node) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/opentelemetry__sdk-node
```
...
**Original version**: 0.220.0 | **DepUp version**: 0.220.0-depup.10 | **Updated**: 7/13/2026 | **Import test**: passed
...
This package inherits the license from [@opentelemetry/sdk-node](https://www.npmjs.com/package/@opentelemetry/sdk-node).