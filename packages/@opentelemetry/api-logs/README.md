# @depup/opentelemetry__api-logs

> [@opentelemetry/api-logs](https://www.npmjs.com/package/@opentelemetry/api-logs) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/opentelemetry__api-logs
```
...
This package inherits the license from [@opentelemetry/api-logs](https://www.npmjs.com/package/@opentelemetry/api-logs).