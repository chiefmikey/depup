...
> Dependency-bumped version of @opentelemetry/api-logs

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @opentelemetry/api-logs.
...
- **Original Package**: [@opentelemetry/api-logs](https://www.npmjs.com/package/@opentelemetry/api-logs)
