...
> Dependency-bumped version of @opentelemetry/instrumentation-nestjs-core

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @opentelemetry/instrumentation-nestjs-core.
...
- **Original Package**: [@opentelemetry/instrumentation-nestjs-core](https://www.npmjs.com/package/@opentelemetry/instrumentation-nestjs-core)
- **DepUp Version**: 0.59.0-depup.0
- **Original Version**: 0.59.0
...
- **Revision 0** (0.59.0-depup.0) - 🔴 Poor 0% integrity
