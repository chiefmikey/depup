...
> Dependency-bumped version of @opentelemetry/api

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @opentelemetry/api.
...
- **Revision 0** (1.9.0-depup.0) - 🔴 Poor 0% integrity
