...
> Dependency-bumped version of websocket-driver

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for websocket-driver.
...
- **Original Package**: [websocket-driver](https://www.npmjs.com/package/websocket-driver)
- **DepUp Version**: 0.7.4-depup.0
- **Original Version**: 0.7.4
...
- **Revision 0** (0.7.4-depup.0) - 🔴 Poor 0% integrity
