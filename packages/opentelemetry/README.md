...
> Dependency-bumped version of opentelemetry

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for opentelemetry.
...
- **Original Package**: [opentelemetry](https://www.npmjs.com/package/opentelemetry)
- **DepUp Version**: 0.1.0-depup.0
...
- **Revision 0** (0.1.0-depup.0) - 🔴 Poor 0% integrity
