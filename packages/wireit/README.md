...
> [wireit](https://www.npmjs.com/package/wireit) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/wireit
```
...
**Original version**: 0.14.13 | **DepUp version**: 0.14.13-depup.20 | **Updated**: 7/14/2026 | **Import test**: failed
...
Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/wireit&labels=bug).
...
This package inherits the license from [wireit](https://www.npmjs.com/package/wireit).