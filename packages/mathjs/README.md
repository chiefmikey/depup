...
> [mathjs](https://www.npmjs.com/package/mathjs) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/mathjs
```
...
**Original version**: 15.1.1 | **DepUp version**: 15.1.1-depup.0 | **Updated**: 3/18/2026 | **Import test**: unknown
...
| typed-function | `^4.2.1` | `^4.2.2` |


Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/mathjs&labels=bug).
...
This package inherits the license from [mathjs](https://www.npmjs.com/package/mathjs).