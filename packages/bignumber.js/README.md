...
> Dependency-bumped version of bignumber.js

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for bignumber.js.
...
- **Original Package**: [bignumber.js](https://www.npmjs.com/package/bignumber.js)
- **DepUp Version**: 10.0.2-depup.0
...
- **Revision 0** (10.0.2-depup.0) - 🔴 Poor 0% integrity
