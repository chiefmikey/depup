...
> Dependency-bumped version of del

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for del.
...
- **Original Package**: [del](https://www.npmjs.com/package/del)
- **DepUp Version**: 8.0.1-depup.0
...
- **Revision 0** (8.0.1-depup.0) - 🔴 Poor 0% integrity
