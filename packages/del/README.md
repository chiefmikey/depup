...
> [del](https://www.npmjs.com/package/del) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/del
```
...
**Original version**: 8.0.1 | **DepUp version**: 8.0.1-depup.0 | **Updated**: 3/8/2026 | **Import test**: unknown

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| globby | `^14.0.2` | `^16.1.1` |
...
This package inherits the license from [del](https://www.npmjs.com/package/del).