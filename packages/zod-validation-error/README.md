...
> Dependency-bumped version of zod-validation-error

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for zod-validation-error.
...
- **Original Package**: [zod-validation-error](https://www.npmjs.com/package/zod-validation-error)
