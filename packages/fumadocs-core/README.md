...
> [fumadocs-core](https://www.npmjs.com/package/fumadocs-core) with all dependencies updated to latest versions.
...
**Original version**: 16.10.1 | **DepUp version**: 16.10.1-depup.1 | **Updated**: 6/12/2026 | **Import test**: failed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @fuma-translate/react | `^1.0.1` | `^1.0.2` |
...
This package inherits the license from [fumadocs-core](https://www.npmjs.com/package/fumadocs-core).