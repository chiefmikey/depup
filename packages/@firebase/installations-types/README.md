...
> Dependency-bumped version of @firebase/installations-types

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @firebase/installations-types.
...
- **Original Package**: [@firebase/installations-types](https://www.npmjs.com/package/@firebase/installations-types)
- **DepUp Version**: 0.5.3-depup.0
- **Original Version**: 0.5.3
...
- **Revision 0** (0.5.3-depup.0) - 🔴 Poor 0% integrity
