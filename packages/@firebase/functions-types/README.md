...
> Dependency-bumped version of @firebase/functions-types

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @firebase/functions-types.
...
- **Original Package**: [@firebase/functions-types](https://www.npmjs.com/package/@firebase/functions-types)
- **DepUp Version**: 0.6.3-depup.0
...
- **Revision 0** (0.6.3-depup.0) - 🔴 Poor 0% integrity
