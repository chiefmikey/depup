...
> Dependency-bumped version of @firebase/app-check-compat

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @firebase/app-check-compat.
...
- **Original Package**: [@firebase/app-check-compat](https://www.npmjs.com/package/@firebase/app-check-compat)
- **DepUp Version**: 0.4.1-depup.0
- **Original Version**: 0.4.1
...
- **Revision 0** (0.4.1-depup.0) - 🔴 Poor 0% integrity
