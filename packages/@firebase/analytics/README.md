...
> Dependency-bumped version of @firebase/analytics

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @firebase/analytics.
...
- **Original Package**: [@firebase/analytics](https://www.npmjs.com/package/@firebase/analytics)
- **DepUp Version**: 0.10.20-depup.0
- **Original Version**: 0.10.20
...
- **Revision 0** (0.10.20-depup.0) - 🔴 Poor 0% integrity
