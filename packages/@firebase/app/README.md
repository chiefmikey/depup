...
> Dependency-bumped version of @firebase/app

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @firebase/app.
...
- **Original Package**: [@firebase/app](https://www.npmjs.com/package/@firebase/app)
- **DepUp Version**: 0.14.9-depup.0
- **Original Version**: 0.14.9
...
- **Revision 0** (0.14.9-depup.0) - 🔴 Poor 0% integrity
