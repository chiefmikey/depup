...
> Dependency-bumped version of @firebase/firestore-compat

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @firebase/firestore-compat.
...
- **Original Package**: [@firebase/firestore-compat](https://www.npmjs.com/package/@firebase/firestore-compat)
- **DepUp Version**: 0.4.6-depup.0
...
- **Revision 0** (0.4.6-depup.0) - 🔴 Poor 0% integrity
