...
> Dependency-bumped version of @firebase/auth-types

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @firebase/auth-types.
...
- **Original Package**: [@firebase/auth-types](https://www.npmjs.com/package/@firebase/auth-types)
- **DepUp Version**: 0.13.0-depup.0
- **Original Version**: 0.13.0
...
- **Revision 0** (0.13.0-depup.0) - 🔴 Poor 0% integrity
