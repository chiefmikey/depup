...
> Dependency-bumped version of @firebase/database-compat

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @firebase/database-compat.
...
- **Original Package**: [@firebase/database-compat](https://www.npmjs.com/package/@firebase/database-compat)
- **DepUp Version**: 2.1.1-depup.0
...
- **Revision 0** (2.1.1-depup.0) - 🔴 Poor 0% integrity
