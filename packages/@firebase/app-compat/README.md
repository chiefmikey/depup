...
> Dependency-bumped version of @firebase/app-compat

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @firebase/app-compat.
...
- **Original Package**: [@firebase/app-compat](https://www.npmjs.com/package/@firebase/app-compat)
- **DepUp Version**: 0.5.9-depup.0
- **Original Version**: 0.5.9
...
- **Revision 0** (0.5.9-depup.0) - 🔴 Poor 0% integrity
