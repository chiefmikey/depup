...
> Dependency-bumped version of @firebase/app-check

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @firebase/app-check.
...
- **Original Package**: [@firebase/app-check](https://www.npmjs.com/package/@firebase/app-check)
- **DepUp Version**: 0.11.1-depup.0
- **Original Version**: 0.11.1
...
- **Revision 0** (0.11.1-depup.0) - 🔴 Poor 0% integrity
