...
> Dependency-bumped version of @firebase/app-types

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @firebase/app-types.
...
- **Original Package**: [@firebase/app-types](https://www.npmjs.com/package/@firebase/app-types)
- **DepUp Version**: 0.9.3-depup.0
...
- **Revision 0** (0.9.3-depup.0) - 🔴 Poor 0% integrity
