...
> Dependency-bumped version of @firebase/remote-config

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @firebase/remote-config.
...
- **Original Package**: [@firebase/remote-config](https://www.npmjs.com/package/@firebase/remote-config)
- **DepUp Version**: 0.8.1-depup.0
...
- **Revision 0** (0.8.1-depup.0) - 🔴 Poor 0% integrity
