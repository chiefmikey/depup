...
> Dependency-bumped version of @firebase/firestore

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @firebase/firestore.
...
- **Original Package**: [@firebase/firestore](https://www.npmjs.com/package/@firebase/firestore)
- **DepUp Version**: 4.12.0-depup.0
...
- **Revision 0** (4.12.0-depup.0) - 🔴 Poor 0% integrity
