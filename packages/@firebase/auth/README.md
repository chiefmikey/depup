...
> Dependency-bumped version of @firebase/auth

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @firebase/auth.
...
- **Original Package**: [@firebase/auth](https://www.npmjs.com/package/@firebase/auth)
- **DepUp Version**: 1.12.1-depup.0
- **Original Version**: 1.12.1
...
- **Revision 0** (1.12.1-depup.0) - 🔴 Poor 0% integrity
