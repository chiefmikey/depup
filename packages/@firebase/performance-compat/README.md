...
> Dependency-bumped version of @firebase/performance-compat

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @firebase/performance-compat.
...
- **Original Package**: [@firebase/performance-compat](https://www.npmjs.com/package/@firebase/performance-compat)
- **DepUp Version**: 0.2.23-depup.0
- **Original Version**: 0.2.23
...
- **Revision 0** (0.2.23-depup.0) - 🔴 Poor 0% integrity
