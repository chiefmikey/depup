...
> Dependency-bumped version of @firebase/messaging

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @firebase/messaging.
...
- **Original Package**: [@firebase/messaging](https://www.npmjs.com/package/@firebase/messaging)
- **DepUp Version**: 0.12.24-depup.0
- **Original Version**: 0.12.24
...
- **Revision 0** (0.12.24-depup.0) - 🔴 Poor 0% integrity
