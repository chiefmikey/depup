...
> [fakeredis](https://www.npmjs.com/package/fakeredis) with all dependencies updated to latest versions.
...
This package inherits the license from [fakeredis](https://www.npmjs.com/package/fakeredis).