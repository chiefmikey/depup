...
> Dependency-bumped version of discord-api-types

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for discord-api-types.
...
- **Original Package**: [discord-api-types](https://www.npmjs.com/package/discord-api-types)
- **DepUp Version**: 0.38.42-depup.0
- **Original Version**: 0.38.42
...
- **Revision 0** (0.38.42-depup.0) - 🔴 Poor 0% integrity
