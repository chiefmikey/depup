# @depup/storybook__addon-interactions

> [@storybook/addon-interactions](https://www.npmjs.com/package/@storybook/addon-interactions) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/storybook__addon-interactions
```
...
**Original version**: 8.6.14 | **DepUp version**: 8.6.14-depup.0 | **Updated**: 3/18/2026 | **Import test**: passed
...
This package inherits the license from [@storybook/addon-interactions](https://www.npmjs.com/package/@storybook/addon-interactions).