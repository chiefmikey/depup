...
> Dependency-bumped version of ast-types

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for ast-types.
...
- **Original Package**: [ast-types](https://www.npmjs.com/package/ast-types)
- **DepUp Version**: 0.14.2-depup.0
- **Original Version**: 0.14.2
...
- **Revision 0** (0.14.2-depup.0) - 🔴 Poor 0% integrity
