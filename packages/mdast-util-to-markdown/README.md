...
> Dependency-bumped version of mdast-util-to-markdown

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for mdast-util-to-markdown.
...
- **Original Package**: [mdast-util-to-markdown](https://www.npmjs.com/package/mdast-util-to-markdown)
- **DepUp Version**: 2.1.2-depup.0
- **Original Version**: 2.1.2
...
- **Revision 0** (2.1.2-depup.0) - 🔴 Poor 0% integrity
