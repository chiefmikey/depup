...
> [zone.js](https://www.npmjs.com/package/zone.js) with all dependencies updated to latest versions.
...
**Original version**: 0.16.1 | **DepUp version**: 0.16.1-depup.0 | **Updated**: 3/9/2026 | **Import test**: unknown

## What changed

No dependency changes in the latest revision.

Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/zone.js&labels=bug).
...
This package inherits the license from [zone.js](https://www.npmjs.com/package/zone.js).