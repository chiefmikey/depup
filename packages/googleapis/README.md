...
**Original version**: 176.0.0 | **DepUp version**: 176.0.0-depup.0 | **Updated**: 8/19/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| google-auth-library | `10.5.0` | `^11.0.2` |
| googleapis-common | `^8.0.0` | `^9.0.3` |
