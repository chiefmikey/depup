...
> [googleapis](https://www.npmjs.com/package/googleapis) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/googleapis
```
...
**Original version**: 173.0.0 | **DepUp version**: 173.0.0-depup.56 | **Updated**: 7/30/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| google-auth-library | `^10.2.0` | `^11.0.0` |
| googleapis-common | `^8.0.0` | `^9.0.0` |
...
This package inherits the license from [googleapis](https://www.npmjs.com/package/googleapis).