...
> [open](https://www.npmjs.com/package/open) with all dependencies updated to latest versions.
...
This package inherits the license from [open](https://www.npmjs.com/package/open).