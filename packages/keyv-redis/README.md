...
> [keyv-redis](https://www.npmjs.com/package/keyv-redis) with all dependencies updated to latest versions.
...
**Original version**: 1.3.4 | **DepUp version**: 1.3.4-depup.0 | **Updated**: 3/17/2026 | **Import test**: unknown
...
This package inherits the license from [keyv-redis](https://www.npmjs.com/package/keyv-redis).