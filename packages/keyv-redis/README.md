...
> Dependency-bumped version of keyv-redis

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for keyv-redis.
...
- **Original Package**: [keyv-redis](https://www.npmjs.com/package/keyv-redis)
- **DepUp Version**: 1.3.4-depup.0
...
- **Revision 0** (1.3.4-depup.0) - 🔴 Poor 0% integrity
