...
> Dependency-bumped version of winston-transport

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for winston-transport.
...
- **Original Package**: [winston-transport](https://www.npmjs.com/package/winston-transport)
- **DepUp Version**: 4.9.0-depup.0
...
- **Revision 0** (4.9.0-depup.0) - 🔴 Poor 0% integrity
