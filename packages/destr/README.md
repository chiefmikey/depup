...
> Dependency-bumped version of destr

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for destr.
...
- **Original Package**: [destr](https://www.npmjs.com/package/destr)
- **DepUp Version**: 2.0.5-depup.0
...
- **Revision 0** (2.0.5-depup.0) - 🔴 Poor 0% integrity
