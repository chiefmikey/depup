...
> [wait-on](https://www.npmjs.com/package/wait-on) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/wait-on
```
...
**Original version**: 9.0.10 | **DepUp version**: 9.0.10-depup.20 | **Updated**: 6/15/2026 | **Import test**: passed
...
This package inherits the license from [wait-on](https://www.npmjs.com/package/wait-on).