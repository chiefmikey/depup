# @depup/express-openapi-validator

> [express-openapi-validator](https://www.npmjs.com/package/express-openapi-validator) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/express-openapi-validator
```
...
**Original version**: 5.6.2 | **DepUp version**: 5.6.2-depup.10 | **Updated**: 8/28/2026 | **Import test**: failed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @apidevtools/json-schema-ref-parser | `^14.2.1` | `^16.0.1` |
| @types/multer | `^2.0.0` | `^2.2.0` |
| ajv | `^8.17.1` | `^8.20.0` |
...
This package inherits the license from [express-openapi-validator](https://www.npmjs.com/package/express-openapi-validator).