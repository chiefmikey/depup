# @depup/vitest__expect

> [@vitest/expect](https://www.npmjs.com/package/@vitest/expect) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/vitest__expect
```
...
This package inherits the license from [@vitest/expect](https://www.npmjs.com/package/@vitest/expect).