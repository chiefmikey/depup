...
> [@vitest/snapshot](https://www.npmjs.com/package/@vitest/snapshot) with all dependencies updated to latest versions.
...
**Original version**: 4.1.10 | **DepUp version**: 4.1.10-depup.7 | **Updated**: 7/23/2026 | **Import test**: passed
...
Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/vitest__snapshot&labels=bug).
...
This package inherits the license from [@vitest/snapshot](https://www.npmjs.com/package/@vitest/snapshot).