...
> Dependency-bumped version of @vitest/coverage-v8

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @vitest/coverage-v8.
...
- **Original Package**: [@vitest/coverage-v8](https://www.npmjs.com/package/@vitest/coverage-v8)
