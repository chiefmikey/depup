...
> [@vitest/runner](https://www.npmjs.com/package/@vitest/runner) with all dependencies updated to latest versions.
...
This package inherits the license from [@vitest/runner](https://www.npmjs.com/package/@vitest/runner).