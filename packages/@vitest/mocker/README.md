...
> [@vitest/mocker](https://www.npmjs.com/package/@vitest/mocker) with all dependencies updated to latest versions.
...
This package inherits the license from [@vitest/mocker](https://www.npmjs.com/package/@vitest/mocker).