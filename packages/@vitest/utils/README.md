...
> [@vitest/utils](https://www.npmjs.com/package/@vitest/utils) with all dependencies updated to latest versions.
...
This package inherits the license from [@vitest/utils](https://www.npmjs.com/package/@vitest/utils).