...
> Dependency-bumped version of tslib

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for tslib.
...
- **Original Package**: [tslib](https://www.npmjs.com/package/tslib)
- **DepUp Version**: 2.8.1-depup.0
- **Original Version**: 2.8.1
...
- **Revision 0** (2.8.1-depup.0) - 🔴 Poor 0% integrity
