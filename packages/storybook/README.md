...
**Original version**: 10.4.0 | **DepUp version**: 10.4.0-depup.1 | **Updated**: 5/16/2026 | **Import test**: failed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @vitest/expect | `3.2.4` | `^4.1.6` |
| @vitest/spy | `3.2.4` | `^4.1.6` |
| esbuild | `^0.18.0 || ^0.19.0 || ^0.20.0 || ^0.21.0 || ^0.22.0 || ^0.23.0 || ^0.24.0 || ^0.25.0 || ^0.26.0 || ^0.27.0` | `^0.28.0` |
| open | `^10.2.0` | `^11.0.0` |
| oxc-parser | `^0.127.0` | `^0.131.0` |
