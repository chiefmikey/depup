...
> Dependency-bumped version of humanize-duration

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for humanize-duration.
...
- **Original Package**: [humanize-duration](https://www.npmjs.com/package/humanize-duration)
- **DepUp Version**: 3.33.2-depup.0
- **Original Version**: 3.33.2
...
- **Revision 0** (3.33.2-depup.0) - 🔴 Poor 0% integrity
