...
> Dependency-bumped version of json-schema-ref-resolver

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for json-schema-ref-resolver.
...
- **Original Package**: [json-schema-ref-resolver](https://www.npmjs.com/package/json-schema-ref-resolver)
- **DepUp Version**: 3.0.0-depup.0
...
- **Revision 0** (3.0.0-depup.0) - 🔴 Poor 0% integrity
