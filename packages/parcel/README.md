...
> Dependency-bumped version of parcel

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for parcel.
...
- **Original Package**: [parcel](https://www.npmjs.com/package/parcel)
- **DepUp Version**: 2.16.4-depup.0
- **Original Version**: 2.16.4
...
- **Revision 0** (2.16.4-depup.0) - 🔴 Poor 0% integrity
