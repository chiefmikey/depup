...
> Dependency-bumped version of http-proxy

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for http-proxy.
...
- **Original Package**: [http-proxy](https://www.npmjs.com/package/http-proxy)
- **DepUp Version**: 1.18.1-depup.0
- **Original Version**: 1.18.1
...
- **Revision 0** (1.18.1-depup.0) - 🔴 Poor 0% integrity
