...
> Dependency-bumped version of ora

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for ora.
...
- **Original Package**: [ora](https://www.npmjs.com/package/ora)
- **DepUp Version**: 9.3.0-depup.0
- **Original Version**: 9.3.0
