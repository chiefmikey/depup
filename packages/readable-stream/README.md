...
> Dependency-bumped version of readable-stream

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for readable-stream.
...
- **Original Package**: [readable-stream](https://www.npmjs.com/package/readable-stream)
- **DepUp Version**: 4.7.0-depup.0
...
- **Revision 0** (4.7.0-depup.0) - 🔴 Poor 0% integrity
