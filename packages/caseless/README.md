...
> Dependency-bumped version of caseless

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for caseless.
...
- **Original Package**: [caseless](https://www.npmjs.com/package/caseless)
- **DepUp Version**: 0.12.0-depup.0
- **Original Version**: 0.12.0
...
- **Revision 0** (0.12.0-depup.0) - 🔴 Poor 0% integrity
