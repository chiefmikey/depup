...
> [jotai](https://www.npmjs.com/package/jotai) with all dependencies updated to latest versions.
...
**Original version**: 2.20.1 | **DepUp version**: 2.20.1-depup.13 | **Updated**: 6/16/2026 | **Import test**: failed

## What changed

No dependencies were updated (all already at latest).

Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/jotai&labels=bug).
...
This package inherits the license from [jotai](https://www.npmjs.com/package/jotai).