...
> Dependency-bumped version of jotai

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for jotai.
...
- **DepUp Version**: 2.18.1-depup.0
- **Original Version**: 2.18.1
...
- **Revision 0** (2.18.0-depup.0) - 🔴 Poor 0% integrity

### Version 2.18.1

- **Revision 0** (2.18.1-depup.0) - 🔴 Poor 0% integrity
