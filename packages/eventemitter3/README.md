...
> Dependency-bumped version of eventemitter3

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for eventemitter3.
...
- **Original Package**: [eventemitter3](https://www.npmjs.com/package/eventemitter3)
- **DepUp Version**: 5.0.4-depup.0
- **Original Version**: 5.0.4
...
- **Revision 0** (5.0.4-depup.0) - 🔴 Poor 0% integrity
