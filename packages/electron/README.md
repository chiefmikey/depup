...
> [electron](https://www.npmjs.com/package/electron) with all dependencies updated to latest versions.
...
**Original version**: 42.4.0 | **DepUp version**: 42.4.0-depup.18 | **Updated**: 6/16/2026 | **Import test**: failed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @electron-internal/extract-zip | `^1.0.1` | `^1.0.3` |
| @types/node | `^24.9.0` | `^25.9.3` |
...
This package inherits the license from [electron](https://www.npmjs.com/package/electron).