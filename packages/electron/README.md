...
**Original version**: 42.4.0 | **DepUp version**: 42.4.0-depup.3 | **Updated**: 6/10/2026 | **Import test**: failed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @electron-internal/extract-zip | `^1.0.1` | `^1.0.2` |
| @types/node | `^24.9.0` | `^25.9.2` |
