...
**Original version**: 43.1.1 | **DepUp version**: 43.1.1-depup.0 | **Updated**: 7/21/2026 | **Import test**: failed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @electron-internal/extract-zip | `^1.0.1` | `^1.0.4` |
| @types/node | `^24.9.0` | `^26.1.1` |
