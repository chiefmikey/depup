...
> Dependency-bumped version of react-dev-utils

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for react-dev-utils.
...
- **Original Package**: [react-dev-utils](https://www.npmjs.com/package/react-dev-utils)
- **DepUp Version**: 12.0.1-depup.0
...
- **Revision 0** (12.0.1-depup.0) - 🔴 Poor 0% integrity
