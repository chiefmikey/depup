# @depup/prosemirror-view

> [prosemirror-view](https://www.npmjs.com/package/prosemirror-view) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/prosemirror-view
```
...
**Original version**: 1.41.7 | **DepUp version**: 1.41.7-depup.0 | **Updated**: 3/18/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| prosemirror-model | `^1.20.0` | `^1.25.4` |
| prosemirror-state | `^1.0.0` | `^1.4.4` |
| prosemirror-transform | `^1.1.0` | `^1.11.0` |
...
This package inherits the license from [prosemirror-view](https://www.npmjs.com/package/prosemirror-view).