...
> [koa](https://www.npmjs.com/package/koa) with all dependencies updated to latest versions.
...
**Original version**: 3.2.1 | **DepUp version**: 3.2.1-depup.55 | **Updated**: 8/21/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| content-disposition | `~1.0.1` | `^3.0.0` |
...
Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/koa&labels=bug).
...
This package inherits the license from [koa](https://www.npmjs.com/package/koa).