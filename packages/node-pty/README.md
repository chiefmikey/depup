...
> Dependency-bumped version of node-pty

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for node-pty.
...
- **Original Package**: [node-pty](https://www.npmjs.com/package/node-pty)
