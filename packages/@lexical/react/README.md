# @depup/lexical__react

> [@lexical/react](https://www.npmjs.com/package/@lexical/react) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/lexical__react
```
...
**Original version**: 0.45.0 | **DepUp version**: 0.45.0-depup.35 | **Updated**: 6/23/2026 | **Import test**: failed
...
This package inherits the license from [@lexical/react](https://www.npmjs.com/package/@lexical/react).