...
> Dependency-bumped version of babel-plugin-react-compiler

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for babel-plugin-react-compiler.
...
- **Original Package**: [babel-plugin-react-compiler](https://www.npmjs.com/package/babel-plugin-react-compiler)
- **DepUp Version**: 1.0.0-depup.0
...
- **Revision 0** (1.0.0-depup.0) - 🔴 Poor 0% integrity
