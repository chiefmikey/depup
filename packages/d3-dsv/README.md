...
> [d3-dsv](https://www.npmjs.com/package/d3-dsv) with all dependencies updated to latest versions.
...
**Original version**: 3.0.1 | **DepUp version**: 3.0.1-depup.130 | **Updated**: 8/15/2026 | **Import test**: passed
...
Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/d3-dsv&labels=bug).
...
This package inherits the license from [d3-dsv](https://www.npmjs.com/package/d3-dsv).