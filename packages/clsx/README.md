...
> [clsx](https://www.npmjs.com/package/clsx) with all dependencies updated to latest versions.
...
This package inherits the license from [clsx](https://www.npmjs.com/package/clsx).