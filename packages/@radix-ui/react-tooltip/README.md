# @depup/radix-ui__react-tooltip

> [@radix-ui/react-tooltip](https://www.npmjs.com/package/@radix-ui/react-tooltip) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/radix-ui__react-tooltip
```
...
**Original version**: 1.2.16 | **DepUp version**: 1.2.16-depup.0 | **Updated**: 7/25/2026 | **Import test**: failed
...
This package inherits the license from [@radix-ui/react-tooltip](https://www.npmjs.com/package/@radix-ui/react-tooltip).