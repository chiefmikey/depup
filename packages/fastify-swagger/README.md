# @depup/fastify-swagger

> [fastify-swagger](https://www.npmjs.com/package/fastify-swagger) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/fastify-swagger
```
...
**Original version**: 5.2.0 | **DepUp version**: 5.2.0-depup.1 | **Updated**: 7/30/2026 | **Import test**: failed
...
This package inherits the license from [fastify-swagger](https://www.npmjs.com/package/fastify-swagger).