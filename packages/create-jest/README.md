...
> Dependency-bumped version of create-jest

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for create-jest.
...
- **Original Package**: [create-jest](https://www.npmjs.com/package/create-jest)
