...
> Dependency-bumped version of graphql-config

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for graphql-config.
...
- **Original Package**: [graphql-config](https://www.npmjs.com/package/graphql-config)
