...
> Dependency-bumped version of seq-queue

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for seq-queue.
...
- **Original Package**: [seq-queue](https://www.npmjs.com/package/seq-queue)
- **DepUp Version**: 0.0.5-depup.0
- **Original Version**: 0.0.5
...
- **Revision 0** (0.0.5-depup.0) - 🔴 Poor 0% integrity
