...
**Original version**: 29.0.2 | **DepUp version**: 29.0.2-depup.1 | **Updated**: 4/13/2026 | **Import test**: failed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @asamuzakjp/css-color | `^5.1.5` | `^5.1.10` |
| @asamuzakjp/dom-selector | `^7.0.6` | `^7.0.9` |
