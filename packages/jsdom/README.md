...
**Original version**: 29.1.1 | **DepUp version**: 29.1.1-depup.18 | **Updated**: 6/13/2026 | **Import test**: failed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @asamuzakjp/css-color | `^5.1.11` | `^6.0.2` |
| @asamuzakjp/dom-selector | `^7.1.1` | `^8.0.2` |
