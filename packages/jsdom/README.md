...
**Original version**: 29.0.2 | **DepUp version**: 29.0.2-depup.2 | **Updated**: 4/18/2026 | **Import test**: failed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @asamuzakjp/css-color | `^5.1.5` | `^5.1.11` |
| @asamuzakjp/dom-selector | `^7.0.6` | `^7.1.0` |
