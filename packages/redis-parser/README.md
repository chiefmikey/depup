...
> Dependency-bumped version of redis-parser

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for redis-parser.
...
- **Original Package**: [redis-parser](https://www.npmjs.com/package/redis-parser)
