...
> Dependency-bumped version of triple-beam

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for triple-beam.
...
- **Original Package**: [triple-beam](https://www.npmjs.com/package/triple-beam)
- **DepUp Version**: 1.4.1-depup.0
- **Original Version**: 1.4.1
...
- **Revision 0** (1.4.1-depup.0) - 🔴 Poor 0% integrity
