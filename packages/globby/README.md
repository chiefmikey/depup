...
> Dependency-bumped version of globby

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for globby.
...
- **Original Package**: [globby](https://www.npmjs.com/package/globby)
- **DepUp Version**: 16.1.1-depup.0
- **Original Version**: 16.1.1
...
- **Revision 0** (16.1.1-depup.0) - 🔴 Poor 0% integrity
