...
> Dependency-bumped version of nise

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for nise.
...
- **Original Package**: [nise](https://www.npmjs.com/package/nise)
- **DepUp Version**: 6.1.4-depup.0
- **Original Version**: 6.1.4
...
- **Revision 0** (6.1.4-depup.0) - 🔴 Poor 0% integrity
