...
> [nise](https://www.npmjs.com/package/nise) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/nise
```
...
**Original version**: 6.1.5 | **DepUp version**: 6.1.5-depup.0 | **Updated**: 4/11/2026 | **Import test**: failed
...
| @sinonjs/fake-timers | `^15.1.1` | `^15.3.2` |
...
This package inherits the license from [nise](https://www.npmjs.com/package/nise).