# @depup/eslint-plugin-es

> [eslint-plugin-es](https://www.npmjs.com/package/eslint-plugin-es) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/eslint-plugin-es
```
...
Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/eslint-plugin-es&labels=bug).
...
This package inherits the license from [eslint-plugin-es](https://www.npmjs.com/package/eslint-plugin-es).