...
> [knex](https://www.npmjs.com/package/knex) with all dependencies updated to latest versions.
...
**Original version**: 3.2.10 | **DepUp version**: 3.2.10-depup.16 | **Updated**: 6/13/2026 | **Import test**: passed
...
| pg-connection-string | `2.6.2` | `^2.13.0` |
| tildify | `2.0.0` | `^3.0.0` |


Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/knex&labels=bug).
...
This package inherits the license from [knex](https://www.npmjs.com/package/knex).