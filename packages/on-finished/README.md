...
> Dependency-bumped version of on-finished

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for on-finished.
...
- **Original Package**: [on-finished](https://www.npmjs.com/package/on-finished)
- **DepUp Version**: 2.4.1-depup.0
- **Original Version**: 2.4.1
...
- **Revision 0** (2.4.1-depup.0) - 🔴 Poor 0% integrity
