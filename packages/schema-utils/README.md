...
> [schema-utils](https://www.npmjs.com/package/schema-utils) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/schema-utils
```
...
**Original version**: 4.3.3 | **DepUp version**: 4.3.3-depup.0 | **Updated**: 3/17/2026 | **Import test**: unknown
...
This package inherits the license from [schema-utils](https://www.npmjs.com/package/schema-utils).