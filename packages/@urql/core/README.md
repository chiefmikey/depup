...
> [@urql/core](https://www.npmjs.com/package/@urql/core) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/urql__core
```
...
**Original version**: 6.0.3 | **DepUp version**: 6.0.3-depup.19 | **Updated**: 7/12/2026 | **Import test**: passed
...
This package inherits the license from [@urql/core](https://www.npmjs.com/package/@urql/core).