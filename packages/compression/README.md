...
> [compression](https://www.npmjs.com/package/compression) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/compression
```
...
**Original version**: 1.8.1 | **DepUp version**: 1.8.1-depup.10 | **Updated**: 6/12/2026 | **Import test**: passed
...
This package inherits the license from [compression](https://www.npmjs.com/package/compression).