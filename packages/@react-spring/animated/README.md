...
> Dependency-bumped version of @react-spring/animated

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @react-spring/animated.
...
- **Original Package**: [@react-spring/animated](https://www.npmjs.com/package/@react-spring/animated)
- **DepUp Version**: 10.0.3-depup.0
...
- **Revision 0** (10.0.3-depup.0) - 🔴 Poor 0% integrity
