...
> Dependency-bumped version of jsonc-eslint-parser

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for jsonc-eslint-parser.
...
- **Original Package**: [jsonc-eslint-parser](https://www.npmjs.com/package/jsonc-eslint-parser)
- **DepUp Version**: 3.1.0-depup.0
