# @depup/eslint-webpack-plugin

> [eslint-webpack-plugin](https://www.npmjs.com/package/eslint-webpack-plugin) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/eslint-webpack-plugin
```
...
**Original version**: 6.0.0 | **DepUp version**: 6.0.0-depup.2 | **Updated**: 9/13/2026 | **Import test**: passed
...
This package inherits the license from [eslint-webpack-plugin](https://www.npmjs.com/package/eslint-webpack-plugin).