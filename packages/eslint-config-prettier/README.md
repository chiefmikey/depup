...
> Dependency-bumped version of eslint-config-prettier

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for eslint-config-prettier.
...
- **Original Package**: [eslint-config-prettier](https://www.npmjs.com/package/eslint-config-prettier)
- **DepUp Version**: 10.1.8-depup.0
- **Original Version**: 10.1.8
...
- **Revision 0** (10.1.8-depup.0) - 🔴 Poor 0% integrity
