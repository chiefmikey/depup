...
> Dependency-bumped version of react-transition-group

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for react-transition-group.
...
- **Original Package**: [react-transition-group](https://www.npmjs.com/package/react-transition-group)
- **DepUp Version**: 4.4.5-depup.0
- **Original Version**: 4.4.5
...
- **Revision 0** (4.4.5-depup.0) - 🔴 Poor 0% integrity
