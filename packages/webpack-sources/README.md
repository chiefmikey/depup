...
> [webpack-sources](https://www.npmjs.com/package/webpack-sources) with all dependencies updated to latest versions.
...
**Original version**: 3.5.0 | **DepUp version**: 3.5.0-depup.34 | **Updated**: 6/28/2026 | **Import test**: passed

## What changed

No dependencies were updated (all already at latest).

Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/webpack-sources&labels=bug).
...
This package inherits the license from [webpack-sources](https://www.npmjs.com/package/webpack-sources).