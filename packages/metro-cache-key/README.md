...
> Dependency-bumped version of metro-cache-key

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for metro-cache-key.
...
- **Original Package**: [metro-cache-key](https://www.npmjs.com/package/metro-cache-key)
- **DepUp Version**: 0.84.2-depup.0
- **Original Version**: 0.84.2
...
- **Revision 0** (0.84.2-depup.0) - 🔴 Poor 0% integrity
