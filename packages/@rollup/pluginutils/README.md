...
```bash
npm install @depup/rollup__pluginutils
```
...
**Original version**: 5.4.0 | **DepUp version**: 5.4.0-depup.42 | **Updated**: 6/28/2026 | **Import test**: passed
