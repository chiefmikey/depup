...
> Dependency-bumped version of @rollup/plugin-typescript

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @rollup/plugin-typescript.
...
- **Original Package**: [@rollup/plugin-typescript](https://www.npmjs.com/package/@rollup/plugin-typescript)
- **DepUp Version**: 12.3.0-depup.0
- **Original Version**: 12.3.0
...
- **Revision 0** (12.3.0-depup.0) - 🔴 Poor 0% integrity
