...
**Original version**: 6.1.0 | **DepUp version**: 6.1.0-depup.2 | **Updated**: 6/19/2026 | **Import test**: failed
...
| @portabletext/editor | `^7.5.0` | `^7.6.0` |
| @portabletext/plugin-markdown-shortcuts | `^8.0.16` | `^8.0.19` |
| @portabletext/plugin-one-line | `^7.0.16` | `^7.0.19` |
| @portabletext/plugin-paste-link | `^4.0.16` | `^4.0.19` |
| @portabletext/plugin-typography | `^8.0.16` | `^8.0.19` |
| @portabletext/sanity-bridge | `^3.1.2` | `^3.1.3` |
...
| isomorphic-dompurify | `2.26.0` | `^3.17.0` |
