...
**Original version**: 6.0.0 | **DepUp version**: 6.0.0-depup.11 | **Updated**: 6/15/2026 | **Import test**: failed
...
| @portabletext/editor | `^7.3.3` | `^7.5.0` |
| @portabletext/plugin-markdown-shortcuts | `^8.0.13` | `^8.0.16` |
| @portabletext/plugin-one-line | `^7.0.13` | `^7.0.16` |
| @portabletext/plugin-paste-link | `^4.0.13` | `^4.0.16` |
| @portabletext/plugin-typography | `^8.0.13` | `^8.0.16` |
