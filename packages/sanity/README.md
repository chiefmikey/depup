...
**Original version**: 6.4.0 | **DepUp version**: 6.4.0-depup.6 | **Updated**: 7/14/2026 | **Import test**: failed
...
| @portabletext/editor | `^7.10.1` | `^7.10.7` |
| @portabletext/html | `^1.1.0` | `^1.1.1` |
| @portabletext/plugin-dnd | `^1.0.13` | `^1.0.19` |
| @portabletext/plugin-list-index | `^1.0.13` | `^1.0.19` |
| @portabletext/plugin-markdown-shortcuts | `^8.0.28` | `^8.0.35` |
| @portabletext/plugin-one-line | `^7.0.28` | `^7.0.34` |
| @portabletext/plugin-paste-link | `^4.0.28` | `^4.0.34` |
| @portabletext/plugin-typography | `^8.0.28` | `^8.0.35` |
| @portabletext/sanity-bridge | `^3.2.0` | `^3.2.2` |
