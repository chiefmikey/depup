...
**Original version**: 2.0.30 | **DepUp version**: 2.0.30-depup.11 | **Updated**: 4/1/2026 | **Import test**: failed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @aws-sdk/client-cloudwatch-logs | `^3.972.0` | `^3.1022.0` |
| @aws-sdk/client-ec2 | `^3.972.0` | `^3.1022.0` |
| @aws-sdk/client-ecs | `^3.972.0` | `^3.1022.0` |
| @aws-sdk/client-iam | `^3.972.0` | `^3.1022.0` |
| @aws-sdk/client-lambda | `^3.972.0` | `^3.1022.0` |
| @aws-sdk/client-s3 | `^3.972.0` | `^3.1022.0` |
| @aws-sdk/client-sqs | `^3.972.0` | `^3.1022.0` |
| @aws-sdk/client-ssm | `^3.972.0` | `^3.1022.0` |
| @aws-sdk/client-sts | `^3.972.0` | `^3.1022.0` |
| @aws-sdk/credential-providers | `^3.972.0` | `^3.1022.0` |
