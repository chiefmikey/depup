...
**Original version**: 2.0.34 | **DepUp version**: 2.0.34-depup.37 | **Updated**: 9/25/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @aws-sdk/client-cloudwatch | `^3.1101.0` | `^3.1140.0` |
| @aws-sdk/client-cloudwatch-logs | `^3.1101.0` | `^3.1140.0` |
| @aws-sdk/client-ec2 | `^3.1101.0` | `^3.1140.0` |
| @aws-sdk/client-ecs | `^3.1101.0` | `^3.1140.0` |
| @aws-sdk/client-iam | `^3.1101.0` | `^3.1140.0` |
| @aws-sdk/client-lambda | `^3.1101.0` | `^3.1140.0` |
| @aws-sdk/client-s3 | `^3.1101.0` | `^3.1140.0` |
| @aws-sdk/client-sqs | `^3.1101.0` | `^3.1140.0` |
| @aws-sdk/client-ssm | `^3.1101.0` | `^3.1140.0` |
| @aws-sdk/client-sts | `^3.1101.0` | `^3.1140.0` |
| @aws-sdk/credential-providers | `^3.1101.0` | `^3.1140.0` |
...
| @oclif/core | `^4.8.0` | `^5.1.0` |
| @oclif/plugin-help | `^6.2.36` | `^7.0.0` |
| @oclif/plugin-not-found | `^3.2.73` | `^4.0.0` |
