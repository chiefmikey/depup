...
**Original version**: 2.0.32 | **DepUp version**: 2.0.32-depup.16 | **Updated**: 6/5/2026 | **Import test**: failed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @aws-sdk/client-cloudwatch | `^3.1034.0` | `^3.1062.0` |
| @aws-sdk/client-cloudwatch-logs | `^3.1034.0` | `^3.1062.0` |
| @aws-sdk/client-ec2 | `^3.1034.0` | `^3.1062.0` |
| @aws-sdk/client-ecs | `^3.1034.0` | `^3.1062.0` |
| @aws-sdk/client-iam | `^3.1034.0` | `^3.1062.0` |
| @aws-sdk/client-lambda | `^3.1034.0` | `^3.1062.0` |
| @aws-sdk/client-s3 | `^3.1034.0` | `^3.1062.0` |
| @aws-sdk/client-sqs | `^3.1034.0` | `^3.1062.0` |
| @aws-sdk/client-ssm | `^3.1034.0` | `^3.1062.0` |
