...
> [pg](https://www.npmjs.com/package/pg) with all dependencies updated to latest versions.
...
This package inherits the license from [pg](https://www.npmjs.com/package/pg).