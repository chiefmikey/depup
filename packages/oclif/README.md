...
**Original version**: 4.23.2 | **DepUp version**: 4.23.2-depup.0 | **Updated**: 5/15/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @aws-sdk/client-cloudfront | `^3.1009.0` | `^3.1047.0` |
| @aws-sdk/client-s3 | `^3.1014.0` | `^3.1047.0` |
