...
**Original version**: 4.23.7 | **DepUp version**: 4.23.7-depup.2 | **Updated**: 5/19/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @aws-sdk/client-cloudfront | `^3.1009.0` | `^3.1050.0` |
| @aws-sdk/client-s3 | `^3.1048.0` | `^3.1050.0` |
