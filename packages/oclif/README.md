...
**Original version**: 4.23.0 | **DepUp version**: 4.23.0-depup.6 | **Updated**: 4/16/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @aws-sdk/client-cloudfront | `3.1009.0` | `^3.1031.0` |
| @aws-sdk/client-s3 | `3.1014.0` | `^3.1031.0` |
