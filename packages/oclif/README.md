...
**Original version**: 4.23.0 | **DepUp version**: 4.23.0-depup.4 | **Updated**: 4/10/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @aws-sdk/client-cloudfront | `3.1009.0` | `^3.1029.0` |
| @aws-sdk/client-s3 | `3.1014.0` | `^3.1029.0` |
