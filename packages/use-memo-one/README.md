...
> Dependency-bumped version of use-memo-one

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for use-memo-one.
...
- **Original Package**: [use-memo-one](https://www.npmjs.com/package/use-memo-one)
