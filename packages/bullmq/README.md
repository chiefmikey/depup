...
> Dependency-bumped version of bullmq

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for bullmq.
...
- **DepUp Version**: 5.71.0-depup.0
- **Original Version**: 5.71.0
...
- **Revision 0** (5.71.0-depup.0) - 🔴 Poor 0% integrity
