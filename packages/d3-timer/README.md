...
> Dependency-bumped version of d3-timer

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for d3-timer.
...
- **Original Package**: [d3-timer](https://www.npmjs.com/package/d3-timer)
