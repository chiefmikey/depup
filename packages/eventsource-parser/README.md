...
> Dependency-bumped version of eventsource-parser

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for eventsource-parser.
...
- **Original Package**: [eventsource-parser](https://www.npmjs.com/package/eventsource-parser)
- **DepUp Version**: 3.0.6-depup.0
- **Original Version**: 3.0.6
...
- **Revision 0** (3.0.6-depup.0) - 🔴 Poor 0% integrity
