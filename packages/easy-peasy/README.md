...
> [easy-peasy](https://www.npmjs.com/package/easy-peasy) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/easy-peasy
```
...
This package inherits the license from [easy-peasy](https://www.npmjs.com/package/easy-peasy).