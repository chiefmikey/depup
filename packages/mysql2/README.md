...
> [mysql2](https://www.npmjs.com/package/mysql2) with all dependencies updated to latest versions.
...
**Original version**: 3.22.5 | **DepUp version**: 3.22.5-depup.19 | **Updated**: 6/15/2026 | **Import test**: passed
...
This package inherits the license from [mysql2](https://www.npmjs.com/package/mysql2).