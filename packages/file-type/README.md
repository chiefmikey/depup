...
> [file-type](https://www.npmjs.com/package/file-type) with all dependencies updated to latest versions.
...
**Original version**: 21.3.3 | **DepUp version**: 21.3.3-depup.0 | **Updated**: 3/16/2026 | **Import test**: unknown
...
This package inherits the license from [file-type](https://www.npmjs.com/package/file-type).