...
> Dependency-bumped version of tiny-invariant

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for tiny-invariant.
...
- **Original Package**: [tiny-invariant](https://www.npmjs.com/package/tiny-invariant)
- **DepUp Version**: 1.3.3-depup.0
...
- **Revision 0** (1.3.3-depup.0) - 🔴 Poor 0% integrity
