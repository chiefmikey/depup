...
> [sharp-cli](https://www.npmjs.com/package/sharp-cli) with all dependencies updated to latest versions.
...
**Original version**: 6.0.0 | **DepUp version**: 6.0.0-depup.0 | **Updated**: 8/23/2026 | **Import test**: passed
...
This package inherits the license from [sharp-cli](https://www.npmjs.com/package/sharp-cli).