...
> Dependency-bumped version of react-native-safe-area-context

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for react-native-safe-area-context.
...
- **Original Package**: [react-native-safe-area-context](https://www.npmjs.com/package/react-native-safe-area-context)
- **DepUp Version**: 5.7.0-depup.0
...
- **Revision 0** (5.7.0-depup.0) - 🔴 Poor 0% integrity
