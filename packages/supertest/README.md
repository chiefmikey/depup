...
> [supertest](https://www.npmjs.com/package/supertest) with all dependencies updated to latest versions.
...
**Original version**: 7.2.2 | **DepUp version**: 7.2.2-depup.53 | **Updated**: 7/26/2026 | **Import test**: passed
...
This package inherits the license from [supertest](https://www.npmjs.com/package/supertest).