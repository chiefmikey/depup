...
> [otplib](https://www.npmjs.com/package/otplib) with all dependencies updated to latest versions.
...
**Original version**: 13.4.1 | **DepUp version**: 13.4.1-depup.14 | **Updated**: 6/13/2026 | **Import test**: failed

## What changed

No dependencies were updated (all already at latest).

Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/otplib&labels=bug).
...
This package inherits the license from [otplib](https://www.npmjs.com/package/otplib).