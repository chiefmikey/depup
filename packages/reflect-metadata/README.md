...
> Dependency-bumped version of reflect-metadata

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for reflect-metadata.
...
- **Original Package**: [reflect-metadata](https://www.npmjs.com/package/reflect-metadata)
- **DepUp Version**: 0.2.2-depup.0
...
- **Revision 0** (0.2.2-depup.0) - 🔴 Poor 0% integrity
