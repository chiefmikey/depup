# @depup/pdf-lib__standard-fonts

> [@pdf-lib/standard-fonts](https://www.npmjs.com/package/@pdf-lib/standard-fonts) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/pdf-lib__standard-fonts
```
...
This package inherits the license from [@pdf-lib/standard-fonts](https://www.npmjs.com/package/@pdf-lib/standard-fonts).