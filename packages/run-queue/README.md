...
> Dependency-bumped version of run-queue

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for run-queue.
...
- **Original Package**: [run-queue](https://www.npmjs.com/package/run-queue)
