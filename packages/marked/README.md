...
> Dependency-bumped version of marked

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for marked.
...
- **Original Package**: [marked](https://www.npmjs.com/package/marked)
- **DepUp Version**: 17.0.4-depup.0
- **Original Version**: 17.0.4
...
- **Revision 0** (17.0.4-depup.0) - 🔴 Poor 0% integrity
