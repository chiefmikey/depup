...
> Dependency-bumped version of @cacheable/memory

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @cacheable/memory.
...
- **Original Package**: [@cacheable/memory](https://www.npmjs.com/package/@cacheable/memory)
- **DepUp Version**: 2.0.8-depup.0
- **Original Version**: 2.0.8
...
- **Revision 0** (2.0.8-depup.0) - 🔴 Poor 0% integrity
