...
> Dependency-bumped version of destroy

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for destroy.
...
- **Original Package**: [destroy](https://www.npmjs.com/package/destroy)
