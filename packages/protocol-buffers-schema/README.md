...
> Dependency-bumped version of protocol-buffers-schema

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for protocol-buffers-schema.
...
- **Original Package**: [protocol-buffers-schema](https://www.npmjs.com/package/protocol-buffers-schema)
- **DepUp Version**: 3.6.0-depup.0
- **Original Version**: 3.6.0
...
- **Revision 0** (3.6.0-depup.0) - 🔴 Poor 0% integrity
