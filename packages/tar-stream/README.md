...
> Dependency-bumped version of tar-stream

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for tar-stream.
...
- **Original Package**: [tar-stream](https://www.npmjs.com/package/tar-stream)
- **DepUp Version**: 3.1.8-depup.0
- **Original Version**: 3.1.8
...
- **Revision 0** (3.1.8-depup.0) - 🔴 Poor 0% integrity
