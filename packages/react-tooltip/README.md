...
> Dependency-bumped version of react-tooltip

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for react-tooltip.
...
- **Original Package**: [react-tooltip](https://www.npmjs.com/package/react-tooltip)
- **DepUp Version**: 5.30.0-depup.0
- **Original Version**: 5.30.0
...
- **Revision 0** (5.30.0-depup.0) - 🔴 Poor 0% integrity
