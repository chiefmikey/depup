...
> Dependency-bumped version of getopts

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for getopts.
...
- **Original Package**: [getopts](https://www.npmjs.com/package/getopts)
