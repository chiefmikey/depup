# @depup/paypal-rest-sdk

> [paypal-rest-sdk](https://www.npmjs.com/package/paypal-rest-sdk) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/paypal-rest-sdk
```
...
**Original version**: 1.8.1 | **DepUp version**: 1.8.1-depup.0 | **Updated**: 3/18/2026
...
This package inherits the license from [paypal-rest-sdk](https://www.npmjs.com/package/paypal-rest-sdk).