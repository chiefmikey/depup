...
**Original version**: 0.15.1 | **DepUp version**: 0.15.1-depup.37 | **Updated**: 6/18/2026 | **Import test**: failed
...
| @babel/plugin-transform-regenerator | `^7.12.1` | `^8.0.1` |
| @babel/preset-env | `^7.12.11` | `^8.0.1` |
