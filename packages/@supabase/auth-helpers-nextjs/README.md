# @depup/supabase__auth-helpers-nextjs

> [@supabase/auth-helpers-nextjs](https://www.npmjs.com/package/@supabase/auth-helpers-nextjs) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/supabase__auth-helpers-nextjs
```
...
**Original version**: 0.15.0 | **DepUp version**: 0.15.0-depup.0 | **Updated**: 3/18/2026 | **Import test**: failed
...
This package inherits the license from [@supabase/auth-helpers-nextjs](https://www.npmjs.com/package/@supabase/auth-helpers-nextjs).