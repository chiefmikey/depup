...
> [@supabase/ssr](https://www.npmjs.com/package/@supabase/ssr) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/supabase__ssr
```
...
**Original version**: 0.12.0 | **DepUp version**: 0.12.0-depup.49 | **Updated**: 7/11/2026 | **Import test**: failed
...
This package inherits the license from [@supabase/ssr](https://www.npmjs.com/package/@supabase/ssr).