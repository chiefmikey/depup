...
> Dependency-bumped version of uncrypto

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for uncrypto.
...
- **Original Package**: [uncrypto](https://www.npmjs.com/package/uncrypto)
- **DepUp Version**: 0.1.3-depup.0
...
- **Revision 0** (0.1.3-depup.0) - 🔴 Poor 0% integrity
