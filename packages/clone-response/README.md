...
> Dependency-bumped version of clone-response

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for clone-response.
...
- **Original Package**: [clone-response](https://www.npmjs.com/package/clone-response)
