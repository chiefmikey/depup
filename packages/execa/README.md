...
> [execa](https://www.npmjs.com/package/execa) with all dependencies updated to latest versions.
...
**Original version**: 10.0.1 | **DepUp version**: 10.0.1-depup.0 | **Updated**: 7/31/2026 | **Import test**: passed
...
This package inherits the license from [execa](https://www.npmjs.com/package/execa).