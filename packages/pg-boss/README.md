...
> [pg-boss](https://www.npmjs.com/package/pg-boss) with all dependencies updated to latest versions.
...
**Original version**: 12.33.1 | **DepUp version**: 12.33.1-depup.0 | **Updated**: 9/18/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| rrule-temporal | `^2.2.5` | `^2.2.6` |
...
This package inherits the license from [pg-boss](https://www.npmjs.com/package/pg-boss).