...
> [env-cmd](https://www.npmjs.com/package/env-cmd) with all dependencies updated to latest versions.
...
**Original version**: 11.0.0 | **DepUp version**: 11.0.0-depup.15 | **Updated**: 6/13/2026 | **Import test**: passed
...
This package inherits the license from [env-cmd](https://www.npmjs.com/package/env-cmd).