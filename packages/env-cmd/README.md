...
> Dependency-bumped version of env-cmd

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for env-cmd.
...
- **Original Package**: [env-cmd](https://www.npmjs.com/package/env-cmd)
