...
> Dependency-bumped version of jsonschema

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for jsonschema.
...
- **Original Package**: [jsonschema](https://www.npmjs.com/package/jsonschema)
- **DepUp Version**: 1.5.0-depup.0
...
- **Revision 0** (1.5.0-depup.0) - 🔴 Poor 0% integrity
