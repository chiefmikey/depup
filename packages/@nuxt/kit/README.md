...
> [@nuxt/kit](https://www.npmjs.com/package/@nuxt/kit) with all dependencies updated to latest versions.
...
**Original version**: 4.4.4 | **DepUp version**: 4.4.4-depup.0 | **Updated**: 4/30/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| c12 | `^3.3.4` | `^4.0.0-beta.4` |
...
This package inherits the license from [@nuxt/kit](https://www.npmjs.com/package/@nuxt/kit).