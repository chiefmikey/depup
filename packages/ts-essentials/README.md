...
> Dependency-bumped version of ts-essentials

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for ts-essentials.
...
- **Original Package**: [ts-essentials](https://www.npmjs.com/package/ts-essentials)
- **DepUp Version**: 10.1.1-depup.0
- **Original Version**: 10.1.1
...
- **Revision 0** (10.1.1-depup.0) - 🔴 Poor 0% integrity
