...
> Dependency-bumped version of http-proxy-middleware

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for http-proxy-middleware.
...
- **Original Package**: [http-proxy-middleware](https://www.npmjs.com/package/http-proxy-middleware)
- **DepUp Version**: 3.0.5-depup.0
- **Original Version**: 3.0.5
...
- **Revision 0** (3.0.5-depup.0) - 🔴 Poor 0% integrity
