...
> [http-proxy-middleware](https://www.npmjs.com/package/http-proxy-middleware) with all dependencies updated to latest versions.
...
**Original version**: 4.1.1 | **DepUp version**: 4.1.1-depup.15 | **Updated**: 6/26/2026 | **Import test**: passed
...
This package inherits the license from [http-proxy-middleware](https://www.npmjs.com/package/http-proxy-middleware).