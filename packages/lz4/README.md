...
> [lz4](https://www.npmjs.com/package/lz4) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/lz4
```
...
**Original version**: 0.6.5 | **DepUp version**: 0.6.5-depup.23 | **Updated**: 6/15/2026 | **Import test**: passed
...
This package inherits the license from [lz4](https://www.npmjs.com/package/lz4).