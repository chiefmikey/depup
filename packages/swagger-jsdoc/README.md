...
> [swagger-jsdoc](https://www.npmjs.com/package/swagger-jsdoc) with all dependencies updated to latest versions.
...
**Original version**: 6.3.0 | **DepUp version**: 6.3.0-depup.0 | **Updated**: 5/22/2026 | **Import test**: passed
...
This package inherits the license from [swagger-jsdoc](https://www.npmjs.com/package/swagger-jsdoc).