# @depup/babel-plugin-const-enum

> [babel-plugin-const-enum](https://www.npmjs.com/package/babel-plugin-const-enum) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/babel-plugin-const-enum
```
...
**Original version**: 1.2.0 | **DepUp version**: 1.2.0-depup.0 | **Updated**: 3/22/2026 | **Import test**: passed
...
| @babel/plugin-syntax-typescript | `^7.3.3` | `^7.28.6` |
| @babel/traverse | `^7.16.0` | `^7.29.0` |
...
This package inherits the license from [babel-plugin-const-enum](https://www.npmjs.com/package/babel-plugin-const-enum).