...
> [p-queue](https://www.npmjs.com/package/p-queue) with all dependencies updated to latest versions.
...
This package inherits the license from [p-queue](https://www.npmjs.com/package/p-queue).