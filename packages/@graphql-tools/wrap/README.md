...
> [@graphql-tools/wrap](https://www.npmjs.com/package/@graphql-tools/wrap) with all dependencies updated to latest versions.
...
**Original version**: 11.1.16 | **DepUp version**: 11.1.16-depup.34 | **Updated**: 6/21/2026 | **Import test**: passed
...
This package inherits the license from [@graphql-tools/wrap](https://www.npmjs.com/package/@graphql-tools/wrap).