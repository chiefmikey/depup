...
> Dependency-bumped version of @graphql-tools/executor-common

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @graphql-tools/executor-common.
...
- **Original Package**: [@graphql-tools/executor-common](https://www.npmjs.com/package/@graphql-tools/executor-common)
- **DepUp Version**: 1.0.6-depup.0
...
- **Revision 0** (1.0.6-depup.0) - 🔴 Poor 0% integrity
