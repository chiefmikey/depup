...
> Dependency-bumped version of @graphql-tools/load

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @graphql-tools/load.
...
- **Original Package**: [@graphql-tools/load](https://www.npmjs.com/package/@graphql-tools/load)
- **DepUp Version**: 8.1.8-depup.0
- **Original Version**: 8.1.8
...
- **Revision 0** (8.1.8-depup.0) - 🔴 Poor 0% integrity
