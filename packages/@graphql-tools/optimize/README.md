...
> Dependency-bumped version of @graphql-tools/optimize

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @graphql-tools/optimize.
...
- **Original Package**: [@graphql-tools/optimize](https://www.npmjs.com/package/@graphql-tools/optimize)
