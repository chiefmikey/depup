...
> Dependency-bumped version of @graphql-tools/batch-execute

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @graphql-tools/batch-execute.
...
- **Original Package**: [@graphql-tools/batch-execute](https://www.npmjs.com/package/@graphql-tools/batch-execute)
- **DepUp Version**: 10.0.7-depup.0
- **Original Version**: 10.0.7
...
- **Revision 0** (10.0.7-depup.0) - 🔴 Poor 0% integrity
