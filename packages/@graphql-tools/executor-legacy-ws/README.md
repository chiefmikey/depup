...
> Dependency-bumped version of @graphql-tools/executor-legacy-ws

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @graphql-tools/executor-legacy-ws.
...
- **Original Package**: [@graphql-tools/executor-legacy-ws](https://www.npmjs.com/package/@graphql-tools/executor-legacy-ws)
- **DepUp Version**: 1.1.25-depup.0
- **Original Version**: 1.1.25
...
- **Revision 0** (1.1.25-depup.0) - 🔴 Poor 0% integrity
