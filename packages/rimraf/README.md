...
> Dependency-bumped version of rimraf

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for rimraf.
...
- **Original Package**: [rimraf](https://www.npmjs.com/package/rimraf)
- **DepUp Version**: 6.1.3-depup.0
- **Original Version**: 6.1.3
...
- **Revision 0** (6.1.3-depup.0) - 🔴 Poor 0% integrity
