...
> [rimraf](https://www.npmjs.com/package/rimraf) with all dependencies updated to latest versions.
...
This package inherits the license from [rimraf](https://www.npmjs.com/package/rimraf).