...
> Dependency-bumped version of redis

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for redis.
...
- **Original Package**: [redis](https://www.npmjs.com/package/redis)
