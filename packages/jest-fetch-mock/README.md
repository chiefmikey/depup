# @depup/jest-fetch-mock

> [jest-fetch-mock](https://www.npmjs.com/package/jest-fetch-mock) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/jest-fetch-mock
```
...
**Original version**: 3.0.3 | **DepUp version**: 3.0.3-depup.0 | **Updated**: 3/18/2026 | **Import test**: failed
...
This package inherits the license from [jest-fetch-mock](https://www.npmjs.com/package/jest-fetch-mock).