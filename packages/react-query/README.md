...
> [react-query](https://www.npmjs.com/package/react-query) with all dependencies updated to latest versions.
...
This package inherits the license from [react-query](https://www.npmjs.com/package/react-query).