...
> Dependency-bumped version of decimal.js

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for decimal.js.
...
- **Original Package**: [decimal.js](https://www.npmjs.com/package/decimal.js)
- **DepUp Version**: 10.6.0-depup.0
- **Original Version**: 10.6.0
...
- **Revision 0** (10.6.0-depup.0) - 🔴 Poor 0% integrity
