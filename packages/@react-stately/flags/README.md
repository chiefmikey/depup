...
> Dependency-bumped version of @react-stately/flags

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @react-stately/flags.
...
- **Original Package**: [@react-stately/flags](https://www.npmjs.com/package/@react-stately/flags)
- **DepUp Version**: 3.1.2-depup.0
...
- **Revision 0** (3.1.2-depup.0) - 🔴 Poor 0% integrity
