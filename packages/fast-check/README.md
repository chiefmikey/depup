...
> [fast-check](https://www.npmjs.com/package/fast-check) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/fast-check
```
...
**Original version**: 4.10.0 | **DepUp version**: 4.10.0-depup.0 | **Updated**: 9/11/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| pure-rand | `^8.0.0` | `^8.4.2` |
...
This package inherits the license from [fast-check](https://www.npmjs.com/package/fast-check).