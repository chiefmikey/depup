...
> [pinia](https://www.npmjs.com/package/pinia) with all dependencies updated to latest versions.
...
**Original version**: 4.0.3 | **DepUp version**: 4.0.3-depup.0 | **Updated**: 8/12/2026 | **Import test**: failed
...
This package inherits the license from [pinia](https://www.npmjs.com/package/pinia).