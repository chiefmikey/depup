...
> Dependency-bumped version of pinia

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for pinia.
...
- **Original Package**: [pinia](https://www.npmjs.com/package/pinia)
- **DepUp Version**: 3.0.4-depup.1
...
- **Revision 1** (3.0.4-depup.1) - 🔴 Poor 0% integrity
