...
> Dependency-bumped version of ms

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for ms.
...
- **Original Package**: [ms](https://www.npmjs.com/package/ms)
- **DepUp Version**: 2.1.3-depup.0
- **Original Version**: 2.1.3
...
- **Revision 0** (2.1.3-depup.0) - 🔴 Poor 0% integrity
