...
> Dependency-bumped version of recoil

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for recoil.
...
- **DepUp Version**: 0.7.7-depup.0
- **Original Version**: 0.7.7
...
- **Revision 0** (0.7.7-depup.0) - 🔴 Poor 0% integrity
