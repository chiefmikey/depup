...
> Dependency-bumped version of response-time

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for response-time.
...
- **Original Package**: [response-time](https://www.npmjs.com/package/response-time)
- **DepUp Version**: 2.3.4-depup.0
...
- **Revision 0** (2.3.4-depup.0) - 🔴 Poor 0% integrity
