...
> [next-auth](https://www.npmjs.com/package/next-auth) with all dependencies updated to latest versions.
...
**Original version**: 4.24.14 | **DepUp version**: 4.24.14-depup.1 | **Updated**: 4/19/2026 | **Import test**: failed
...
| jose | `^4.15.5` | `^6.2.2` |
| oauth | `^0.9.15` | `^0.10.2` |
| openid-client | `^5.4.0` | `^6.8.3` |
| preact | `^10.6.3` | `^10.29.1` |
| preact-render-to-string | `^5.1.19` | `^6.6.7` |
| uuid | `^8.3.2` | `^14.0.0` |
...
This package inherits the license from [next-auth](https://www.npmjs.com/package/next-auth).