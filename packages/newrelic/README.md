...
**Original version**: 13.20.0 | **DepUp version**: 13.20.0-depup.1 | **Updated**: 5/14/2026 | **Import test**: passed
...
| @opentelemetry/exporter-metrics-otlp-proto | `^0.201.1` | `^0.218.0` |
| @opentelemetry/resources | `^2.0.1` | `^2.7.1` |
| @opentelemetry/sdk-logs | `^0.203.0` | `^0.218.0` |
