...
> Dependency-bumped version of @xyflow/system

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @xyflow/system.
...
- **Original Package**: [@xyflow/system](https://www.npmjs.com/package/@xyflow/system)
- **DepUp Version**: 0.0.75-depup.0
- **Original Version**: 0.0.75
...
- **Revision 0** (0.0.75-depup.0) - 🔴 Poor 0% integrity
