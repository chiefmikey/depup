...
> Dependency-bumped version of mercurius

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for mercurius.
...
- **Original Package**: [mercurius](https://www.npmjs.com/package/mercurius)
- **DepUp Version**: 16.8.0-depup.0
- **Original Version**: 16.8.0
...
- **Revision 0** (16.8.0-depup.0) - 🔴 Poor 0% integrity
