...
**Original version**: 1.29.0 | **DepUp version**: 1.29.0-depup.64 | **Updated**: 7/21/2026 | **Import test**: failed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @hono/node-server | `^1.19.9` | `^2.0.11` |
| ajv | `^8.17.1` | `^8.20.0` |
...
| express-rate-limit | `^8.2.1` | `^8.6.0` |
| hono | `^4.11.4` | `^4.12.31` |
| jose | `^6.1.3` | `^6.2.3` |
