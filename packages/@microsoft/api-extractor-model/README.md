...
> Dependency-bumped version of @microsoft/api-extractor-model

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @microsoft/api-extractor-model.
...
- **Original Package**: [@microsoft/api-extractor-model](https://www.npmjs.com/package/@microsoft/api-extractor-model)
- **DepUp Version**: 7.33.4-depup.0
- **Original Version**: 7.33.4
...
- **Revision 0** (7.33.4-depup.0) - 🔴 Poor 0% integrity
