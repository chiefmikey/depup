...
> Dependency-bumped version of pdf-lib

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for pdf-lib.
...
- **Original Package**: [pdf-lib](https://www.npmjs.com/package/pdf-lib)
- **DepUp Version**: 1.17.1-depup.0
- **Original Version**: 1.17.1
...
- **Revision 0** (1.17.1-depup.0) - 🔴 Poor 0% integrity
