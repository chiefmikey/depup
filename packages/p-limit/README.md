...
> [p-limit](https://www.npmjs.com/package/p-limit) with all dependencies updated to latest versions.
...
**Original version**: 7.3.0 | **DepUp version**: 7.3.0-depup.21 | **Updated**: 6/16/2026 | **Import test**: passed
...
Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/p-limit&labels=bug).
...
This package inherits the license from [p-limit](https://www.npmjs.com/package/p-limit).