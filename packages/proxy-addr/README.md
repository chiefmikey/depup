...
> [proxy-addr](https://www.npmjs.com/package/proxy-addr) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/proxy-addr
```
...
**Original version**: 2.0.7 | **DepUp version**: 2.0.7-depup.0 | **Updated**: 3/19/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| ipaddr.js | `1.9.1` | `^2.3.0` |
...
This package inherits the license from [proxy-addr](https://www.npmjs.com/package/proxy-addr).