...
> Dependency-bumped version of date-fns

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for date-fns.
...
- **Original Package**: [date-fns](https://www.npmjs.com/package/date-fns)
