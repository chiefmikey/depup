...
> Dependency-bumped version of electron-updater

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for electron-updater.
...
- **Original Package**: [electron-updater](https://www.npmjs.com/package/electron-updater)
- **DepUp Version**: 6.8.3-depup.0
- **Original Version**: 6.8.3
...
- **Revision 0** (6.8.3-depup.0) - 🔴 Poor 0% integrity
