...
> [react-router](https://www.npmjs.com/package/react-router) with all dependencies updated to latest versions.
...
**Original version**: 8.4.0 | **DepUp version**: 8.4.0-depup.0 | **Updated**: 9/20/2026 | **Import test**: failed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @remix-run/route-pattern | `^0.22.1` | `^0.24.1` |
...
This package inherits the license from [react-router](https://www.npmjs.com/package/react-router).