...
> [qrcode](https://www.npmjs.com/package/qrcode) with all dependencies updated to latest versions.
...
**Original version**: 1.5.4 | **DepUp version**: 1.5.4-depup.51 | **Updated**: 7/12/2026 | **Import test**: passed
...
This package inherits the license from [qrcode](https://www.npmjs.com/package/qrcode).