...
> Dependency-bumped version of micromark-extension-mdx-md

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for micromark-extension-mdx-md.
...
- **Original Package**: [micromark-extension-mdx-md](https://www.npmjs.com/package/micromark-extension-mdx-md)
