...
> Dependency-bumped version of swagger-ui-express

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for swagger-ui-express.
...
- **Original Package**: [swagger-ui-express](https://www.npmjs.com/package/swagger-ui-express)
- **DepUp Version**: 5.0.1-depup.1
...
- **Revision 1** (5.0.1-depup.1) - 🔴 Poor 0% integrity
