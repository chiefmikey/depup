...
> [mini-css-extract-plugin](https://www.npmjs.com/package/mini-css-extract-plugin) with all dependencies updated to latest versions.
...
**Original version**: 2.10.2 | **DepUp version**: 2.10.2-depup.2 | **Updated**: 9/13/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| schema-utils | `^4.0.0` | `^4.5.0` |
| tapable | `^2.2.1` | `^2.3.3` |
...
This package inherits the license from [mini-css-extract-plugin](https://www.npmjs.com/package/mini-css-extract-plugin).