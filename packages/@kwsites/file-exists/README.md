...
> Dependency-bumped version of @kwsites/file-exists

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @kwsites/file-exists.
...
- **Original Package**: [@kwsites/file-exists](https://www.npmjs.com/package/@kwsites/file-exists)
- **DepUp Version**: 1.1.1-depup.0
...
- **Revision 0** (1.1.1-depup.0) - 🔴 Poor 0% integrity
