...
> Dependency-bumped version of figlet

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for figlet.
...
- **Original Package**: [figlet](https://www.npmjs.com/package/figlet)
- **DepUp Version**: 1.11.0-depup.0
- **Original Version**: 1.11.0
...
- **Revision 0** (1.11.0-depup.0) - 🔴 Poor 0% integrity
