...
> [fastq](https://www.npmjs.com/package/fastq) with all dependencies updated to latest versions.
...
**Original version**: 1.20.1 | **DepUp version**: 1.20.1-depup.0 | **Updated**: 3/17/2026 | **Import test**: unknown
...
Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/fastq&labels=bug).
...
This package inherits the license from [fastq](https://www.npmjs.com/package/fastq).