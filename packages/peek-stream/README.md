...
> [peek-stream](https://www.npmjs.com/package/peek-stream) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/peek-stream
```
...
This package inherits the license from [peek-stream](https://www.npmjs.com/package/peek-stream).