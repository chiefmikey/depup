# @depup/react-mosaic-component

> [react-mosaic-component](https://www.npmjs.com/package/react-mosaic-component) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/react-mosaic-component
```
...
**Original version**: 7.0.0-beta0 | **DepUp version**: 7.0.0-beta0-depup.0 | **Updated**: 3/19/2026 | **Import test**: passed
...
This package inherits the license from [react-mosaic-component](https://www.npmjs.com/package/react-mosaic-component).