...
> [js-yaml](https://www.npmjs.com/package/js-yaml) with all dependencies updated to latest versions.
...
**Original version**: 5.2.2 | **DepUp version**: 5.2.2-depup.16 | **Updated**: 7/29/2026 | **Import test**: passed
...
This package inherits the license from [js-yaml](https://www.npmjs.com/package/js-yaml).