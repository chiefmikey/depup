...
> [ajv](https://www.npmjs.com/package/ajv) with all dependencies updated to latest versions.
...
**Original version**: 8.20.0 | **DepUp version**: 8.20.0-depup.14 | **Updated**: 6/13/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| fast-uri | `^3.0.1` | `^4.0.0` |
...
This package inherits the license from [ajv](https://www.npmjs.com/package/ajv).