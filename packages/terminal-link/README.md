...
> [terminal-link](https://www.npmjs.com/package/terminal-link) with all dependencies updated to latest versions.
...
**Original version**: 5.0.0 | **DepUp version**: 5.0.0-depup.16 | **Updated**: 6/14/2026 | **Import test**: passed
...
This package inherits the license from [terminal-link](https://www.npmjs.com/package/terminal-link).