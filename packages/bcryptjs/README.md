...
> Dependency-bumped version of bcryptjs

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for bcryptjs.
...
- **Original Package**: [bcryptjs](https://www.npmjs.com/package/bcryptjs)
