...
> Dependency-bumped version of chai

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for chai.
...
- **Original Package**: [chai](https://www.npmjs.com/package/chai)
- **DepUp Version**: 6.2.2-depup.0
- **Original Version**: 6.2.2
...
- **Revision 0** (6.2.2-depup.0) - 🔴 Poor 0% integrity
