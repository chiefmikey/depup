...
**Original version**: 4.2.1 | **DepUp version**: 4.2.1-depup.75 | **Updated**: 7/30/2026 | **Import test**: passed
...
| react-router | `^3.0.2` | `^8.3.0` |
| redux | `^3.7.2` | `^5.0.1` |
| redux-saga | `^0.15.6` | `^1.5.1` |
