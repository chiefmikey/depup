...
> Dependency-bumped version of duckdb

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for duckdb.
...
- **Original Package**: [duckdb](https://www.npmjs.com/package/duckdb)
- **DepUp Version**: 1.4.4-depup.0
- **Original Version**: 1.4.4
...
- **Revision 0** (1.4.4-depup.0) - 🔴 Poor 0% integrity
