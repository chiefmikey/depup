...
> Dependency-bumped version of @redocly/config

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @redocly/config.
...
- **Original Package**: [@redocly/config](https://www.npmjs.com/package/@redocly/config)
- **DepUp Version**: 0.44.1-depup.0
- **Original Version**: 0.44.1
...
- **Revision 0** (0.44.1-depup.0) - 🔴 Poor 0% integrity
