...
> [msgpack5](https://www.npmjs.com/package/msgpack5) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/msgpack5
```
...
**Original version**: 6.0.2 | **DepUp version**: 6.0.2-depup.1 | **Updated**: 4/13/2026 | **Import test**: failed
...
Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/msgpack5&labels=bug).
...
This package inherits the license from [msgpack5](https://www.npmjs.com/package/msgpack5).