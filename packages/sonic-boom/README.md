...
> Dependency-bumped version of sonic-boom

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for sonic-boom.
...
- **Original Package**: [sonic-boom](https://www.npmjs.com/package/sonic-boom)
- **DepUp Version**: 4.2.1-depup.0
...
- **Revision 0** (4.2.1-depup.0) - 🔴 Poor 0% integrity
