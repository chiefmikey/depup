...
> [crypto-random-string](https://www.npmjs.com/package/crypto-random-string) with all dependencies updated to latest versions.
...
**Original version**: 5.0.0 | **DepUp version**: 5.0.0-depup.2 | **Updated**: 4/17/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| type-fest | `^2.12.2` | `^5.6.0` |
...
This package inherits the license from [crypto-random-string](https://www.npmjs.com/package/crypto-random-string).