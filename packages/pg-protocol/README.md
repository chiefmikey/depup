...
> Dependency-bumped version of pg-protocol

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for pg-protocol.
...
- **Original Package**: [pg-protocol](https://www.npmjs.com/package/pg-protocol)
- **DepUp Version**: 1.13.0-depup.0
- **Original Version**: 1.13.0
...
- **Revision 0** (1.13.0-depup.0) - 🔴 Poor 0% integrity
