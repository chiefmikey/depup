# @depup/testcontainers

> [testcontainers](https://www.npmjs.com/package/testcontainers) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/testcontainers
```
...
**Original version**: 11.13.0 | **DepUp version**: 11.13.0-depup.2 | **Updated**: 3/31/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| docker-compose | `^1.3.2` | `^1.4.1` |
| dockerode | `^4.0.9` | `^4.0.10` |
| get-port | `^7.1.0` | `^7.2.0` |
| undici | `^7.24.3` | `^7.24.6` |
...
This package inherits the license from [testcontainers](https://www.npmjs.com/package/testcontainers).