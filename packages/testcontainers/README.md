...
> Dependency-bumped version of testcontainers

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for testcontainers.
...
- **Original Package**: [testcontainers](https://www.npmjs.com/package/testcontainers)
- **DepUp Version**: 11.13.0-depup.0
- **Original Version**: 11.13.0
...
- **Revision 0** (11.13.0-depup.0) - 🔴 Poor 0% integrity
