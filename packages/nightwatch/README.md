...
**Original version**: 3.16.0 | **DepUp version**: 3.16.0-depup.0 | **Updated**: 5/25/2026 | **Import test**: failed
...
| @types/selenium-webdriver | `^4.1.14` | `^4.35.5` |
...
| devtools-protocol | `^0.0.1140464` | `^0.0.1635485` |
