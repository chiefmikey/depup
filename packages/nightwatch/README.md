...
**Original version**: 3.16.0 | **DepUp version**: 3.16.0-depup.58 | **Updated**: 8/11/2026 | **Import test**: failed
...
| devtools-protocol | `^0.0.1140464` | `^0.0.1676105` |
...
| ora | `5.4.1` | `^9.4.1` |
| piscina | `^4.3.1` | `^5.3.0` |
| selenium-webdriver | `4.27.0` | `^4.47.0` |
| semver | `7.5.4` | `^7.8.5` |
