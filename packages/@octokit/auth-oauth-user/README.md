...
> Dependency-bumped version of @octokit/auth-oauth-user

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @octokit/auth-oauth-user.
...
- **Original Package**: [@octokit/auth-oauth-user](https://www.npmjs.com/package/@octokit/auth-oauth-user)
- **DepUp Version**: 6.0.2-depup.0
...
- **Revision 0** (6.0.2-depup.0) - 🔴 Poor 0% integrity
