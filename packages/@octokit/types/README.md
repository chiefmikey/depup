...
> Dependency-bumped version of @octokit/types

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @octokit/types.
...
- **Original Package**: [@octokit/types](https://www.npmjs.com/package/@octokit/types)
- **DepUp Version**: 16.0.0-depup.0
...
- **Revision 0** (16.0.0-depup.0) - 🔴 Poor 0% integrity
