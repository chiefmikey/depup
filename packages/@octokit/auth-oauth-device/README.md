...
> Dependency-bumped version of @octokit/auth-oauth-device

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @octokit/auth-oauth-device.
...
- **Original Package**: [@octokit/auth-oauth-device](https://www.npmjs.com/package/@octokit/auth-oauth-device)
