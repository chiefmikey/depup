...
> [@octokit/core](https://www.npmjs.com/package/@octokit/core) with all dependencies updated to latest versions.
...
**Original version**: 7.0.8 | **DepUp version**: 7.0.8-depup.0 | **Updated**: 8/31/2026 | **Import test**: passed
...
Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/octokit__core&labels=bug).
...
This package inherits the license from [@octokit/core](https://www.npmjs.com/package/@octokit/core).