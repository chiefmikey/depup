...
> Dependency-bumped version of @octokit/auth-unauthenticated

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @octokit/auth-unauthenticated.
...
- **Original Package**: [@octokit/auth-unauthenticated](https://www.npmjs.com/package/@octokit/auth-unauthenticated)
- **DepUp Version**: 7.0.3-depup.0
...
- **Revision 0** (7.0.3-depup.0) - 🔴 Poor 0% integrity
