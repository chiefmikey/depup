...
> [@octokit/endpoint](https://www.npmjs.com/package/@octokit/endpoint) with all dependencies updated to latest versions.
...
**Original version**: 11.0.5 | **DepUp version**: 11.0.5-depup.0 | **Updated**: 8/30/2026 | **Import test**: passed
...
Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/octokit__endpoint&labels=bug).
...
This package inherits the license from [@octokit/endpoint](https://www.npmjs.com/package/@octokit/endpoint).