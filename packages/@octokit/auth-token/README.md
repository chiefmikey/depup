...
> Dependency-bumped version of @octokit/auth-token

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @octokit/auth-token.
...
- **Original Package**: [@octokit/auth-token](https://www.npmjs.com/package/@octokit/auth-token)
