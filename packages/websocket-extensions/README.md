...
> Dependency-bumped version of websocket-extensions

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for websocket-extensions.
...
- **Original Package**: [websocket-extensions](https://www.npmjs.com/package/websocket-extensions)
- **DepUp Version**: 0.1.4-depup.0
...
- **Revision 0** (0.1.4-depup.0) - 🔴 Poor 0% integrity
