...
> Dependency-bumped version of nats

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for nats.
...
- **Original Package**: [nats](https://www.npmjs.com/package/nats)
- **DepUp Version**: 2.29.3-depup.0
- **Original Version**: 2.29.3
...
- **Revision 0** (2.29.3-depup.0) - 🔴 Poor 0% integrity
