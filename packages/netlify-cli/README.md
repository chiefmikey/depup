...
> Dependency-bumped version of netlify-cli

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for netlify-cli.
...
- **Original Package**: [netlify-cli](https://www.npmjs.com/package/netlify-cli)
- **DepUp Version**: 24.3.0-depup.0
- **Original Version**: 24.3.0
...
- **Revision 0** (24.3.0-depup.0) - 🔴 Poor 0% integrity
