...
**Original version**: 26.0.2 | **DepUp version**: 26.0.2-depup.3 | **Updated**: 5/25/2026 | **Import test**: failed
...
| @netlify/zip-it-and-ship-it | `^14.5.6` | `^14.6.0` |
