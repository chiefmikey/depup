...
**Original version**: 27.4.2 | **DepUp version**: 27.4.2-depup.1 | **Updated**: 9/3/2026 | **Import test**: failed
...
| @netlify/dev | `^5.0.2` | `^5.0.5` |
| @netlify/zip-it-and-ship-it | `^15.4.1` | `^15.5.0` |
