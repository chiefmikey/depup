...
**Original version**: 24.5.0 | **DepUp version**: 24.5.0-depup.0 | **Updated**: 3/24/2026 | **Import test**: failed
...
| @netlify/build | `35.11.0` | `^35.11.1` |
| @netlify/edge-functions-bootstrap | `2.17.1` | `^3.1.0` |
| @netlify/zip-it-and-ship-it | `14.5.1` | `^14.5.2` |
