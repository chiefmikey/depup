...
> Dependency-bumped version of @standard-schema/utils

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @standard-schema/utils.
...
- **Original Package**: [@standard-schema/utils](https://www.npmjs.com/package/@standard-schema/utils)
- **DepUp Version**: 0.3.0-depup.0
...
- **Revision 0** (0.3.0-depup.0) - 🔴 Poor 0% integrity
