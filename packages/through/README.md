...
> Dependency-bumped version of through

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for through.
...
- **Original Package**: [through](https://www.npmjs.com/package/through)
- **DepUp Version**: 2.3.8-depup.0
- **Original Version**: 2.3.8
...
- **Revision 0** (2.3.8-depup.0) - 🔴 Poor 0% integrity
