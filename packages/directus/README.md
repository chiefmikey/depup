...
> Dependency-bumped version of directus

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for directus.
...
- **Original Package**: [directus](https://www.npmjs.com/package/directus)
- **DepUp Version**: 11.16.1-depup.0
- **Original Version**: 11.16.1
...
- **Revision 0** (11.16.1-depup.0) - 🔴 Poor 0% integrity
