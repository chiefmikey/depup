...
> Dependency-bumped version of webpack-dev-server

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for webpack-dev-server.
...
- **Original Package**: [webpack-dev-server](https://www.npmjs.com/package/webpack-dev-server)
- **DepUp Version**: 5.2.3-depup.0
- **Original Version**: 5.2.3
...
- **Revision 0** (5.2.3-depup.0) - 🔴 Poor 0% integrity
