...
**Original version**: 6.0.0 | **DepUp version**: 6.0.0-depup.12 | **Updated**: 7/26/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @types/express-serve-static-core | `^5.1.1` | `^5.1.2` |
| bonjour-service | `^1.3.0` | `^1.4.3` |
