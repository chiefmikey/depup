...
> Dependency-bumped version of aws4fetch

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for aws4fetch.
...
- **Original Package**: [aws4fetch](https://www.npmjs.com/package/aws4fetch)
- **DepUp Version**: 1.0.20-depup.0
- **Original Version**: 1.0.20
...
- **Revision 0** (1.0.20-depup.0) - 🔴 Poor 0% integrity
