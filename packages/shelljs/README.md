...
> [shelljs](https://www.npmjs.com/package/shelljs) with all dependencies updated to latest versions.
...
**Original version**: 0.10.0 | **DepUp version**: 0.10.0-depup.0 | **Updated**: 3/9/2026 | **Import test**: unknown

## What changed

No dependency changes in the latest revision.

Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/shelljs&labels=bug).
...
This package inherits the license from [shelljs](https://www.npmjs.com/package/shelljs).