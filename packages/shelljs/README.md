...
> Dependency-bumped version of shelljs

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for shelljs.
...
- **Original Package**: [shelljs](https://www.npmjs.com/package/shelljs)
- **DepUp Version**: 0.10.0-depup.0
- **Original Version**: 0.10.0
...
- **Revision 0** (0.10.0-depup.0) - 🔴 Poor 0% integrity
