...
> [uploadthing](https://www.npmjs.com/package/uploadthing) with all dependencies updated to latest versions.
...
**Original version**: 7.7.4 | **DepUp version**: 7.7.4-depup.1 | **Updated**: 3/19/2026 | **Import test**: failed
...
This package inherits the license from [uploadthing](https://www.npmjs.com/package/uploadthing).