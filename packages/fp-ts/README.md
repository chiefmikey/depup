...
> Dependency-bumped version of fp-ts

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for fp-ts.
...
- **Original Package**: [fp-ts](https://www.npmjs.com/package/fp-ts)
- **DepUp Version**: 2.16.11-depup.0
- **Original Version**: 2.16.11
...
- **Revision 0** (2.16.11-depup.0) - 🔴 Poor 0% integrity
