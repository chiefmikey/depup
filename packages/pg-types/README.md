...
> Dependency-bumped version of pg-types

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for pg-types.
...
- **Original Package**: [pg-types](https://www.npmjs.com/package/pg-types)
