# @depup/sentry__vite-plugin

> [@sentry/vite-plugin](https://www.npmjs.com/package/@sentry/vite-plugin) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/sentry__vite-plugin
```
...
This package inherits the license from [@sentry/vite-plugin](https://www.npmjs.com/package/@sentry/vite-plugin).