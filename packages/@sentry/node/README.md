...
| @opentelemetry/instrumentation-amqplib | `0.61.0` | `^0.64.0` |
| @opentelemetry/instrumentation-connect | `0.57.0` | `^0.60.0` |
| @opentelemetry/instrumentation-dataloader | `0.31.0` | `^0.34.0` |
| @opentelemetry/instrumentation-fs | `0.33.0` | `^0.36.0` |
| @opentelemetry/instrumentation-generic-pool | `0.57.0` | `^0.60.0` |
...
| @opentelemetry/instrumentation-lru-memoizer | `0.58.0` | `^0.61.0` |
| @opentelemetry/instrumentation-mongodb | `0.67.0` | `^0.70.0` |
| @opentelemetry/instrumentation-mongoose | `0.60.0` | `^0.63.0` |
