...
**Original version**: 10.74.0 | **DepUp version**: 10.74.0-depup.1 | **Updated**: 9/10/2026 | **Import test**: passed
...
| @sentry/conventions | `^0.16.0` | `^0.23.0` |
| import-in-the-middle | `^3.0.0` | `^3.5.0` |
