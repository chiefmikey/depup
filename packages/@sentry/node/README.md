...
**Original version**: 10.72.0 | **DepUp version**: 10.72.0-depup.1 | **Updated**: 8/31/2026 | **Import test**: passed
...
| @sentry/conventions | `^0.16.0` | `^0.21.0` |
| import-in-the-middle | `^3.0.0` | `^3.4.0` |
