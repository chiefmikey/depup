...
> Dependency-bumped version of gulp

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for gulp.
...
- **Original Package**: [gulp](https://www.npmjs.com/package/gulp)
