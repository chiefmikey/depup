...
> Dependency-bumped version of @sindresorhus/is

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @sindresorhus/is.
...
- **Original Package**: [@sindresorhus/is](https://www.npmjs.com/package/@sindresorhus/is)
- **DepUp Version**: 7.2.0-depup.0
- **Original Version**: 7.2.0
...
- **Revision 0** (7.2.0-depup.0) - 🔴 Poor 0% integrity
