...
> [cache-base](https://www.npmjs.com/package/cache-base) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/cache-base
```
...
Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/cache-base&labels=bug).
...
This package inherits the license from [cache-base](https://www.npmjs.com/package/cache-base).