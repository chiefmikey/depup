...
**Original version**: 3.7.4 | **DepUp version**: 3.7.4-depup.8 | **Updated**: 5/12/2026 | **Import test**: passed
...
| devtools-protocol | `0.0.1109433` | `^0.0.1628107` |
| diff | `^8.0.3` | `^9.0.0` |
