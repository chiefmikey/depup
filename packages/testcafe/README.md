...
**Original version**: 3.7.5 | **DepUp version**: 3.7.5-depup.10 | **Updated**: 6/27/2026 | **Import test**: failed
...
| devtools-protocol | `0.0.1109433` | `^0.0.1652909` |
| diff | `^8.0.3` | `^9.0.0` |
