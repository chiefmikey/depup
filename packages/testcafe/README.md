...
**Original version**: 3.7.4 | **DepUp version**: 3.7.4-depup.4 | **Updated**: 3/31/2026 | **Import test**: passed
...
| devtools-protocol | `0.0.1109433` | `^0.0.1604597` |
| diff | `^8.0.3` | `^8.0.4` |
