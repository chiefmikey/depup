...
> [arangojs](https://www.npmjs.com/package/arangojs) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/arangojs
```
...
**Original version**: 10.3.1 | **DepUp version**: 10.3.1-depup.35 | **Updated**: 6/27/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @types/node | `^20.11.26` | `^26.0.1` |
...
This package inherits the license from [arangojs](https://www.npmjs.com/package/arangojs).