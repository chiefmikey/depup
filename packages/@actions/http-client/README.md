# @depup/actions__http-client

> [@actions/http-client](https://www.npmjs.com/package/@actions/http-client) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/actions__http-client
```
...
**Original version**: 4.0.1 | **DepUp version**: 4.0.1-depup.60 | **Updated**: 8/3/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| undici | `^6.23.0` | `^8.10.0` |
...
This package inherits the license from [@actions/http-client](https://www.npmjs.com/package/@actions/http-client).