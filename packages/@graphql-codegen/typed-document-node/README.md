...
> Dependency-bumped version of @graphql-codegen/typed-document-node

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @graphql-codegen/typed-document-node.
...
- **Original Package**: [@graphql-codegen/typed-document-node](https://www.npmjs.com/package/@graphql-codegen/typed-document-node)
- **DepUp Version**: 6.1.7-depup.0
- **Original Version**: 6.1.7
...
- **Revision 0** (6.1.7-depup.0) - 🔴 Poor 0% integrity
