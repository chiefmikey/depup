...
> Dependency-bumped version of @npmcli/package-json

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @npmcli/package-json.
...
- **Original Package**: [@npmcli/package-json](https://www.npmjs.com/package/@npmcli/package-json)
- **DepUp Version**: 7.0.5-depup.0
- **Original Version**: 7.0.5
...
- **Revision 0** (7.0.5-depup.0) - 🔴 Poor 0% integrity
