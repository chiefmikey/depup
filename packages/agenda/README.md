...
> [agenda](https://www.npmjs.com/package/agenda) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/agenda
```
...
**Original version**: 6.2.5 | **DepUp version**: 6.2.5-depup.21 | **Updated**: 6/15/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| cron-parser | `^5.0.0` | `^5.5.0` |
| debug | `^4.4.0` | `^4.4.3` |
| luxon | `^3.2.1` | `^3.7.2` |
...
This package inherits the license from [agenda](https://www.npmjs.com/package/agenda).