...
> [mongodb](https://www.npmjs.com/package/mongodb) with all dependencies updated to latest versions.
...
**Original version**: 7.2.0 | **DepUp version**: 7.2.0-depup.0 | **Updated**: 4/20/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @mongodb-js/saslprep | `^1.3.0` | `^1.4.8` |
...
This package inherits the license from [mongodb](https://www.npmjs.com/package/mongodb).