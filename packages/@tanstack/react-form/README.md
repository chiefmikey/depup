# @depup/tanstack__react-form

> [@tanstack/react-form](https://www.npmjs.com/package/@tanstack/react-form) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/tanstack__react-form
```
...
**Original version**: 1.31.0 | **DepUp version**: 1.31.0-depup.0 | **Updated**: 5/10/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @tanstack/react-store | `^0.9.1` | `^0.11.0` |
...
This package inherits the license from [@tanstack/react-form](https://www.npmjs.com/package/@tanstack/react-form).