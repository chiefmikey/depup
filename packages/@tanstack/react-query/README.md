...
> [@tanstack/react-query](https://www.npmjs.com/package/@tanstack/react-query) with all dependencies updated to latest versions.
...
This package inherits the license from [@tanstack/react-query](https://www.npmjs.com/package/@tanstack/react-query).