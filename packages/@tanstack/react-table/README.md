...
> Dependency-bumped version of @tanstack/react-table

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @tanstack/react-table.
...
- **Original Package**: [@tanstack/react-table](https://www.npmjs.com/package/@tanstack/react-table)
- **DepUp Version**: 8.21.3-depup.0
- **Original Version**: 8.21.3
...
- **Revision 0** (8.21.3-depup.0) - 🔴 Poor 0% integrity
