...
> Dependency-bumped version of gray-matter

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for gray-matter.
...
- **Original Package**: [gray-matter](https://www.npmjs.com/package/gray-matter)
- **DepUp Version**: 4.0.3-depup.0
...
- **Revision 0** (4.0.3-depup.0) - 🔴 Poor 0% integrity
