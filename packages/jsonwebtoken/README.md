...
> [jsonwebtoken](https://www.npmjs.com/package/jsonwebtoken) with all dependencies updated to latest versions.
...
**Original version**: 9.0.3 | **DepUp version**: 9.0.3-depup.11 | **Updated**: 6/12/2026 | **Import test**: passed
...
This package inherits the license from [jsonwebtoken](https://www.npmjs.com/package/jsonwebtoken).