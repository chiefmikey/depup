...
> [csurf](https://www.npmjs.com/package/csurf) with all dependencies updated to latest versions.
...
Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/csurf&labels=bug).
...
This package inherits the license from [csurf](https://www.npmjs.com/package/csurf).