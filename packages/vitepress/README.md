...
**Original version**: 1.6.4 | **DepUp version**: 1.6.4-depup.4 | **Updated**: 5/19/2026 | **Import test**: failed
...
| @iconify-json/simple-icons | `^1.2.21` | `^1.2.83` |
| @shikijs/core | `^2.1.0` | `^4.1.0` |
| @shikijs/transformers | `^2.1.0` | `^4.1.0` |
| @shikijs/types | `^2.1.0` | `^4.1.0` |
| @vitejs/plugin-vue | `^5.2.1` | `^6.0.7` |
| @vue/devtools-api | `^7.7.0` | `^8.1.2` |
| @vue/shared | `^3.5.13` | `^3.5.34` |
