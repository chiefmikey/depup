...
> [form-data](https://www.npmjs.com/package/form-data) with all dependencies updated to latest versions.
...
**Original version**: 4.0.6 | **DepUp version**: 4.0.6-depup.10 | **Updated**: 6/16/2026 | **Import test**: passed
...
This package inherits the license from [form-data](https://www.npmjs.com/package/form-data).