# @depup/react-dropzone

> [react-dropzone](https://www.npmjs.com/package/react-dropzone) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/react-dropzone
```
...
**Original version**: 15.0.0 | **DepUp version**: 15.0.0-depup.10 | **Updated**: 6/12/2026 | **Import test**: failed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| attr-accept | `^2.2.4` | `^2.2.5` |
| file-selector | `^2.1.0` | `^2.1.2` |
...
This package inherits the license from [react-dropzone](https://www.npmjs.com/package/react-dropzone).