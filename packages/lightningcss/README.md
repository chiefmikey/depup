...
> Dependency-bumped version of lightningcss

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for lightningcss.
...
- **Original Package**: [lightningcss](https://www.npmjs.com/package/lightningcss)
- **DepUp Version**: 1.32.0-depup.0
- **Original Version**: 1.32.0
...
- **Revision 0** (1.32.0-depup.0) - 🔴 Poor 0% integrity
