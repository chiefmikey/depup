...
> Dependency-bumped version of prom-client

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for prom-client.
...
- **DepUp Version**: 15.1.3-depup.0
- **Original Version**: 15.1.3
...
- **Revision 0** (15.1.3-depup.0) - 🔴 Poor 0% integrity
