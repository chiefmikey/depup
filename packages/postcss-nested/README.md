...
> Dependency-bumped version of postcss-nested

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for postcss-nested.
...
- **Original Package**: [postcss-nested](https://www.npmjs.com/package/postcss-nested)
- **DepUp Version**: 7.0.2-depup.0
...
- **Revision 0** (7.0.2-depup.0) - 🔴 Poor 0% integrity
