...
> [h3](https://www.npmjs.com/package/h3) with all dependencies updated to latest versions.
...
**Original version**: 2.0.1-rc.22 | **DepUp version**: 2.0.1-rc.22-depup.39 | **Updated**: 6/29/2026 | **Import test**: failed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| srvx | `^0.11.15` | `^0.11.17` |
...
This package inherits the license from [h3](https://www.npmjs.com/package/h3).