...
> Dependency-bumped version of builtin-status-codes

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for builtin-status-codes.
...
- **Original Package**: [builtin-status-codes](https://www.npmjs.com/package/builtin-status-codes)
