...
> [nconf](https://www.npmjs.com/package/nconf) with all dependencies updated to latest versions.
...
**Original version**: 0.13.0 | **DepUp version**: 0.13.0-depup.13 | **Updated**: 6/13/2026 | **Import test**: passed
...
This package inherits the license from [nconf](https://www.npmjs.com/package/nconf).