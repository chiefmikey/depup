...
> [vscode-languageserver](https://www.npmjs.com/package/vscode-languageserver) with all dependencies updated to latest versions.
...
**Original version**: 10.0.0 | **DepUp version**: 10.0.0-depup.26 | **Updated**: 6/20/2026 | **Import test**: passed
...
This package inherits the license from [vscode-languageserver](https://www.npmjs.com/package/vscode-languageserver).