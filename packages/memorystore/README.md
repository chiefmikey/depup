...
> [memorystore](https://www.npmjs.com/package/memorystore) with all dependencies updated to latest versions.
...
**Original version**: 1.6.8 | **DepUp version**: 1.6.8-depup.31 | **Updated**: 6/21/2026 | **Import test**: passed
...
This package inherits the license from [memorystore](https://www.npmjs.com/package/memorystore).