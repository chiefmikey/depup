...
> [remark-rehype](https://www.npmjs.com/package/remark-rehype) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/remark-rehype
```
...
Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/remark-rehype&labels=bug).
...
This package inherits the license from [remark-rehype](https://www.npmjs.com/package/remark-rehype).