...
**Original version**: 6.7.0 | **DepUp version**: 6.7.0-depup.1 | **Updated**: 7/12/2026 | **Import test**: failed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @babel/parser | `7.27.0` | `^8.0.4` |
| @babel/traverse | `7.27.0` | `^8.0.4` |
