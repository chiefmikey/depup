...
> [pg-mem](https://www.npmjs.com/package/pg-mem) with all dependencies updated to latest versions.
...
**Original version**: 3.0.14 | **DepUp version**: 3.0.14-depup.4 | **Updated**: 9/15/2026 | **Import test**: failed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| immutable | `^4.3.4` | `^5.1.9` |
| json-stable-stringify | `^1.0.1` | `^1.3.0` |
| lru-cache | `^6.0.0` | `^11.5.2` |
| moment | `^2.27.0` | `^2.31.0` |
| object-hash | `^2.0.3` | `^3.0.0` |


Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/pg-mem&labels=bug).
...
This package inherits the license from [pg-mem](https://www.npmjs.com/package/pg-mem).