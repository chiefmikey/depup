...
**Original version**: 12.0.5 | **DepUp version**: 12.0.5-depup.1 | **Updated**: 9/24/2026 | **Import test**: failed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @angular-devkit/core | `22.1.8` | `^22.2.0` |
| @angular-devkit/schematics | `22.1.8` | `^22.2.0` |
| @angular-devkit/schematics-cli | `22.1.8` | `^22.2.0` |
