...
> [@nestjs/cli](https://www.npmjs.com/package/@nestjs/cli) with all dependencies updated to latest versions.
...
**Original version**: 11.0.21 | **DepUp version**: 11.0.21-depup.5 | **Updated**: 5/25/2026 | **Import test**: failed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @angular-devkit/core | `19.2.24` | `^21.2.12` |
| @angular-devkit/schematics | `19.2.24` | `^21.2.12` |
| @angular-devkit/schematics-cli | `19.2.24` | `^21.2.12` |
...
This package inherits the license from [@nestjs/cli](https://www.npmjs.com/package/@nestjs/cli).