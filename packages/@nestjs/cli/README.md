...
**Original version**: 11.0.23 | **DepUp version**: 11.0.23-depup.47 | **Updated**: 7/9/2026 | **Import test**: failed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @angular-devkit/core | `19.2.27` | `^22.0.5` |
| @angular-devkit/schematics | `19.2.27` | `^22.0.5` |
| @angular-devkit/schematics-cli | `19.2.27` | `^22.0.5` |
