...
**Original version**: 11.0.24 | **DepUp version**: 11.0.24-depup.6 | **Updated**: 7/30/2026 | **Import test**: failed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @angular-devkit/core | `19.2.27` | `^22.1.0` |
| @angular-devkit/schematics | `19.2.27` | `^22.1.0` |
| @angular-devkit/schematics-cli | `19.2.27` | `^22.1.0` |
