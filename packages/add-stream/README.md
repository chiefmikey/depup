...
> [add-stream](https://www.npmjs.com/package/add-stream) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/add-stream
```
...
Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/add-stream&labels=bug).
...
This package inherits the license from [add-stream](https://www.npmjs.com/package/add-stream).