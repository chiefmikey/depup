...
> Dependency-bumped version of memorystream

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for memorystream.
...
- **Original Package**: [memorystream](https://www.npmjs.com/package/memorystream)
- **DepUp Version**: 0.3.1-depup.0
...
- **Revision 0** (0.3.1-depup.0) - 🔴 Poor 0% integrity
