...
> [send](https://www.npmjs.com/package/send) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/send
```
...
This package inherits the license from [send](https://www.npmjs.com/package/send).