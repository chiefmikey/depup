# @depup/react-tag-input

> [react-tag-input](https://www.npmjs.com/package/react-tag-input) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/react-tag-input
```
...
**Original version**: 6.10.6 | **DepUp version**: 6.10.6-depup.1 | **Updated**: 4/1/2026 | **Import test**: failed
...
This package inherits the license from [react-tag-input](https://www.npmjs.com/package/react-tag-input).