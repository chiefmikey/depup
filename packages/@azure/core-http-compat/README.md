# @depup/azure__core-http-compat

> [@azure/core-http-compat](https://www.npmjs.com/package/@azure/core-http-compat) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/azure__core-http-compat
```
...
**Original version**: 2.3.2 | **DepUp version**: 2.3.2-depup.0 | **Updated**: 3/17/2026 | **Import test**: unknown
...
This package inherits the license from [@azure/core-http-compat](https://www.npmjs.com/package/@azure/core-http-compat).