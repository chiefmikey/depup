...
> Dependency-bumped version of vite

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for vite.
...
- **DepUp Version**: 7.1.5-depup.0
- **Original Version**: 7.1.5
...
- **Revision 0** (7.1.5-depup.0) - 🔴 Poor 0% integrity
