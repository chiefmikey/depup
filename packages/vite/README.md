...
> [vite](https://www.npmjs.com/package/vite) with all dependencies updated to latest versions.
...
**Original version**: 8.0.16 | **DepUp version**: 8.0.16-depup.6 | **Updated**: 6/10/2026 | **Import test**: failed
...
This package inherits the license from [vite](https://www.npmjs.com/package/vite).