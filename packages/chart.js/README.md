...
> [chart.js](https://www.npmjs.com/package/chart.js) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/chart.js
```
...
**Original version**: 4.5.1 | **DepUp version**: 4.5.1-depup.30 | **Updated**: 9/15/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @kurkle/color | `^0.3.0` | `^0.6.0` |
...
This package inherits the license from [chart.js](https://www.npmjs.com/package/chart.js).