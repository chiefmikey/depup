...
> Dependency-bumped version of eslint-plugin-jest

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for eslint-plugin-jest.
...
- **Original Package**: [eslint-plugin-jest](https://www.npmjs.com/package/eslint-plugin-jest)
- **DepUp Version**: 29.15.0-depup.0
- **Original Version**: 29.15.0
...
- **Revision 0** (29.15.0-depup.0) - 🔴 Poor 0% integrity
