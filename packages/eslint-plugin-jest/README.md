...
> [eslint-plugin-jest](https://www.npmjs.com/package/eslint-plugin-jest) with all dependencies updated to latest versions.
...
**Original version**: 29.15.2 | **DepUp version**: 29.15.2-depup.30 | **Updated**: 6/19/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @typescript-eslint/utils | `^8.0.0` | `^8.61.1` |
...
This package inherits the license from [eslint-plugin-jest](https://www.npmjs.com/package/eslint-plugin-jest).