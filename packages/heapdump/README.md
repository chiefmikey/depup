...
> [heapdump](https://www.npmjs.com/package/heapdump) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/heapdump
```
...
**Original version**: 0.3.15 | **DepUp version**: 0.3.15-depup.31 | **Updated**: 6/23/2026 | **Import test**: passed
...
This package inherits the license from [heapdump](https://www.npmjs.com/package/heapdump).