...
> Dependency-bumped version of global-agent

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for global-agent.
...
- **Original Package**: [global-agent](https://www.npmjs.com/package/global-agent)
- **DepUp Version**: 4.1.3-depup.0
- **Original Version**: 4.1.3
...
- **Revision 0** (4.1.3-depup.0) - 🔴 Poor 0% integrity
