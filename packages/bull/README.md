...
> Dependency-bumped version of bull

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for bull.
...
- **DepUp Version**: 4.16.5-depup.0
- **Original Version**: 4.16.5
...
- **Revision 0** (4.16.5-depup.0) - 🔴 Poor 0% integrity
