...
> [p-all](https://www.npmjs.com/package/p-all) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/p-all
```
...
This package inherits the license from [p-all](https://www.npmjs.com/package/p-all).