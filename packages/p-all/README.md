...
> Dependency-bumped version of p-all

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for p-all.
...
- **Original Package**: [p-all](https://www.npmjs.com/package/p-all)
