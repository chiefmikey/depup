...
> Dependency-bumped version of react-freeze

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for react-freeze.
...
- **Original Package**: [react-freeze](https://www.npmjs.com/package/react-freeze)
- **DepUp Version**: 1.0.4-depup.0
...
- **Revision 0** (1.0.4-depup.0) - 🔴 Poor 0% integrity
