...
> [wrangler](https://www.npmjs.com/package/wrangler) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/wrangler
```
...
**Original version**: 4.94.0 | **DepUp version**: 4.94.0-depup.3 | **Updated**: 5/24/2026 | **Import test**: failed
...
This package inherits the license from [wrangler](https://www.npmjs.com/package/wrangler).