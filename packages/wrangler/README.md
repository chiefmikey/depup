...
> Dependency-bumped version of wrangler

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for wrangler.
...
- **Original Package**: [wrangler](https://www.npmjs.com/package/wrangler)
- **DepUp Version**: 4.75.0-depup.0
- **Original Version**: 4.75.0
...
- **Revision 0** (4.75.0-depup.0) - 🔴 Poor 0% integrity
