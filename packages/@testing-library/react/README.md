# @depup/testing-library__react

> [@testing-library/react](https://www.npmjs.com/package/@testing-library/react) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/testing-library__react
```
...
**Original version**: 16.3.3 | **DepUp version**: 16.3.3-depup.0 | **Updated**: 8/27/2026 | **Import test**: failed
...
This package inherits the license from [@testing-library/react](https://www.npmjs.com/package/@testing-library/react).