...
> Dependency-bumped version of @testing-library/jest-dom

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @testing-library/jest-dom.
...
- **Revision 0** (6.9.1-depup.0) - 🔴 Poor 0% integrity
