...
> Dependency-bumped version of @testing-library/user-event

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @testing-library/user-event.
...
- **DepUp Version**: 14.6.1-depup.0
- **Original Version**: 14.6.1
...
- **Revision 0** (14.6.1-depup.0) - 🔴 Poor 0% integrity
