...
> Dependency-bumped version of pdf-parse

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for pdf-parse.
...
- **Original Package**: [pdf-parse](https://www.npmjs.com/package/pdf-parse)
- **DepUp Version**: 2.4.5-depup.0
- **Original Version**: 2.4.5
...
- **Revision 0** (2.4.5-depup.0) - 🔴 Poor 0% integrity
