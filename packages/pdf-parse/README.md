...
> [pdf-parse](https://www.npmjs.com/package/pdf-parse) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/pdf-parse
```
...
**Original version**: 2.4.5 | **DepUp version**: 2.4.5-depup.6 | **Updated**: 7/29/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @napi-rs/canvas | `0.1.80` | `^1.0.3` |
| pdfjs-dist | `5.4.296` | `^6.2.108` |
...
This package inherits the license from [pdf-parse](https://www.npmjs.com/package/pdf-parse).