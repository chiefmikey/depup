...
> [@react-email/components](https://www.npmjs.com/package/@react-email/components) with all dependencies updated to latest versions.
...
**Original version**: 1.0.10 | **DepUp version**: 1.0.10-depup.0 | **Updated**: 3/18/2026 | **Import test**: failed
...
This package inherits the license from [@react-email/components](https://www.npmjs.com/package/@react-email/components).