...
> Dependency-bumped version of @react-email/render

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @react-email/render.
...
- **Original Package**: [@react-email/render](https://www.npmjs.com/package/@react-email/render)
- **DepUp Version**: 2.0.4-depup.0
...
- **Revision 0** (2.0.4-depup.0) - 🔴 Poor 0% integrity
