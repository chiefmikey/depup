...
> [ws](https://www.npmjs.com/package/ws) with all dependencies updated to latest versions.
...
**Original version**: 8.21.0 | **DepUp version**: 8.21.0-depup.10 | **Updated**: 6/12/2026 | **Import test**: passed

## What changed

No dependencies were updated (all already at latest).

Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/ws&labels=bug).
...
This package inherits the license from [ws](https://www.npmjs.com/package/ws).