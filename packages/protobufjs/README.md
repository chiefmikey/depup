...
> [protobufjs](https://www.npmjs.com/package/protobufjs) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/protobufjs
```
...
This package inherits the license from [protobufjs](https://www.npmjs.com/package/protobufjs).