...
> Dependency-bumped version of webpack-dev-middleware

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for webpack-dev-middleware.
...
- **Original Package**: [webpack-dev-middleware](https://www.npmjs.com/package/webpack-dev-middleware)
- **DepUp Version**: 7.4.5-depup.0
- **Original Version**: 7.4.5
...
- **Revision 0** (7.4.5-depup.0) - 🔴 Poor 0% integrity
