...
> Dependency-bumped version of domain

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for domain.
...
- **Original Package**: [domain](https://www.npmjs.com/package/domain)
