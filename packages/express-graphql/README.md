...
> [express-graphql](https://www.npmjs.com/package/express-graphql) with all dependencies updated to latest versions.
...
**Original version**: 0.12.0 | **DepUp version**: 0.12.0-depup.5 | **Updated**: 9/11/2026 | **Import test**: passed
...
Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/express-graphql&labels=bug).
...
This package inherits the license from [express-graphql](https://www.npmjs.com/package/express-graphql).