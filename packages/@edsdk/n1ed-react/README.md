...
> Dependency-bumped version of @edsdk/n1ed-react

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @edsdk/n1ed-react.
...
- **Original Package**: [@edsdk/n1ed-react](https://www.npmjs.com/package/@edsdk/n1ed-react)
- **DepUp Version**: 1.0.19-depup.0
- **Original Version**: 1.0.19
...
- **Revision 0** (1.0.19-depup.0) - 🔴 Poor 0% integrity
