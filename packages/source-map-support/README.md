...
> [source-map-support](https://www.npmjs.com/package/source-map-support) with all dependencies updated to latest versions.
...
This package inherits the license from [source-map-support](https://www.npmjs.com/package/source-map-support).