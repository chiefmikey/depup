...
> [mongoose](https://www.npmjs.com/package/mongoose) with all dependencies updated to latest versions.
...
**Original version**: 9.10.0 | **DepUp version**: 9.10.0-depup.0 | **Updated**: 9/11/2026 | **Import test**: passed
...
This package inherits the license from [mongoose](https://www.npmjs.com/package/mongoose).