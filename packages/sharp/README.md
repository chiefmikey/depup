...
> Dependency-bumped version of sharp

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for sharp.
...
- **DepUp Version**: 0.34.5-depup.0
- **Original Version**: 0.34.5
...
- **Revision 0** (0.34.5-depup.0) - 🔴 Poor 0% integrity
