...
> Dependency-bumped version of co-body

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for co-body.
...
- **Original Package**: [co-body](https://www.npmjs.com/package/co-body)
