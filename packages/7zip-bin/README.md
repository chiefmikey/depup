...
> Dependency-bumped version of 7zip-bin

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for 7zip-bin.
...
- **Original Package**: [7zip-bin](https://www.npmjs.com/package/7zip-bin)
