...
> Dependency-bumped version of payload

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for payload.
...
- **Original Package**: [payload](https://www.npmjs.com/package/payload)
- **DepUp Version**: 3.79.1-depup.0
- **Original Version**: 3.79.1
...
- **Revision 0** (3.79.1-depup.0) - 🔴 Poor 0% integrity
