...
> Dependency-bumped version of multiparty

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for multiparty.
...
- **Original Package**: [multiparty](https://www.npmjs.com/package/multiparty)
- **DepUp Version**: 4.2.3-depup.0
- **Original Version**: 4.2.3
...
- **Revision 0** (4.2.3-depup.0) - 🔴 Poor 0% integrity
