...
**Original version**: 4.4.5 | **DepUp version**: 4.4.5-depup.0 | **Updated**: 5/11/2026 | **Import test**: passed
...
| jiti | `^2.6.1` | `^2.7.0` |
| oxc-minify | `^0.128.0` | `^0.129.0` |
| oxc-parser | `^0.128.0` | `^0.129.0` |
| oxc-transform | `^0.128.0` | `^0.129.0` |
