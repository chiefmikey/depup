...
**Original version**: 4.4.6 | **DepUp version**: 4.4.6-depup.1 | **Updated**: 5/26/2026 | **Import test**: passed
...
| oxc-minify | `^0.131.0` | `^0.133.0` |
| oxc-parser | `^0.131.0` | `^0.133.0` |
| oxc-transform | `^0.131.0` | `^0.133.0` |
| semver | `^7.8.0` | `^7.8.1` |
