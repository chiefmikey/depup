...
**Original version**: 4.5.0 | **DepUp version**: 4.5.0-depup.3 | **Updated**: 7/24/2026 | **Import test**: failed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @dxup/nuxt | `^0.5.3` | `^0.5.4` |
| @nuxt/devtools | `^3.2.4` | `^4.0.0-alpha.9` |
| @unhead/vue | `^3.1.8` | `^3.2.3` |
