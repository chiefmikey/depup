...
> [webpack-log](https://www.npmjs.com/package/webpack-log) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/webpack-log
```
...
This package inherits the license from [webpack-log](https://www.npmjs.com/package/webpack-log).