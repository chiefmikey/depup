...
> Dependency-bumped version of formatjs

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for formatjs.
...
- **Original Package**: [formatjs](https://www.npmjs.com/package/formatjs)
- **DepUp Version**: 0.1.1-depup.0
...
- **Revision 0** (0.1.1-depup.0) - 🔴 Poor 0% integrity
