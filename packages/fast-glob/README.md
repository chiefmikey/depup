...
> [fast-glob](https://www.npmjs.com/package/fast-glob) with all dependencies updated to latest versions.
...
**Original version**: 3.3.3 | **DepUp version**: 3.3.3-depup.19 | **Updated**: 6/15/2026 | **Import test**: passed
...
This package inherits the license from [fast-glob](https://www.npmjs.com/package/fast-glob).