...
**Original version**: 5.16.1 | **DepUp version**: 5.16.1-depup.42 | **Updated**: 6/9/2026 | **Import test**: failed
...
| @typescript-eslint/eslint-plugin | `^5.60.1` | `^8.61.0` |
| @typescript-eslint/parser | `^5.60.1` | `^8.61.0` |
...
| dotenv | `^8.6.0` | `^17.4.2` |
| enhanced-resolve | `^5.15.0` | `^5.23.0` |
| eslint | `^7.32.0` | `^10.4.1` |
