...
**Original version**: 5.16.1 | **DepUp version**: 5.16.1-depup.91 | **Updated**: 7/14/2026 | **Import test**: failed
...
| @typescript-eslint/eslint-plugin | `^5.60.1` | `^8.64.0` |
| @typescript-eslint/parser | `^5.60.1` | `^8.64.0` |
