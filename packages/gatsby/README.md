...
> Dependency-bumped version of gatsby

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for gatsby.
...
- **Original Package**: [gatsby](https://www.npmjs.com/package/gatsby)
- **DepUp Version**: 5.16.1-depup.0
- **Original Version**: 5.16.1
...
- **Revision 0** (5.16.1-depup.0) - 🔴 Poor 0% integrity
