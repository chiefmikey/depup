...
> [africastalking](https://www.npmjs.com/package/africastalking) with all dependencies updated to latest versions.
...
**Original version**: 0.7.9 | **DepUp version**: 0.7.9-depup.4 | **Updated**: 4/2/2026 | **Import test**: passed
...
This package inherits the license from [africastalking](https://www.npmjs.com/package/africastalking).