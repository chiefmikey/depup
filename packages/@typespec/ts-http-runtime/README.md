...
> Dependency-bumped version of @typespec/ts-http-runtime

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @typespec/ts-http-runtime.
...
- **Original Package**: [@typespec/ts-http-runtime](https://www.npmjs.com/package/@typespec/ts-http-runtime)
- **DepUp Version**: 0.3.4-depup.0
...
- **Revision 0** (0.3.4-depup.0) - 🔴 Poor 0% integrity
