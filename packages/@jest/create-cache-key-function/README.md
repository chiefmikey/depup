...
> Dependency-bumped version of @jest/create-cache-key-function

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for @jest/create-cache-key-function.
...
- **Original Package**: [@jest/create-cache-key-function](https://www.npmjs.com/package/@jest/create-cache-key-function)
- **DepUp Version**: 30.3.0-depup.0
- **Original Version**: 30.3.0
...
- **Revision 0** (30.3.0-depup.0) - 🔴 Poor 0% integrity
