...
> [umzug](https://www.npmjs.com/package/umzug) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/umzug
```
...
**Original version**: 3.8.2 | **DepUp version**: 3.8.2-depup.0 | **Updated**: 3/19/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @rushstack/ts-command-line | `^4.12.2` | `^5.3.3` |
...
This package inherits the license from [umzug](https://www.npmjs.com/package/umzug).