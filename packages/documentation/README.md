...
> [documentation](https://www.npmjs.com/package/documentation) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/documentation
```
...
**Original version**: 14.0.3 | **DepUp version**: 14.0.3-depup.10 | **Updated**: 8/25/2026 | **Import test**: failed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @babel/core | `^7.18.10` | `^8.0.1` |
| @babel/generator | `^7.18.10` | `^8.0.0` |
| @babel/parser | `^7.18.11` | `^8.0.4` |
| @babel/traverse | `^7.18.11` | `^8.0.4` |
| @babel/types | `^7.18.10` | `^8.0.4` |
| chalk | `^5.0.1` | `^6.0.0` |
...
This package inherits the license from [documentation](https://www.npmjs.com/package/documentation).