...
> Dependency-bumped version of got

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for got.
...
- **Original Package**: [got](https://www.npmjs.com/package/got)
- **DepUp Version**: 14.6.6-depup.0
- **Original Version**: 14.6.6
...
- **Revision 0** (14.6.6-depup.0) - 🔴 Poor 0% integrity
