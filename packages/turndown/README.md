...
> Dependency-bumped version of turndown

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for turndown.
...
- **Original Package**: [turndown](https://www.npmjs.com/package/turndown)
- **DepUp Version**: 7.2.2-depup.0
- **Original Version**: 7.2.2
...
- **Revision 0** (7.2.2-depup.0) - 🔴 Poor 0% integrity
