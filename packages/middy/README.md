...
> Dependency-bumped version of middy

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for middy.
...
- **Original Package**: [middy](https://www.npmjs.com/package/middy)
- **DepUp Version**: 0.36.0-depup.0
- **Original Version**: 0.36.0
...
- **Revision 0** (0.36.0-depup.0) - 🔴 Poor 0% integrity
