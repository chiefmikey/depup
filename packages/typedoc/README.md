...
> [typedoc](https://www.npmjs.com/package/typedoc) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/typedoc
```
...
**Original version**: 0.28.17 | **DepUp version**: 0.28.17-depup.0 | **Updated**: 3/17/2026 | **Import test**: unknown

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @gerrit0/mini-shiki | `^3.17.0` | `^3.23.0` |
...
This package inherits the license from [typedoc](https://www.npmjs.com/package/typedoc).