...
> [unified](https://www.npmjs.com/package/unified) with all dependencies updated to latest versions.
...
Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/unified&labels=bug).
...
This package inherits the license from [unified](https://www.npmjs.com/package/unified).