...
> [micromatch](https://www.npmjs.com/package/micromatch) with all dependencies updated to latest versions.
...
**Original version**: 4.0.8 | **DepUp version**: 4.0.8-depup.16 | **Updated**: 6/14/2026 | **Import test**: passed
...
This package inherits the license from [micromatch](https://www.npmjs.com/package/micromatch).