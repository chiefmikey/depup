...
**Original version**: 22.1.7 | **DepUp version**: 22.1.7-depup.1 | **Updated**: 9/4/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @inquirer/confirm | `6.1.1` | `^6.3.1` |
| beasties | `0.4.3` | `^0.5.3` |
| browserslist | `^4.26.0` | `^4.28.8` |
| listr2 | `11.0.0` | `^11.1.0` |
| magic-string | `1.0.0` | `^1.2.3` |
| oxc-parser | `0.142.0` | `^0.148.0` |
| picomatch | `4.0.5` | `^4.0.7` |
| piscina | `5.2.0` | `^5.3.2` |
| rolldown | `1.2.0` | `^1.2.7` |
