...
> [solid-js](https://www.npmjs.com/package/solid-js) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/solid-js
```
...
**Original version**: 1.9.13 | **DepUp version**: 1.9.13-depup.36 | **Updated**: 6/30/2026 | **Import test**: passed
...
This package inherits the license from [solid-js](https://www.npmjs.com/package/solid-js).