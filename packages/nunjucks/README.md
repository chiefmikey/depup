...
> [nunjucks](https://www.npmjs.com/package/nunjucks) with all dependencies updated to latest versions.
...
**Original version**: 3.2.4 | **DepUp version**: 3.2.4-depup.16 | **Updated**: 6/14/2026 | **Import test**: passed
...
Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/nunjucks&labels=bug).
...
This package inherits the license from [nunjucks](https://www.npmjs.com/package/nunjucks).