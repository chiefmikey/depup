...
> Dependency-bumped version of avsc

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for avsc.
...
- **Original Package**: [avsc](https://www.npmjs.com/package/avsc)
- **DepUp Version**: 5.7.9-depup.0
- **Original Version**: 5.7.9
...
- **Revision 0** (5.7.9-depup.0) - 🔴 Poor 0% integrity
