# @depup/react-grid-layout

> [react-grid-layout](https://www.npmjs.com/package/react-grid-layout) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/react-grid-layout
```
...
**Original version**: 2.2.3 | **DepUp version**: 2.2.3-depup.4 | **Updated**: 7/21/2026 | **Import test**: failed
...
This package inherits the license from [react-grid-layout](https://www.npmjs.com/package/react-grid-layout).