...
> [lint-staged](https://www.npmjs.com/package/lint-staged) with all dependencies updated to latest versions.
...
**Original version**: 17.0.6 | **DepUp version**: 17.0.6-depup.0 | **Updated**: 5/30/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| tinyexec | `1.2.2` | `^1.2.3` |
...
This package inherits the license from [lint-staged](https://www.npmjs.com/package/lint-staged).