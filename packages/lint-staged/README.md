...
> Dependency-bumped version of lint-staged

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for lint-staged.
...
- **DepUp Version**: 16.4.0-depup.0
- **Original Version**: 16.4.0
...
- **Revision 0** (16.3.4-depup.0) - 🔴 Poor 0% integrity

### Version 16.4.0

- **Revision 0** (16.4.0-depup.0) - 🔴 Poor 0% integrity
