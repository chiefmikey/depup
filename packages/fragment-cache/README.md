...
> Dependency-bumped version of fragment-cache

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for fragment-cache.
...
- **Original Package**: [fragment-cache](https://www.npmjs.com/package/fragment-cache)
- **DepUp Version**: 0.2.1-depup.0
...
- **Revision 0** (0.2.1-depup.0) - 🔴 Poor 0% integrity
