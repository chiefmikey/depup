...
> Dependency-bumped version of mongoose-paginate-v2

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for mongoose-paginate-v2.
...
- **Original Package**: [mongoose-paginate-v2](https://www.npmjs.com/package/mongoose-paginate-v2)
- **DepUp Version**: 1.9.1-depup.0
...
- **Revision 0** (1.9.1-depup.0) - 🔴 Poor 0% integrity
