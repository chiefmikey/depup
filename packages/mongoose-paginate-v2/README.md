...
> [mongoose-paginate-v2](https://www.npmjs.com/package/mongoose-paginate-v2) with all dependencies updated to latest versions.
...
**Original version**: 1.9.5 | **DepUp version**: 1.9.5-depup.0 | **Updated**: 7/21/2026 | **Import test**: passed
...
This package inherits the license from [mongoose-paginate-v2](https://www.npmjs.com/package/mongoose-paginate-v2).