...
> [formidable](https://www.npmjs.com/package/formidable) with all dependencies updated to latest versions.
...
**Original version**: 3.5.4 | **DepUp version**: 3.5.4-depup.14 | **Updated**: 6/13/2026 | **Import test**: passed
...
This package inherits the license from [formidable](https://www.npmjs.com/package/formidable).