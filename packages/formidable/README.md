...
> Dependency-bumped version of formidable

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for formidable.
...
- **Original Package**: [formidable](https://www.npmjs.com/package/formidable)
- **DepUp Version**: 3.5.4-depup.0
- **Original Version**: 3.5.4
...
- **Revision 0** (3.5.4-depup.0) - 🔴 Poor 0% integrity
