...
> [karma-jasmine](https://www.npmjs.com/package/karma-jasmine) with all dependencies updated to latest versions.
...
**Original version**: 5.1.0 | **DepUp version**: 5.1.0-depup.3 | **Updated**: 8/16/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| jasmine-core | `^4.1.0` | `^7.0.1` |
...
This package inherits the license from [karma-jasmine](https://www.npmjs.com/package/karma-jasmine).