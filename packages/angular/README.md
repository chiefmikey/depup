...
> Dependency-bumped version of angular

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for angular.
...
- **Original Package**: [angular](https://www.npmjs.com/package/angular)
- **DepUp Version**: 1.8.3-depup.0
- **Original Version**: 1.8.3
...
- **Revision 0** (1.8.3-depup.0) - 🔴 Poor 0% integrity
