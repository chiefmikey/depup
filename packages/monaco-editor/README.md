...
> [monaco-editor](https://www.npmjs.com/package/monaco-editor) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/monaco-editor
```
...
**Original version**: 0.57.0 | **DepUp version**: 0.57.0-depup.0 | **Updated**: 9/25/2026 | **Import test**: failed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| marked | `14.0.0` | `^18.0.14` |
...
This package inherits the license from [monaco-editor](https://www.npmjs.com/package/monaco-editor).