...
> [@clerk/themes](https://www.npmjs.com/package/@clerk/themes) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/clerk__themes
```
...
**Original version**: 2.4.57 | **DepUp version**: 2.4.57-depup.67 | **Updated**: 7/12/2026 | **Import test**: passed

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @clerk/shared | `^3.47.2` | `^4.25.2` |
...
This package inherits the license from [@clerk/themes](https://www.npmjs.com/package/@clerk/themes).