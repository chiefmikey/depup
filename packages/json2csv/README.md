...
> Dependency-bumped version of json2csv

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for json2csv.
...
- **Original Package**: [json2csv](https://www.npmjs.com/package/json2csv)
- **DepUp Version**: 6.0.0-alpha.2-depup.0
- **Original Version**: 6.0.0-alpha.2
...
- **Revision 0** (6.0.0-alpha.2-depup.0) - 🔴 Poor 0% integrity
