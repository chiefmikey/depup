...
> [json2csv](https://www.npmjs.com/package/json2csv) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/json2csv
```
...
**Original version**: 6.0.0-alpha.2 | **DepUp version**: 6.0.0-alpha.2-depup.0 | **Updated**: 3/17/2026
...
This package inherits the license from [json2csv](https://www.npmjs.com/package/json2csv).