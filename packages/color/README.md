...
> Dependency-bumped version of color

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for color.
...
- **Original Package**: [color](https://www.npmjs.com/package/color)
