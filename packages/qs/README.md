...
> [qs](https://www.npmjs.com/package/qs) with all dependencies updated to latest versions.
...
**Original version**: 6.15.2 | **DepUp version**: 6.15.2-depup.17 | **Updated**: 6/14/2026 | **Import test**: passed
...
This package inherits the license from [qs](https://www.npmjs.com/package/qs).