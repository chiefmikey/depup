...
> Dependency-bumped version of qs

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for qs.
...
- **Original Package**: [qs](https://www.npmjs.com/package/qs)
- **DepUp Version**: 6.15.0-depup.0
- **Original Version**: 6.15.0
...
- **Revision 0** (6.15.0-depup.0) - 🔴 Poor 0% integrity
