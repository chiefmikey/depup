# @depup/postcss-loader

> [postcss-loader](https://www.npmjs.com/package/postcss-loader) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/postcss-loader
```
...
This package inherits the license from [postcss-loader](https://www.npmjs.com/package/postcss-loader).