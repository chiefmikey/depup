...
> Dependency-bumped version of uvu

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for uvu.
...
- **Original Package**: [uvu](https://www.npmjs.com/package/uvu)
- **DepUp Version**: 0.5.6-depup.0
- **Original Version**: 0.5.6
...
- **Revision 0** (0.5.6-depup.0) - 🔴 Poor 0% integrity
