...
> [uvu](https://www.npmjs.com/package/uvu) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/uvu
```
...
**Original version**: 0.5.6 | **DepUp version**: 0.5.6-depup.0 | **Updated**: 3/17/2026
...
Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/uvu&labels=bug).
...
This package inherits the license from [uvu](https://www.npmjs.com/package/uvu).