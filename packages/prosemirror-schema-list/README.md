...
> Dependency-bumped version of prosemirror-schema-list

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for prosemirror-schema-list.
...
- **Original Package**: [prosemirror-schema-list](https://www.npmjs.com/package/prosemirror-schema-list)
- **DepUp Version**: 1.5.1-depup.0
...
- **Revision 0** (1.5.1-depup.0) - 🔴 Poor 0% integrity
