...
> Dependency-bumped version of z-schema

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for z-schema.
...
- **Original Package**: [z-schema](https://www.npmjs.com/package/z-schema)
