...
> [encoding](https://www.npmjs.com/package/encoding) with all dependencies updated to latest versions.
...
**Original version**: 0.1.13 | **DepUp version**: 0.1.13-depup.16 | **Updated**: 6/14/2026 | **Import test**: passed
...
This package inherits the license from [encoding](https://www.npmjs.com/package/encoding).