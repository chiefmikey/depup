...
> Dependency-bumped version of encoding

This package is automatically generated by [DepUp](https://github.com/depup/npm) to provide up-to-date dependencies for encoding.
...
- **Original Package**: [encoding](https://www.npmjs.com/package/encoding)
- **DepUp Version**: 0.1.13-depup.0
- **Original Version**: 0.1.13
...
- **Revision 0** (0.1.13-depup.0) - 🔴 Poor 0% integrity
