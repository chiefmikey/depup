...
> [elasticsearch](https://www.npmjs.com/package/elasticsearch) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/elasticsearch
```
...
**Original version**: 16.7.3 | **DepUp version**: 16.7.3-depup.0 | **Updated**: 3/17/2026 | **Import test**: unknown
...
This package inherits the license from [elasticsearch](https://www.npmjs.com/package/elasticsearch).