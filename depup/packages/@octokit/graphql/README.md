...
> [@octokit/graphql](https://www.npmjs.com/package/@octokit/graphql) with all dependencies updated to latest versions.
...
Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/octokit__graphql&labels=bug).
...
This package inherits the license from [@octokit/graphql](https://www.npmjs.com/package/@octokit/graphql).