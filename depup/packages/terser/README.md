...
> [terser](https://www.npmjs.com/package/terser) with all dependencies updated to latest versions.
...
**Original version**: 5.46.1 | **DepUp version**: 5.46.1-depup.0 | **Updated**: 3/16/2026 | **Import test**: unknown
...
Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/terser&labels=bug).
...
This package inherits the license from [terser](https://www.npmjs.com/package/terser).