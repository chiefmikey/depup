# @depup/through2-filter

> [through2-filter](https://www.npmjs.com/package/through2-filter) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/through2-filter
```
...
This package inherits the license from [through2-filter](https://www.npmjs.com/package/through2-filter).