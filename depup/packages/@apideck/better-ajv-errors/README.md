# @depup/apideck__better-ajv-errors

> [@apideck/better-ajv-errors](https://www.npmjs.com/package/@apideck/better-ajv-errors) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/apideck__better-ajv-errors
```
...
Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/apideck__better-ajv-errors&labels=bug).
...
This package inherits the license from [@apideck/better-ajv-errors](https://www.npmjs.com/package/@apideck/better-ajv-errors).