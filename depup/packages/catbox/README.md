...
> [catbox](https://www.npmjs.com/package/catbox) with all dependencies updated to latest versions.
...
**Original version**: 10.0.6 | **DepUp version**: 10.0.6-depup.0 | **Updated**: 3/17/2026 | **Import test**: unknown
...
Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/catbox&labels=bug).
...
This package inherits the license from [catbox](https://www.npmjs.com/package/catbox).