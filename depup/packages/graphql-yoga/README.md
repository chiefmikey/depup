...
**Original version**: 5.18.1 | **DepUp version**: 5.18.1-depup.0 | **Updated**: 3/17/2026 | **Import test**: unknown

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @graphql-tools/executor | `^1.5.0` | `^1.5.1` |
| @graphql-tools/schema | `^10.0.11` | `^10.0.31` |
| @graphql-tools/utils | `^10.11.0` | `^11.0.0` |
| @whatwg-node/fetch | `^0.10.6` | `^0.10.13` |
| @whatwg-node/server | `^0.10.14` | `^0.10.18` |
| lru-cache | `^10.0.0` | `^11.2.7` |
