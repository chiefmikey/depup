...
> [moment](https://www.npmjs.com/package/moment) with all dependencies updated to latest versions.
...
**Original version**: 2.30.1 | **DepUp version**: 2.30.1-depup.15 | **Updated**: 9/12/2025 | **Import test**: unknown

## What changed

No dependency changes in the latest revision.

Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/moment&labels=bug).
...
This package inherits the license from [moment](https://www.npmjs.com/package/moment).