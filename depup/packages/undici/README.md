...
> [undici](https://www.npmjs.com/package/undici) with all dependencies updated to latest versions.
...
**Original version**: 7.24.4 | **DepUp version**: 7.24.4-depup.0 | **Updated**: 3/16/2026 | **Import test**: unknown

## What changed

No dependencies were updated (all already at latest).

Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/undici&labels=bug).
...
This package inherits the license from [undici](https://www.npmjs.com/package/undici).