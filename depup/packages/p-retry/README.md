...
> [p-retry](https://www.npmjs.com/package/p-retry) with all dependencies updated to latest versions.
...
**Original version**: 7.1.1 | **DepUp version**: 7.1.1-depup.0 | **Updated**: 3/9/2026 | **Import test**: unknown
...
This package inherits the license from [p-retry](https://www.npmjs.com/package/p-retry).