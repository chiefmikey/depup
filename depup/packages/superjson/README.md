...
> [superjson](https://www.npmjs.com/package/superjson) with all dependencies updated to latest versions.
...
This package inherits the license from [superjson](https://www.npmjs.com/package/superjson).