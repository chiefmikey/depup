...
> [sass](https://www.npmjs.com/package/sass) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/sass
```
...
**Original version**: 1.98.0 | **DepUp version**: 1.98.0-depup.1 | **Updated**: 3/14/2026 | **Import test**: unknown
...
This package inherits the license from [sass](https://www.npmjs.com/package/sass).