...
> [@graphql-tools/batch-execute](https://www.npmjs.com/package/@graphql-tools/batch-execute) with all dependencies updated to latest versions.
...
**Original version**: 10.0.7 | **DepUp version**: 10.0.7-depup.0 | **Updated**: 3/17/2026 | **Import test**: unknown
...
This package inherits the license from [@graphql-tools/batch-execute](https://www.npmjs.com/package/@graphql-tools/batch-execute).