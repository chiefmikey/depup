...
> [node-memwatch](https://www.npmjs.com/package/node-memwatch) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/node-memwatch
```
...
**Original version**: 1.0.1 | **DepUp version**: 1.0.1-depup.0 | **Updated**: 3/19/2026 | **Import test**: failed
...
This package inherits the license from [node-memwatch](https://www.npmjs.com/package/node-memwatch).