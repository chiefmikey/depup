...
> [yargs](https://www.npmjs.com/package/yargs) with all dependencies updated to latest versions.
...
This package inherits the license from [yargs](https://www.npmjs.com/package/yargs).