...
> [xss](https://www.npmjs.com/package/xss) with all dependencies updated to latest versions.
...
This package inherits the license from [xss](https://www.npmjs.com/package/xss).