...
> [concat-stream](https://www.npmjs.com/package/concat-stream) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/concat-stream
```
...
Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/concat-stream&labels=bug).
...
This package inherits the license from [concat-stream](https://www.npmjs.com/package/concat-stream).