...
> [pullstate](https://www.npmjs.com/package/pullstate) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/pullstate
```
...
This package inherits the license from [pullstate](https://www.npmjs.com/package/pullstate).