...
> [redux](https://www.npmjs.com/package/redux) with all dependencies updated to latest versions.
...
**Original version**: 5.0.1 | **DepUp version**: 5.0.1-depup.0 | **Updated**: 1/10/2026 | **Import test**: unknown

## What changed

No dependency changes in the latest revision.

Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/redux&labels=bug).
...
This package inherits the license from [redux](https://www.npmjs.com/package/redux).