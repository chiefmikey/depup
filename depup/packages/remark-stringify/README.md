# @depup/remark-stringify

> [remark-stringify](https://www.npmjs.com/package/remark-stringify) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/remark-stringify
```
...
Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/remark-stringify&labels=bug).
...
This package inherits the license from [remark-stringify](https://www.npmjs.com/package/remark-stringify).