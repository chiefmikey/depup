...
> [gatsby](https://www.npmjs.com/package/gatsby) with all dependencies updated to latest versions.

Drop-in replacement. Same API. Fresher dependencies.

```bash
npm install @depup/gatsby
```
...
**Original version**: 5.16.1 | **DepUp version**: 5.16.1-depup.0 | **Updated**: 3/17/2026 | **Import test**: unknown

## What changed

| Dependency | Original | Updated |
|------------|----------|--------|
| @babel/code-frame | `^7.18.6` | `^7.29.0` |
...
| @graphql-codegen/add | `^3.2.3` | `^6.0.0` |
| @graphql-codegen/core | `^2.6.8` | `^5.0.1` |
| @graphql-codegen/plugin-helpers | `^2.7.2` | `^6.2.0` |
| @graphql-codegen/typescript | `^2.8.8` | `^5.0.9` |
| @graphql-codegen/typescript-operations | `^2.5.13` | `^5.0.9` |
| @graphql-tools/code-file-loader | `^7.3.23` | `^8.1.28` |
| @graphql-tools/load | `^7.8.14` | `^8.1.8` |
...
| @typescript-eslint/eslint-plugin | `^5.60.1` | `^8.57.1` |
| @typescript-eslint/parser | `^5.60.1` | `^8.57.1` |
...
| eslint-webpack-plugin | `^2.7.0` | `^5.0.3` |
| execa | `^5.1.1` | `^9.6.1` |
...
| react-server-dom-webpack | `0.0.0-experimental-c8b778b7f-20220825` | `^19.2.4` |
| redux | `4.2.1` | `^5.0.1` |
...
| webpack-dev-middleware | `^5.3.4` | `^7.4.5` |
| webpack-merge | `^5.9.0` | `^6.0.1` |
| xstate | `^4.38.0` | `^5.28.0` |
| yaml-loader | `^0.8.0` | `^0.9.0` |


Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/gatsby&labels=bug).
...
This package inherits the license from [gatsby](https://www.npmjs.com/package/gatsby).