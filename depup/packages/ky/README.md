...
> [ky](https://www.npmjs.com/package/ky) with all dependencies updated to latest versions.
...
**Original version**: 1.14.3 | **DepUp version**: 1.14.3-depup.0 | **Updated**: 3/9/2026 | **Import test**: unknown

## What changed

No dependency changes in the latest revision.

Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/ky&labels=bug).
...
This package inherits the license from [ky](https://www.npmjs.com/package/ky).