...
> [swr](https://www.npmjs.com/package/swr) with all dependencies updated to latest versions.
...
Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/swr&labels=bug).
...
This package inherits the license from [swr](https://www.npmjs.com/package/swr).