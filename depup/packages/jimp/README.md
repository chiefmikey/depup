...
> [jimp](https://www.npmjs.com/package/jimp) with all dependencies updated to latest versions.
...
**Original version**: 1.6.0 | **DepUp version**: 1.6.0-depup.0 | **Updated**: 3/9/2026 | **Import test**: unknown

## What changed

No dependency changes in the latest revision.

Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/jimp&labels=bug).
...
This package inherits the license from [jimp](https://www.npmjs.com/package/jimp).