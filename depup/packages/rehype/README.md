...
> [rehype](https://www.npmjs.com/package/rehype) with all dependencies updated to latest versions.
...
**Original version**: 13.0.2 | **DepUp version**: 13.0.2-depup.0 | **Updated**: 3/9/2026 | **Import test**: unknown

## What changed

No dependency changes in the latest revision.

Something broken? [Report it](https://github.com/depup/npm/issues/new?title=Issue+with+@depup/rehype&labels=bug).
...
This package inherits the license from [rehype](https://www.npmjs.com/package/rehype).